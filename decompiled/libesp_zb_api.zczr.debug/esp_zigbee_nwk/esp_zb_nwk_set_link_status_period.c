 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_nwk.o -> esp_zb_nwk_set_link_status_period
 *
...
undefined4 esp_zb_nwk_set_link_status_period(undefined1 param_1)

{
  DAT_000112b6 = param_1;
  return 0;
}
