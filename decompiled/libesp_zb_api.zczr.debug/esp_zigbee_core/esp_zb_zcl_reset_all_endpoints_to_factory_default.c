 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_core.o -> esp_zb_zcl_reset_all_endpoints_to_factory_default
 *
...

{
  ...
  if (pbVar1 == (byte *)0x0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_L0,uVar3,"ESP_ZIGBEE_CORE",
                  "esp_zb_zcl_reset_all_endpoints_to_factory_default",0x3f7);
    uVar3 = 0xffffffff;
  }
  else {
    uVar3 = 0;
