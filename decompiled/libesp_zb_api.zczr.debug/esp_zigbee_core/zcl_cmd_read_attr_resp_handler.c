 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_core.o -> zcl_cmd_read_attr_resp_handler
 *
...
_L0:
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC7,uVar5,"ESP_ZIGBEE_CORE","zcl_cmd_read_attr_resp_handler"
                  ,0x1c5);
  }
  return iVar4;
}
