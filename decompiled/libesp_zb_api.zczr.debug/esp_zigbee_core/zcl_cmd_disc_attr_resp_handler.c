 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_core.o -> zcl_cmd_disc_attr_resp_handler
 *
...
_L0:
        ...
        if (puVar2 != (undefined2 *)0x0) {
          ...
          if (puVar7 == (undefined2 *)0x0) {
            ...
            esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC12,uVar5,"ESP_ZIGBEE_CORE",
                          "zcl_cmd_disc_attr_resp_handler",0x24a);
            return 0x101;
          }
          *puVar7 = *puVar2;
    ...
    uVar5 = esp_log_timestamp();
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_L0,uVar5,"ESP_ZIGBEE_CORE","zcl_cmd_disc_attr_resp_handler",
                  0x243);
  }
  return iVar3;
}
