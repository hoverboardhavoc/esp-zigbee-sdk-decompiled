...

{
  ...
  if (iVar2 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_LC7,uVar6,"ESP_ZIGBEE_COMMAND",
                  "esp_zb_zcl_report_attr_cmd_req",0x13a,*(undefined1 *)(param_1 + 9));
    uVar4 = 0x105;
  }
  else {
