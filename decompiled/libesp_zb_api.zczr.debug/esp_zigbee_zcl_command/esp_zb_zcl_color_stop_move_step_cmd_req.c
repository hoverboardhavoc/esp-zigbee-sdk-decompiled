 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zcl_command.o -> esp_zb_zcl_color_stop_move_step_cmd_req
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log(1,"ESP_ZIGBEE_COMMAND","E (%lu) %s: %s(%d): No I/O buffer for %s\n",uVar2,
            "ESP_ZIGBEE_COMMAND","esp_zb_zcl_color_stop_move_step_cmd_req",0x3a2,
    ...
    *pcVar3 = *pcVar3 + '\x01';
    ...
    zb_zcl_color_control_send_stop_move_step_req
               ...
               *(undefined1 *)(param_1 + 9),uVar4,0,0);
