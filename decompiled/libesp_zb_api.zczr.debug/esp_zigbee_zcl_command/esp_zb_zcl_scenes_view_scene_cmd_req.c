 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zcl_command.o -> esp_zb_zcl_scenes_view_scene_cmd_req
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log(1,"ESP_ZIGBEE_COMMAND","E (%lu) %s: %s(%d): No I/O buffer for %s\n",uVar3,
            "ESP_ZIGBEE_COMMAND","esp_zb_zcl_scenes_view_scene_cmd_req",0x523,
            "esp_zb_zcl_scenes_view_scene_cmd_req");
    pcVar4 = (char *)zb_zcl_get_ctx();
    *pcVar4 = *pcVar4 + '\x01';
  }
  else {
    zb_zcl_start_command_header(1,0,0);
    puVar2 = (undefined1 *)zb_put_next_htole16(*(undefined2 *)(param_1 + 10));
    *puVar2 = *(undefined1 *)(param_1 + 0xc);
    zb_zcl_finish_and_send_packet
              (iVar1,puVar2 + 1,param_1,2,*(undefined1 *)(param_1 + 8),*(undefined1 *)(param_1 + 9),
               uVar5,5);
