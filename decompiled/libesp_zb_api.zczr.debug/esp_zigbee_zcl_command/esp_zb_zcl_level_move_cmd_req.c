 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zcl_command.o -> esp_zb_zcl_level_move_cmd_req
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_L0,uVar2,"ESP_ZIGBEE_COMMAND",
                  "esp_zb_zcl_level_move_cmd_req",0x265,"esp_zb_zcl_level_move_cmd_req");
