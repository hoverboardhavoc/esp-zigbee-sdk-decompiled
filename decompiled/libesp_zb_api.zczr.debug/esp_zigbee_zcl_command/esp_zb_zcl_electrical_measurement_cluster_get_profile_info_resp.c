 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zcl_command.o -> esp_zb_zcl_electrical_measurement_cluster_get_profile_info_resp
 *
...

{
  ...
  if (iVar3 == 0) {
    ...
    esp_log(1,"ESP_ZIGBEE_COMMAND","E (%lu) %s: %s(%d): No I/O buffer for %s\n",uVar6,
            "ESP_ZIGBEE_COMMAND","esp_zb_zcl_electrical_measurement_cluster_get_profile_info_resp",
            0x6e4,"esp_zb_zcl_electrical_measurement_cluster_get_profile_info_resp");
