 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zcl_command.o -> esp_zb_zcl_disc_attr_cmd_req
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log(1,"ESP_ZIGBEE_COMMAND","E (%lu) %s: %s(%d): No memory for sending disc_attr command\n",
            uVar3,"ESP_ZIGBEE_COMMAND","esp_zb_zcl_disc_attr_cmd_req",0x14b);
