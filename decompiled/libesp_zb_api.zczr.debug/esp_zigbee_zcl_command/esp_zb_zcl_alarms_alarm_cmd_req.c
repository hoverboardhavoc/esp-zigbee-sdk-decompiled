...
void esp_zb_zcl_alarms_alarm_cmd_req(int param_1)
    ...
    *pcVar5 = *pcVar5 + '\x01';
    ...
    if (iVar2 == 0) {
      ...
      *pcVar5 = cVar1 + '\x01';
      ...
      uVar6 = zb_put_next_htole16(puVar4 + 4,*(undefined2 *)(param_1 + 0x12));
      zb_zcl_finish_and_send_packet
                (iVar2,uVar6,param_1,*(undefined1 *)(param_1 + 0xc),*(undefined1 *)(param_1 + 8),
