 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_cluster.o -> esp_zb_cluster_list_add_meter_identification_cluster
 *
...

{
  ...
  aiStack_24[0] = 0;
  iVar1 = esp_zb_cluster_list_get_tail(param_1,param_2,0xb01,param_3,aiStack_24);
  if (aiStack_24[0] == 0) {
    if (param_3 == 1) {
      puVar2 = &zb_zcl_meter_identification_init_server;
    }
    else if (param_3 == 2) {
      puVar2 = &zb_zcl_meter_identification_init_client;
    }
    else {
