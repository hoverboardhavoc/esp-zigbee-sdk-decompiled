 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_cluster.o -> esp_zb_cluster_list_add_touchlink_commissioning_cluster
 *
...

{
  ...
  if (aiStack_24[0] == 0) {
    if (param_3 == 1) {
      puVar2 = &esp_zb_zcl_touchlink_commissioning_init_server;
    }
    else if (param_3 == 2) {
      puVar2 = &esp_zb_zcl_touchlink_commissioning_init_client;
    }
    else {
