 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_cluster.o -> esp_zb_binary_value_cluster_create
 *
...

{
  ...
  esp_zb_binary_value_cluster_add_attr(uVar1,0x51,auStack_11);
  esp_zb_binary_value_cluster_add_attr(uVar1,0x6f,&uStack_12);
  esp_zb_binary_value_cluster_add_attr(uVar1,0x55,&uStack_13);
  return uVar1;
}
