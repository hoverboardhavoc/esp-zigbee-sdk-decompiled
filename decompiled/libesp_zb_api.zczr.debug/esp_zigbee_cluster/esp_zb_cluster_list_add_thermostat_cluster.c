 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_cluster.o -> esp_zb_cluster_list_add_thermostat_cluster
 *
...

{
  ...
  aiStack_24[0] = 0;
  iVar1 = esp_zb_cluster_list_get_tail(param_1,param_2,0x201,param_3,aiStack_24);
  if (aiStack_24[0] == 0) {
    if (param_3 == 1) {
