 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_cluster.o -> esp_zb_cluster_list_add_ias_ace_cluster
 *
...

{
  ...
  aiStack_24[0] = 0;
  iVar1 = esp_zb_cluster_list_get_tail(param_1,param_2,0x501,param_3,aiStack_24);
  if (aiStack_24[0] == 0) {
    if (param_3 == 1) {
      puVar2 = &esp_zb_zcl_ias_ace_init_server;
    }
    else if (param_3 == 2) {
      puVar2 = &esp_zb_zcl_ias_ace_init_client;
    }
    else {
