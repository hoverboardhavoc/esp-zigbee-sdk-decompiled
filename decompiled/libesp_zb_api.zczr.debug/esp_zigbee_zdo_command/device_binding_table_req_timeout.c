 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zdo_command.o -> device_binding_table_req_timeout
 *
...

{
  ...
  esp_log(3,"ESP_ZIGBEE_API_ZDO","I (%lu) %s: ZDO device binding table request timeout!\n",uVar1,
          "ESP_ZIGBEE_API_ZDO");
