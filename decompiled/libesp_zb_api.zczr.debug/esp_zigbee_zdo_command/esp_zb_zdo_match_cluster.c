 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zdo_command.o -> esp_zb_zdo_match_cluster
 *
...

{
  ...
  if (puVar4 == (undefined1 *)0x0) {
    ...
    esp_log(1,"ESP_ZIGBEE_API_ZDO","E (%lu) %s: %s(%d): Failed to malloc memory for cluster list\n",
            uVar3,"ESP_ZIGBEE_API_ZDO","esp_zb_zdo_match_cluster",0x18a);
    uVar3 = 0x101;
  }
  else {
    uVar1 = *param_1;
    *puVar4 = (char)uVar1;
    ...
    if (iVar5 == iVar2) {
      ...
      uVar3 = esp_log_timestamp();
      esp_log(1,"ESP_ZIGBEE_API_ZDO","E (%lu) %s: %s(%d): Failed to fill the cluster list\n",uVar3,
              "ESP_ZIGBEE_API_ZDO","esp_zb_zdo_match_cluster",0x195);
      uVar3 = 0x104;
    }
  }
  return uVar3;
