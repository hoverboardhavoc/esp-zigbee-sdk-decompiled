 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zcl_touchlink_commissioning.o -> zcl_touchlink_endpoint_info_handler
 *
...

{
  ...
  if (iVar5 == 0x10) {
    ...
    esp_log(3,0x10000,"I (%lu) %s: touchlink endpoint information command wrong packet size.\n",
            uVar7,0x10000);
  }
  return 0xffffffff;
}
