 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zcl_groups.o -> zcl_groups_get_remove_group_res
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log(1,0x10000,"E (%lu) %s: %s(%d): Failed to create remove_group_response message\n",uVar3,
            0x10000,"zcl_groups_get_remove_group_res",0x44);
  }
  return iVar1;
}
