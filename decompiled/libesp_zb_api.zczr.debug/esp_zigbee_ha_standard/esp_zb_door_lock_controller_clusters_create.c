 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_ha_standard.o -> esp_zb_door_lock_controller_clusters_create
 *
...
undefined4 esp_zb_door_lock_controller_clusters_create(int param_1)

{
  ...
  esp_zb_cluster_list_add_door_lock_cluster(uVar2,uVar3,2);
  return uVar2;
}
