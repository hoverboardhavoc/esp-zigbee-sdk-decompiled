 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_ha_standard.o -> esp_zb_door_lock_clusters_create
 *
...

{
  ...
  uVar3 = esp_zb_door_lock_cluster_create(iVar1);
  esp_zb_cluster_list_add_door_lock_cluster(uVar2,uVar3,1);
  return uVar2;
}
