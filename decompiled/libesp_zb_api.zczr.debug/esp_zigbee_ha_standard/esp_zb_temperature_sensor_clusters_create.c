 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_ha_standard.o -> esp_zb_temperature_sensor_clusters_create
 *
...
undefined4 esp_zb_temperature_sensor_clusters_create(int param_1)

{
  ...
  uVar3 = esp_zb_temperature_meas_cluster_create(iVar1);
  esp_zb_cluster_list_add_temperature_meas_cluster(uVar2,uVar3,1);
