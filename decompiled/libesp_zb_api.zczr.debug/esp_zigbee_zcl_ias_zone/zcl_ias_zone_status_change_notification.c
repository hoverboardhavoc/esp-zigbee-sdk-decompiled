 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zcl_ias_zone.o -> zcl_ias_zone_status_change_notification
 *
...

{
  ...
  if (iVar2 == 0) {
    ...
    esp_log(1,"ESP_ZIGBEE_ZCL_IAS_ZONE",
            "E (%lu) %s: %s(%d): Failed to create ias_zone_status_notification message\n",uVar4,
            "ESP_ZIGBEE_ZCL_IAS_ZONE","zcl_ias_zone_status_change_notification",0x5d);
  }
  return iVar2;
}
