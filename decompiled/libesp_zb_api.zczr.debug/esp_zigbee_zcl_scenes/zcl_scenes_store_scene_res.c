 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zcl_scenes.o -> zcl_scenes_store_scene_res
 *
...
int zcl_scenes_store_scene_res(undefined4 param_1)

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log(1,"ESP_ZIGBEE_ZCL_SCENES",
            "E (%lu) %s: %s(%d): Failed to create store_scene_response message\n",uVar3,
            "ESP_ZIGBEE_ZCL_SCENES","zcl_scenes_store_scene_res",0x2fe);
  }
  return iVar1;
}
