...
_L0:
    ...
    esp_log_write(1,"ESP_ZIGBEE_ZCL_SCENES",&_L0,uVar6,"ESP_ZIGBEE_ZCL_SCENES",
                  "zcl_scenes_view_scene_res",0x30e);
    iVar5 = 0;
  }
  else {
    ...
    if (iVar5 == 0) {
      ...
      uVar6 = esp_log_timestamp();
      esp_log_write(1,"ESP_ZIGBEE_ZCL_SCENES",&_LC29,uVar6,"ESP_ZIGBEE_ZCL_SCENES",
                    "zcl_scenes_view_scene_res",0x310);
    }
  }
  return iVar5;
}
