 ...
 * Source: libesp_zb_api.zczr.debug -> esp_zigbee_zcl_scenes.o -> zcl_scenes_view_scene_res
 *
...
_L0:
    ...
    esp_log(1,"ESP_ZIGBEE_ZCL_SCENES","E (%lu) %s: %s(%d): Failed to get view scene response\n",
            uVar6,"ESP_ZIGBEE_ZCL_SCENES","zcl_scenes_view_scene_res",0x30e);
    iVar5 = 0;
  }
  else {
    ...
    if (iVar5 == 0) {
      ...
      iVar5 = esp_zb_core_action_handler_schedule(0x1021,auStack_4c);
      puVar9 = puStack_24;
      ...
      esp_log(1,"ESP_ZIGBEE_ZCL_SCENES",
              "E (%lu) %s: %s(%d): Failed to create view_scene_response message\n",uVar6,
              "ESP_ZIGBEE_ZCL_SCENES","zcl_scenes_view_scene_res",0x310);
    }
  }
  return iVar5;
}
