 ...
 * Source: libzboss_port.remote.debug -> zb_esp_osif.o -> zb_esp_init
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    _esp_error_check_failed
              ("/builds/thread_zigbee/esp-zboss/components/zboss_port/src/zb_esp_osif.c",0x9b,
               "zb_esp_init","zb_esp_osif_lock_init()");
  }
