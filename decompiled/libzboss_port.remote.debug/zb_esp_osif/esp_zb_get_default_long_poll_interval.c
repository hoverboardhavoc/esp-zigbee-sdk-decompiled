 ...
 * Source: libzboss_port.remote.debug -> zb_esp_osif.o -> esp_zb_get_default_long_poll_interval
 *
...
void esp_zb_get_default_long_poll_interval(void)

{
  zb_get_default_long_poll_interval();
  return;
}
