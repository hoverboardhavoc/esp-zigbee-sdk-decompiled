 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_zdo_command.o -> esp_zb_zdo_device_bind_req
 *
...

{
  ...
  *(undefined2 *)((int)__dest + 0x16) = *(undefined2 *)((int)param_1 + 0x18);
  uVar2 = zb_zdo_bind_req(uVar2,bind_device_cb);
  zb_schedule_app_alarm(bind_device_req_timeout,uVar2,5000000,0);
  esp_zb_zdo_callback_register(uVar2,0x21,param_2,param_3);
  return;
}
