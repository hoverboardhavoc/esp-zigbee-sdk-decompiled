 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_zdo_command.o -> esp_zb_zdo_find_on_off_light
 *
...
void esp_zb_zdo_find_on_off_light(undefined1 *param_1,undefined4 param_2,undefined4 param_3)
