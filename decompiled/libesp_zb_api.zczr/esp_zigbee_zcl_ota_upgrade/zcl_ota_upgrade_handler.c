...

{
  ...
  *(undefined2 *)(puVar4 + 10) = 0;
  ...
  puVar4[0xb] = 0;
  if (bVar1 == 2) {
    uVar10 = (uint)*(byte *)(iVar6 + 0x14);
    uVar11 = *(uint *)(iVar6 + 0x10);
    __src = *(void **)(iVar6 + 0x18);
    if (s_ota_header_1 == (void *)0x0) {
      s_ota_header_1 = malloc(0x45);
    }
    while (puVar4 = message_2, pvVar3 = s_ota_header_1, uVar10 != 0) {
      if (s_ota_header_length_0 <= uVar11) {
        *(short *)(message_2 + 10) = (short)uVar10;
        puVar4[0xb] = (uint)__src;
        iVar7 = esp_zb_core_action_handler_schedule(4);
        goto _L0;
      }
      __n = s_ota_header_length_0 - uVar11;
      if (uVar10 < __n) {
        __n = uVar10;
      }
      pvVar8 = (void *)((int)s_ota_header_1 + uVar11);
      uVar11 = uVar11 + __n;
      memcpy(pvVar8,__src,__n);
      puVar4 = message_2;
      uVar10 = uVar10 - __n & 0xff;
      __src = (void *)((int)__src + __n);
      if (0x37 < uVar11) {
        s_ota_header_length_0 = *(ushort *)((int)pvVar3 + 6);
      }
      if ((s_ota_header_length_0 <= uVar11) && (pvVar3 != (void *)0x0)) {
...
_L0:
    if (iVar7 != 0) {
      uVar9 = 8;
      if ((iVar7 != 0x10c) && (uVar9 = 7, iVar7 == 0x103)) {
        uVar9 = 9;
      }
      goto _L0;
    }
