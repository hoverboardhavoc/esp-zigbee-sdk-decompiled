...

{
  ...
  if (uVar4 < 0x10) {
    iVar5 = (&DAT_000114e4)[uVar4 * 3];
    (&DAT_000114e0)[uVar4 * 6] = param_1;
    (&DAT_000114e3)[uVar4 * 0xc] = 0;
    if (iVar5 != 0) {
      device_scene_free_fields();
      (&DAT_000114e4)[uVar4 * 3] = 0;
    }
    puVar7 = (undefined2 *)(&DAT_000114e4)[uVar4 * 3];
    for (; param_2 != (undefined2 *)0x0; param_2 = *(undefined2 **)(param_2 + 4)) {
      puVar6 = (undefined2 *)malloc(0xc);
      cVar1 = *(char *)(param_2 + 1);
      (&DAT_000114e3)[uVar4 * 0xc] = (&DAT_000114e3)[uVar4 * 0xc] + '\x03' + cVar1;
      uVar3 = *param_2;
      *(char *)(puVar6 + 1) = cVar1;
