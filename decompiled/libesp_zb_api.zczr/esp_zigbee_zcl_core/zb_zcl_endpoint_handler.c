...
undefined4 zb_zcl_endpoint_handler(int param_1)

{
  ...
  if (*(char *)(iVar4 + 0x16) == '\0') {
    ...
    for (; piVar6 + -2 != (int *)0xfffffff8; piVar6 = (int *)*piVar6) {
      if (*(short *)(piVar6 + -2) == sVar3) {
        iVar4 = (*(code *)piVar6[-1])(param_1,(code *)piVar6[-1]);
        goto _L0;
      }
    }
    iVar4 = 0;
...
_L0:
  if (zcl_raw_command_cb != (code *)0x0) {
    ...
    uVar5 = (*zcl_raw_command_cb)(param_1,zcl_raw_command_cb);
    return uVar5;
  }
  return 0;
}
