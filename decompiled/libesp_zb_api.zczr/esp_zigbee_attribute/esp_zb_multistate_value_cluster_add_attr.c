 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_attribute.o -> esp_zb_multistate_value_cluster_add_attr
 *
...
_L0:
  if ((param_1 == (ushort *)0x0) || (*(int *)(param_1 + 6) == 0)) {
    ...
    puVar7 = param_1;
    if (*(short *)(*(int *)(param_1 + 6) + 10) == 0x14) {
      do {
...
_L0:
      ...
      uVar3 = esp_log_timestamp();
      esp_log_write(1,0x10000,&_LC2,uVar3,0x10000,*(undefined2 *)(*(int *)(param_1 + 6) + 10),0x14);
    }
  }
  return 0x102;
}
