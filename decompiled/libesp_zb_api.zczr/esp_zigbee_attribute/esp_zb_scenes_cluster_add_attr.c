 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_attribute.o -> esp_zb_scenes_cluster_add_attr
 *
...
undefined4 esp_zb_scenes_cluster_add_attr(ushort *param_1,uint param_2,void *param_3)
    ...
    if (*(short *)(*(int *)(param_1 + 6) + 10) == 5) {
      do {
        ...
        if (puVar3 == (ushort *)0x0) {
          ...
          __size = esp_zb_zcl_get_attribute_size(cVar5,param_3);
          if (__size == 0xffff) {
_L0:
            free(__ptr);
            return 0x102;
      ...
      esp_log(1,0x10000,"E (%lu) %s: Wrong cluster(0x%04x) to add attribute, expect 0x%04x\n",uVar4,
              0x10000,*(undefined2 *)(*(int *)(param_1 + 6) + 10),5);
    }
  }
  return 0x102;
}
