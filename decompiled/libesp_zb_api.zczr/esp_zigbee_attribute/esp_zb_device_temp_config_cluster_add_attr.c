 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_attribute.o -> esp_zb_device_temp_config_cluster_add_attr
 *
...
undefined4 esp_zb_device_temp_config_cluster_add_attr(ushort *param_1,uint param_2,void *param_3)
...
_L0:
      ...
      if (0x12 < param_2) {
        if (1 < (param_2 - 0x13 & 0xffff)) goto _L0;
        uVar5 = 3;
        uVar4 = 0x22;
        goto _L0;
      }
...
_L0:
      ...
      uVar3 = esp_log_timestamp();
      esp_log_write(1,0x10000,&_LC2,uVar3,0x10000,*(undefined2 *)(*(int *)(param_1 + 6) + 10),2);
    }
  }
  return 0x102;
}
