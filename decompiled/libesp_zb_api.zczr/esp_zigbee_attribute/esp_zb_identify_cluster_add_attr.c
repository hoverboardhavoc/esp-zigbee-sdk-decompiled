 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_attribute.o -> esp_zb_identify_cluster_add_attr
 *
...
undefined4 esp_zb_identify_cluster_add_attr(short *param_1,int param_2,void *param_3)
...
_L0:
      ...
      uVar3 = esp_log_timestamp();
      esp_log_write(1,0x10000,&_LC2,uVar3,0x10000,*(undefined2 *)(*(int *)(param_1 + 6) + 10),3);
    }
  }
  return 0x102;
}
