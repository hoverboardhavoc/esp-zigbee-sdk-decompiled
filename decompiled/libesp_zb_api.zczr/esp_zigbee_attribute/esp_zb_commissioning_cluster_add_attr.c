...
_L0:
    ...
    if (param_2 < 0x17) {
      uVar5 = 0xf1;
      if ((param_2 == 0x14) || (uVar5 = 0x10, param_2 != 0x15)) goto _L0;
_L0:
      uVar5 = 0x20;
      goto _L0;
    }
    ...
    uVar5 = param_2;
    if ((param_2 == 0x20) || (uVar6 = 0x21, param_2 == 0x21)) goto _L0;
    uVar7 = 0x17;
  }
  uVar5 = uVar6;
  if (param_2 != uVar7) {
...
_L0:
      ...
      esp_log(1,0x10000,"E (%lu) %s: Wrong cluster(0x%04x) to add attribute, expect 0x%04x\n",uVar4,
              0x10000,*(undefined2 *)(*(int *)(param_1 + 6) + 10),0x15);
    }
  }
  return 0x102;
}
