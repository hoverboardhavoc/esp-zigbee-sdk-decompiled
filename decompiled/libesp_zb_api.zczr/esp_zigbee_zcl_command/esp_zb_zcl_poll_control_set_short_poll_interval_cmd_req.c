 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_poll_control_set_short_poll_interval_cmd_req
 *
...
byte esp_zb_zcl_poll_control_set_short_poll_interval_cmd_req(int param_1)

{
  ...
  if ((param_1 != 0) && (iVar3 = zb_buf_get_out_func(), iVar3 != 0)) {
    ...
    zb_zcl_start_command_header(iVar3,1,0,3,0);
