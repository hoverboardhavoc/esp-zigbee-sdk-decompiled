 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_ias_ace_arm_cmd_req
 *
...
byte esp_zb_zcl_ias_ace_arm_cmd_req(int param_1)

{
  ...
  *puVar4 = *(undefined1 *)(param_1 + 0x10);
  ...
  puVar4[1] = bVar1;
  pvVar5 = memcpy(puVar4 + 2,(void *)(param_1 + 0x12),(uint)bVar1);
  puVar4 = (undefined1 *)((int)pvVar5 + (uint)*(byte *)(param_1 + 0x11));
  *puVar4 = *(undefined1 *)(param_1 + 0x110);
