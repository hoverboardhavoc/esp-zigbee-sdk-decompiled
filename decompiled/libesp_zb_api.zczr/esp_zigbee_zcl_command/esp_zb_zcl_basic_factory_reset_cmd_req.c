 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_basic_factory_reset_cmd_req
 *
...

{
  ...
  uVar4 = zb_zcl_start_command_header(1,0,0,0);
  zb_zcl_finish_and_send_packet
            (iVar3,uVar4,param_1,*(undefined1 *)(param_1 + 0xc),*(undefined1 *)(param_1 + 8),
             *(undefined1 *)(param_1 + 9),uVar2,0);
