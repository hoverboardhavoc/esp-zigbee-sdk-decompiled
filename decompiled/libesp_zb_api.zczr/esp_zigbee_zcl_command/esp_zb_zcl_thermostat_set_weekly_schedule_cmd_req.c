 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_thermostat_set_weekly_schedule_cmd_req
 *
...

{
  ...
  puVar6 = (undefined1 *)zb_zcl_start_command_header(1,0,0);
...
_L0:
  ...
  return pbVar8[(-(uint)((*pbVar8 & 4) == 0) & 0xfffffffe) + 3];
}
