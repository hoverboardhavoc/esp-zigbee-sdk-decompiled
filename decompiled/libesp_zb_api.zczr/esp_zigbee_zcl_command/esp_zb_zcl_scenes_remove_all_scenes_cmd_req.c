 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_scenes_remove_all_scenes_cmd_req
 *
...
byte esp_zb_zcl_scenes_remove_all_scenes_cmd_req(int param_1)
