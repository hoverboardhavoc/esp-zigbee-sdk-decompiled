 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_thermostat_clear_weekly_schedule_cmd_req
 *
...
byte esp_zb_zcl_thermostat_clear_weekly_schedule_cmd_req(int param_1)

{
  ...
  uVar4 = zb_zcl_start_command_header(1,0,3,0);
