 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_thermostat_get_relay_status_log_cmd_req
 *
...
byte esp_zb_zcl_thermostat_get_relay_status_log_cmd_req(int param_1)

{
  ...
  uVar4 = zb_zcl_start_command_header(0x11,0,4,0);
