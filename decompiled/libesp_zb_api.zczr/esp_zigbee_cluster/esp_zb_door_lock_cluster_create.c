 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_cluster.o -> esp_zb_door_lock_cluster_create
 *
...

{
  ...
  esp_zb_door_lock_cluster_add_attr(uVar1,0,&uStack_13);
  esp_zb_door_lock_cluster_add_attr(uVar1,1,&uStack_12);
  esp_zb_door_lock_cluster_add_attr(uVar1,2,auStack_11);
  return uVar1;
}
