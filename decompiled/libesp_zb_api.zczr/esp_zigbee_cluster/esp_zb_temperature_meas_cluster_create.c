 ...
 * Source: libesp_zb_api.zczr -> esp_zigbee_cluster.o -> esp_zb_temperature_meas_cluster_create
 *
...

{
  ...
  esp_zb_temperature_meas_cluster_add_attr(uVar1,0,&uStack_16);
  esp_zb_temperature_meas_cluster_add_attr(uVar1,1,&uStack_14);
  esp_zb_temperature_meas_cluster_add_attr(uVar1,2,auStack_12);
  return uVar1;
}
