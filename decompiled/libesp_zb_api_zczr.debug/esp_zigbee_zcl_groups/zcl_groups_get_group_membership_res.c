 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_groups.o -> zcl_groups_get_group_membership_res
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log_write(1,0x10000,&_LC4,uVar4,0x10000,"zcl_groups_get_group_membership_res",0x60);
  }
  return iVar1;
}
