 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_groups.o -> zcl_groups_get_add_group_res
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log_write(1,0x10000,&_LC1,uVar4,0x10000,"zcl_groups_get_add_group_res",0x37);
  }
  return iVar1;
}
