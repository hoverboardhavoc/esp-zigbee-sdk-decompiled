 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_privilege_command.o -> zb_zcl_privilege_command_handler
 *
...

{
  ...
  if (iVar2 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_ZCL_PRIVILEGE_COMMAND",&_LC1,uVar5,
