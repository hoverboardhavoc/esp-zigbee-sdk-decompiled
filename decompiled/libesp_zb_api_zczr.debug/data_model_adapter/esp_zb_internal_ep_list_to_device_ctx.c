 ...
 * Source: libesp_zb_api_zczr.debug -> data_model_adapter.o -> esp_zb_internal_ep_list_to_device_ctx
 *
...

{
  ...
  if (param_1 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_DM_ADAPTER",&_LC12,uVar3,"ESP_ZIGBEE_DM_ADAPTER",
                  "esp_zb_internal_ep_list_to_device_ctx",0x121);
  ...
  if (puVar1 == (undefined1 *)0x0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_DM_ADAPTER",&_LC13,uVar3,"ESP_ZIGBEE_DM_ADAPTER",
                  "esp_zb_internal_ep_list_to_device_ctx",0x127);
_L0:
    ...
    if (__nmemb == 0) {
      ...
      if (pvVar2 == (void *)0x0) {
        ...
        esp_log_write(1,"ESP_ZIGBEE_DM_ADAPTER",&_LC14,uVar3,"ESP_ZIGBEE_DM_ADAPTER",
                      "esp_zb_internal_ep_list_to_device_ctx",299);
        goto _L0;
      }
        ...
        *(void **)(*(int *)(puVar1 + 1) + iVar4 * 4) = __dest;
        if (__dest == (void *)0x0) {
          ...
          esp_log_write(1,"ESP_ZIGBEE_DM_ADAPTER",&_LC15,uVar3,"ESP_ZIGBEE_DM_ADAPTER",
                        "esp_zb_internal_ep_list_to_device_ctx",0x130);
          goto _L0;
        }
