 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_price.o -> zcl_price_get_current_price_handler
 *
...

{
  ...
  if (((uStack_28 >> 8 & 0xff) == 0) || (pvStack_24 == (void *)0x0)) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_ZCL_PRICE",&_L0,uVar3,"ESP_ZIGBEE_ZCL_PRICE");
    uVar3 = 0xffffffe4;
  }
  else {
