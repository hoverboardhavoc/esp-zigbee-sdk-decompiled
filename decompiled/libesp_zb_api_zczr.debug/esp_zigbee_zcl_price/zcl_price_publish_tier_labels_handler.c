 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_price.o -> zcl_price_publish_tier_labels_handler
 *
...

{
  ...
  if (bVar1 != 0) {
    ...
    if (pvStack_14 == (void *)0x0) {
      ...
      esp_log_write(1,"ESP_ZIGBEE_ZCL_PRICE",&_LC4,uVar5,"ESP_ZIGBEE_ZCL_PRICE",
                    "zcl_price_publish_tier_labels_handler",0xdf);
      return 0xffffffea;
    }
