 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_scenes.o -> esp_zb_zcl_scenes_group_check
 *
...

{
  ...
  if (param_2 < 0xfff8) {
    ...
    uVar2 = esp_log_timestamp();
    esp_log_write(2,"ESP_ZIGBEE_ZCL_SCENES",&_L0,uVar2,"ESP_ZIGBEE_ZCL_SCENES",param_2);
    uVar2 = 0x87;
  }
  return uVar2;
}
