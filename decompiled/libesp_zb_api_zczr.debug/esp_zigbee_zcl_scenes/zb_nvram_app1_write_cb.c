 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_scenes.o -> zb_nvram_app1_write_cb
 *
...

{
  ...
  do {
    ...
    iVar10 = iVar14 * 0xc;
    if ((&esp_zb_zcl_scenes_table + iVar10 != (byte *)0x0) && ((&DAT_00012bf6)[iVar14 * 6] != -1)) {
      pbVar13 = abStack_40 + uVar12 + iVar8;
      bVar1 = (&DAT_00012bf5)[iVar10];
      bVar2 = *(byte *)(&DAT_00012bf6 + iVar14 * 6);
      bVar3 = *(byte *)((int)&DAT_00012bf6 + iVar10 + 1);
      bVar4 = (&DAT_00012bf8)[iVar10];
      bVar5 = (&DAT_00012bf9)[iVar10];
      bVar6 = (&DAT_00012bfa)[iVar10];
      bVar7 = (&DAT_00012bfb)[iVar10];
      uVar11 = (uint)bVar7;
      *pbVar13 = (&esp_zb_zcl_scenes_table)[iVar10];
      ...
      pbVar13[7] = bVar7;
      uVar12 = uVar12 + 8;
      for (pbVar13 = (byte *)(&DAT_00012bfc)[iVar14 * 3]; uVar12 = uVar12 & 0xffff,
