 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_scenes.o -> zcl_scenes_add_scene_handler
 *
  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 == 0xff) {
      *puVar10 = 0x89;
      ...
      esp_log_write(2,"ESP_ZIGBEE_ZCL_SCENES",&_LC17,uVar11,"ESP_ZIGBEE_ZCL_SCENES",
                    *(undefined1 *)(puVar9 + 1));
      uVar11 = 0;
    }
    else {
      if ((&DAT_00012bf6)[iVar2 * 6] == -1) {
        uVar11 = 0;
      }
      else {
        device_scenes_table_record_free();
        uVar11 = esp_log_timestamp();
        esp_log_write(2,"ESP_ZIGBEE_ZCL_SCENES",&_L0,uVar11,"ESP_ZIGBEE_ZCL_SCENES",
                      *(undefined1 *)(puVar9 + 1),*puVar9);
        uVar11 = 0xffffffe5;
      }
      puVar12 = (undefined2 *)(&DAT_00012bfc)[iVar2 * 3];
      do {
        ...
        if (uVar3 < 3) {
          ...
          if (uVar3 < bVar8) {
            ...
            if (puVar4 != (undefined2 *)0x0) {
              iVar7 = iVar2 * 0xc;
              (&DAT_00012bf6)[iVar2 * 6] = *puVar9;
              (&DAT_00012bfa)[iVar7] = *(undefined1 *)(puVar9 + 1);
              *(undefined2 *)(&DAT_00012bf8 + iVar7) = *(undefined2 *)((int)puVar9 + 3);
              (&DAT_00012bfb)[iVar7] = (&DAT_00012bfb)[iVar7] + bVar8;
      ...
      *puVar10 = 0;
      ...
      if (iVar2 == 0) {
        ...
        uVar11 = esp_log_timestamp();
        esp_log_write(1,"ESP_ZIGBEE_ZCL_SCENES",&_LC6,uVar11,"ESP_ZIGBEE_ZCL_SCENES",
                      "zcl_scenes_add_scene_handler",0x1b1);
        uVar11 = 0xffffffff;
      }
    }
  }
