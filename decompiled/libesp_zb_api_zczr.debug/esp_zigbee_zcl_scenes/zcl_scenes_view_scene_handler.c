 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_scenes.o -> zcl_scenes_view_scene_handler
 *
...

{
  ...
  if ((iVar2 == 0xff) || ((&DAT_00012bf6)[iVar2 * 6] == -1)) {
    ...
    DAT_00012bda = *puVar1;
    DAT_00012bdc = *(undefined1 *)(puVar1 + 1);
