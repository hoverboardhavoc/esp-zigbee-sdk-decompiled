 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zcl_scenes_view_scene_res
 *
...
_L0:
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_L0,uVar6,"ESP_ZIGBEE_CORE","zcl_scenes_view_scene_res",0x95e
                 );
    iVar5 = 0;
  }
  else {
    ...
    if (iVar5 == 0) {
      ...
      uVar6 = esp_log_timestamp();
      esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC24,uVar6,"ESP_ZIGBEE_CORE","zcl_scenes_view_scene_res",
                    0x960);
    }
  }
  return iVar5;
