 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zcl_metering_request_fast_poll_mode_cb_handler
 *
...

{
  ...
  if (iVar2 == 0) {
    ...
    esp_log_write(2,"ESP_ZIGBEE_CORE",&_LC68,uVar5,"ESP_ZIGBEE_CORE");
    uVar6 = 5;
  }
  else {
  ...
  if ((iStack_24 == 0) && ((uStack_28 & 0xff) == 0)) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC69,uVar4,"ESP_ZIGBEE_CORE");
    uVar4 = 0xffffffe4;
  }
  else if (((uStack_28 & 0xff) < uVar6) || ((uint)(byte)*puVar7 < (uStack_28 & 0xff))) {
    uVar5 = esp_log_timestamp();
    esp_log_write(2,"ESP_ZIGBEE_CORE",&_LC70,uVar5,"ESP_ZIGBEE_CORE");
  }
