 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zcl_scenes_remove_scene_handler
 *
  ...
  *puVar5 = (char)iVar3;
  if (iVar3 == 0) {
    ...
    if ((iVar3 == 0xff) || ((&DAT_00019ae6)[iVar3 * 6] == -1)) {
      *puVar5 = 0x8b;
      ...
      esp_log_write(2,"ESP_ZIGBEE_CORE",&_LC48,uVar4,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar2 + 1),
                    *puVar2);
    }
    else {
  ...
  if (iVar3 != 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC46,uVar4,"ESP_ZIGBEE_CORE",
                  "zcl_scenes_remove_scene_handler",0x32e);
    iVar3 = -1;
  }
  return iVar3;
}
