 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zcl_scenes_store_scene_handler
 *
  ...
  if (iVar3 == 0) {
    ...
    if (iVar3 == 0xff) {
      *puVar7 = 0x89;
      ...
      esp_log_write(2,"ESP_ZIGBEE_CORE",&_LC78,uVar5,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar2 + 1));
      iVar3 = 0;
    }
    else {
      if ((&DAT_00019ae6)[iVar3 * 6] == -1) {
        (&DAT_00019ae6)[iVar3 * 6] = *puVar2;
        (&DAT_00019aea)[iVar3 * 0xc] = *(undefined1 *)(puVar2 + 1);
        (&DAT_00019ae8)[iVar3 * 6] = 0;
        uVar5 = esp_log_timestamp();
        esp_log_write(3,"ESP_ZIGBEE_CORE",&_LC77,uVar5,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar2 + 1)
                      ,*puVar2);
        iVar3 = 0;
      }
      else {
        uVar5 = esp_log_timestamp();
        esp_log_write(3,"ESP_ZIGBEE_CORE",&_LC76,uVar5,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar2 + 1)
                      ,*puVar2);
        iVar3 = -0x1b;
      }
      *puVar7 = 0;
