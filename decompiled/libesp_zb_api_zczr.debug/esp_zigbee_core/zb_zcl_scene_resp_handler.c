 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zb_zcl_scene_resp_handler
 *
...
_L0:
      ...
      esp_log_write(2,"ESP_ZIGBEE_CORE",&_LC25,uVar4,"ESP_ZIGBEE_CORE",*(undefined1 *)(iVar2 + 0x13)
                   );
      return 0;
    }
