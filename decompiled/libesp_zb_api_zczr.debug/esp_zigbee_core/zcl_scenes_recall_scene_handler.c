 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zcl_scenes_recall_scene_handler
 *
...

{
  ...
  *puVar7 = (char)iVar3;
  if (iVar3 == 0) {
    ...
    if ((iVar3 == 0xff) || ((&DAT_00019ae6)[iVar3 * 6] == -1)) {
      *puVar7 = 0x8b;
      uStack_38 = 0x8b;
      uVar5 = esp_log_timestamp();
      esp_log_write(2,"ESP_ZIGBEE_CORE",&_LC75,uVar5,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar2 + 1),
                    *puVar2);
    }
    else {
      uStack_24 = (&DAT_00019aec)[iVar3 * 3];
      *puVar7 = 0;
      uVar5 = esp_log_timestamp();
      esp_log_write(3,"ESP_ZIGBEE_CORE",&_LC74,uVar5,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar2 + 1),
                    *puVar2);
    }
  }
