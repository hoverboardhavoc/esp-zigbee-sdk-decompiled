 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zb_nvram_app1_read_cb
 *
...

{
  ...
  if (param_1 < 2) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC59,uVar13,"ESP_ZIGBEE_CORE","zb_nvram_app1_read_cb",0x91);
  }
  else {
    ...
    while (uVar10 + 8 <= (uVar9 + 2 & 0xffff)) {
      ...
      if (iVar12 == 0) {
        ...
        (&DAT_00019ae5)[iVar19] = uVar1;
        *(undefined1 *)(&DAT_00019ae6 + uVar17 * 6) = uVar2;
        *(undefined1 *)((int)&DAT_00019ae6 + iVar19 + 1) = uVar3;
        *(undefined1 *)(&DAT_00019ae8 + uVar17 * 6) = uVar4;
        *(undefined1 *)((int)&DAT_00019ae8 + iVar19 + 1) = uVar5;
        (&DAT_00019aea)[iVar19] = uVar6;
        (&DAT_00019aeb)[iVar19] = uVar7;
        uVar10 = uVar10 + 8;
