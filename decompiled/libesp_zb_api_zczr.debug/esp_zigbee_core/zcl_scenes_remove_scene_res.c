 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zcl_scenes_remove_scene_res
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_L0,uVar4,"ESP_ZIGBEE_CORE","zcl_scenes_remove_scene_res",
                  0x932);
  }
  return iVar1;
}
