 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zcl_ota_upgrade_handler
 *
...

{
  ...
  if (zb_core_action_cb == (code *)0x0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC3,uVar4,"ESP_ZIGBEE_CORE","zcl_ota_upgrade_handler",0x42e)
    ;
    return -1;
  }
  if (uStack_38 == 2) {
    ...
    if (__n + uVar6 < 0x39) {
      memcpy(ota_header_13,__src,__n);
    }
    else if (uVar6 < 0x38) {
      memcpy(ota_header_13 + uVar6,__src,0x38 - uVar6);
  ...
  uStack_34 = CONCAT22(ota_header_13._12_2_,ota_header_13._10_2_);
  uStack_30 = ota_header_13._14_4_;
  iStack_2c = ota_header_13._52_4_ + -0x38;
