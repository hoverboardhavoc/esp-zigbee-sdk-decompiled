...

{
  ...
  if (pbVar4 == (byte *)0x0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_L0,uVar3,"ESP_ZIGBEE_CORE",
                  "esp_zb_zcl_reset_endpoint_to_factory_default",0xce3);
    uVar3 = 0xffffffff;
  }
  else {
...
_L0:
    if (pbVar2 == (byte *)0x0) {
      uVar3 = esp_log_timestamp();
      esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC93,uVar3,"ESP_ZIGBEE_CORE",
                    "esp_zb_zcl_reset_endpoint_to_factory_default",0xcea,param_1);
      uVar3 = 0xffffffff;
    }
    else {
