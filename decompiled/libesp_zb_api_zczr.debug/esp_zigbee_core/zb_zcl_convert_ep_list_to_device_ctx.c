...

{
  ...
  if (puVar2 == (undefined1 *)0x0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC53,uVar4,"ESP_ZIGBEE_CORE",
                  "zb_zcl_convert_ep_list_to_device_ctx",0xbf8);
_L0:
    ...
    *puVar2 = (char)__nmemb;
    if (__nmemb == 0) {
      ...
      if (pvVar5 == (void *)0x0) {
        uVar4 = esp_log_timestamp();
        esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC54,uVar4,"ESP_ZIGBEE_CORE",
                      "zb_zcl_convert_ep_list_to_device_ctx",0xbfc);
        goto _L0;
      }
      uVar6 = 0;
      pvVar5 = param_1;
      while (pvVar5 = *(void **)((int)pvVar5 + 0x24), pvVar5 != (void *)0x0) {
        ...
        *(void **)(iVar1 + uVar6 * 4) = pvVar3;
        ...
        if (pvVar3 == (void *)0x0) {
          uVar4 = esp_log_timestamp();
          esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC55,uVar4,"ESP_ZIGBEE_CORE",
                        "zb_zcl_convert_ep_list_to_device_ctx",0xc01);
          goto _L0;
        }
