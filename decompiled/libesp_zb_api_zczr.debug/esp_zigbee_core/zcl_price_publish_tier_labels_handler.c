 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zcl_price_publish_tier_labels_handler
 *
...

{
  ...
  if (bVar1 != 0) {
    ...
    if (pvStack_14 == (void *)0x0) {
      ...
      esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC61,uVar5,"ESP_ZIGBEE_CORE",
                    "zcl_price_publish_tier_labels_handler",0x720);
      return 0xffffffea;
    }
  ...
  if (zb_core_action_cb == (code *)0x0) {
    ...
    (*zb_core_action_cb)(0x18,&uStack_2c);
