 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zb_nvram_app1_write_cb
 *
...

{
  ...
  do {
    ...
    iVar10 = iVar14 * 0xc;
    if ((&esp_zb_zcl_scenes_table + iVar10 != (byte *)0x0) && ((&DAT_00019ae6)[iVar14 * 6] != -1)) {
      pbVar13 = abStack_40 + uVar12 + iVar8;
      bVar1 = (&DAT_00019ae5)[iVar10];
      bVar2 = *(byte *)(&DAT_00019ae6 + iVar14 * 6);
      bVar3 = *(byte *)((int)&DAT_00019ae6 + iVar10 + 1);
      bVar4 = *(byte *)(&DAT_00019ae8 + iVar14 * 6);
      bVar5 = *(byte *)((int)&DAT_00019ae8 + iVar10 + 1);
      bVar6 = (&DAT_00019aea)[iVar10];
      bVar7 = (&DAT_00019aeb)[iVar10];
      uVar11 = (uint)bVar7;
      *pbVar13 = (&esp_zb_zcl_scenes_table)[iVar10];
      ...
      pbVar13[7] = bVar7;
      uVar12 = uVar12 + 8;
      for (pbVar13 = (byte *)(&DAT_00019aec)[iVar14 * 3]; uVar12 = uVar12 & 0xffff,
