 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_core.o -> zcl_metering_get_snapshot_cb_handler
 *
...

{
  ...
  if (zb_core_action_cb == (code *)0x0) {
    ...
    (*zb_core_action_cb)(0xc,auStack_7c);
  ...
  if (cVar3 == '\0') {
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC66,uVar9,"ESP_ZIGBEE_CORE");
    iVar7 = -0x1c;
  }
  else if (iVar7 == 0) {
    if (uVar5 < 6) {
    ...
    uVar9 = esp_log_timestamp();
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC67,uVar9,"ESP_ZIGBEE_CORE",uStack_a1);
    iVar7 = -0x1c;
  }
  return iVar7;
}
