 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_touchlink_commissioning.o -> zcl_touchlink_get_group_identifiers_resp_handler
 *
  ...
  if (iVar3 == 3) {
    ...
    *__ptr = *puVar5;
    ...
    if (iVar3 != 0) {
      ...
      esp_log_write(1,0x10000,&_LC2,uVar4,0x10000,"zcl_touchlink_get_group_identifiers_resp_handler"
                    ,0xd5);
      return iVar3;
    }
    auStack_64[0] = 0;
