 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_touchlink_commissioning.o -> zcl_touchlink_get_endpoint_list_resp_handler
 *
  ...
  if (iVar2 == 3) {
    ...
    *__ptr = *puVar4;
    ...
    if (iVar2 != 0) {
      ...
      esp_log_write(1,0x10000,&_LC4,uVar3,0x10000,"zcl_touchlink_get_endpoint_list_resp_handler",
                    0x110);
      return iVar2;
    }
    auStack_64[0] = 0;
