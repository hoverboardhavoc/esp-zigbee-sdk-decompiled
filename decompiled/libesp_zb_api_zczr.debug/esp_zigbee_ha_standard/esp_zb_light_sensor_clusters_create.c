 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_ha_standard.o -> esp_zb_light_sensor_clusters_create
 *
...

{
  ...
  uVar3 = esp_zb_illuminance_meas_cluster_create(iVar1);
  esp_zb_cluster_list_add_illuminance_meas_cluster(uVar2,uVar3,1);
  return uVar2;
}
