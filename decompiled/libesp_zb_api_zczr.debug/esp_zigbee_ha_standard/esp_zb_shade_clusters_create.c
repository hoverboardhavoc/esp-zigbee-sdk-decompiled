 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_ha_standard.o -> esp_zb_shade_clusters_create
 *
...

{
  ...
  uVar3 = esp_zb_shade_config_cluster_create(iVar1);
  esp_zb_cluster_list_add_shade_config_cluster(uVar2,uVar3,1);
  return uVar2;
}
