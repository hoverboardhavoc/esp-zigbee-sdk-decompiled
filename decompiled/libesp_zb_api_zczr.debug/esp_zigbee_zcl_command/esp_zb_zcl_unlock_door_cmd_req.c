 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_command.o -> esp_zb_zcl_unlock_door_cmd_req
 *
...
void esp_zb_zcl_unlock_door_cmd_req(int param_1)

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_L0,uVar2,"ESP_ZIGBEE_COMMAND",
                  "esp_zb_zcl_unlock_door_cmd_req",0x49b,*(undefined1 *)(param_1 + 9));
    ...
    *pcVar3 = *pcVar3 + '\x01';
    ...
    if (iVar1 == 0) {
      ...
      esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_LC6,uVar2,"ESP_ZIGBEE_COMMAND",
                    "esp_zb_zcl_unlock_door_cmd_req",0x49c,"esp_zb_zcl_unlock_door_cmd_req");
      pcVar3 = (char *)zb_zcl_get_ctx();
      *pcVar3 = *pcVar3 + '\x01';
    }
    else {
