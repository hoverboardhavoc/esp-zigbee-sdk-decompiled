 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_command.o -> esp_zb_zcl_thermostat_get_weekly_schedule_cmd_req
 *
...
void esp_zb_zcl_thermostat_get_weekly_schedule_cmd_req(int param_1)

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_L0,uVar4,"ESP_ZIGBEE_COMMAND",
                  "esp_zb_zcl_thermostat_get_weekly_schedule_cmd_req",0x5fd,
    ...
    *pcVar5 = *pcVar5 + '\x01';
    ...
    if (iVar2 == 0) {
      ...
      esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_LC6,uVar4,"ESP_ZIGBEE_COMMAND",
                    "esp_zb_zcl_thermostat_get_weekly_schedule_cmd_req",0x5fe,
                    "esp_zb_zcl_thermostat_get_weekly_schedule_cmd_req");
      pcVar5 = (char *)zb_zcl_get_ctx();
      *pcVar5 = *pcVar5 + '\x01';
    }
    else {
      puVar3 = (undefined1 *)zb_zcl_start_command_header(0x11,0,2,0);
      *puVar3 = *(undefined1 *)(param_1 + 0x10);
      puVar3[1] = *(undefined1 *)(param_1 + 0x11);
      zb_zcl_finish_and_send_packet
                (iVar2,puVar3 + 2,param_1,*(undefined1 *)(param_1 + 0xc),
                 *(undefined1 *)(param_1 + 8),*(undefined1 *)(param_1 + 9),
                 *(undefined2 *)(iVar1 + 1),0x201);
