 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_command.o -> esp_zb_zcl_scenes_recall_scene_cmd_req
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_L0,uVar3,"ESP_ZIGBEE_COMMAND",
                  "esp_zb_zcl_scenes_recall_scene_cmd_req",0x579,*(undefined1 *)(param_1 + 9));
    ...
    *pcVar4 = *pcVar4 + '\x01';
    ...
    if (iVar2 == 0) {
      ...
      esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_LC6,uVar3,"ESP_ZIGBEE_COMMAND",
                    "esp_zb_zcl_scenes_recall_scene_cmd_req",0x57a,
