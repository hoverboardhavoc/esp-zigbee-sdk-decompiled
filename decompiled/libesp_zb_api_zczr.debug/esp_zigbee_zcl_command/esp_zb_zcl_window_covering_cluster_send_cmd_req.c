...

{
  ...
  if (iVar2 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_L0,uVar5,"ESP_ZIGBEE_COMMAND",
                  "esp_zb_zcl_window_covering_cluster_send_cmd_req",0x5dd,
    ...
    *pcVar6 = *pcVar6 + '\x01';
    ...
    if (iVar3 == 0) {
      ...
      esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_LC6,uVar5,"ESP_ZIGBEE_COMMAND",
                    "esp_zb_zcl_window_covering_cluster_send_cmd_req",0x5de,
      ...
      *pcVar6 = *pcVar6 + '\x01';
      ...
      if ((bVar1 == 4) || (bVar1 == 7)) {
        ...
        *puVar4 = **(undefined1 **)(param_1 + 0x10);
        ...
        uVar5 = esp_log_timestamp();
        esp_log_write(3,"ESP_ZIGBEE_COMMAND",&_LC10,uVar5,"ESP_ZIGBEE_COMMAND",
