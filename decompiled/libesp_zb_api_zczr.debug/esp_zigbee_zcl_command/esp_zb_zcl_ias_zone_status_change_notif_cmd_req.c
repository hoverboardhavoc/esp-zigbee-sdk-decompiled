...

{
  ...
  if (iVar2 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_L0,uVar6,"ESP_ZIGBEE_COMMAND",
                  "esp_zb_zcl_ias_zone_status_change_notif_cmd_req",0x5b4,
    ...
    *pcVar5 = *pcVar5 + '\x01';
    ...
    if (iVar3 == 0) {
      ...
      esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_LC6,uVar6,"ESP_ZIGBEE_COMMAND",
                    "esp_zb_zcl_ias_zone_status_change_notif_cmd_req",0x5b5,
      ...
      *pcVar5 = cVar1 + '\x01';
      puVar4[1] = cVar1;
      puVar4[2] = 0;
      puVar4 = (undefined1 *)zb_put_next_htole16(puVar4 + 3,*(undefined2 *)(param_1 + 0x10));
      *puVar4 = *(undefined1 *)(param_1 + 0x12);
      puVar4[1] = *(undefined1 *)(param_1 + 0x13);
      uVar6 = zb_put_next_htole16(puVar4 + 2,*(undefined2 *)(param_1 + 0x14));
