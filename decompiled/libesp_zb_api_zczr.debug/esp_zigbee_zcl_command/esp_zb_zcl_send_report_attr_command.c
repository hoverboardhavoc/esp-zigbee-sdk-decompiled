...

{
  ...
  uVar2 = zb_zcl_construct_general_command_header
                    (uVar9 >> 0x12 & 1,uVar9 >> 0x10 & 3,*(undefined2 *)(param_1 + 0x14),
                     uVar9 >> 0x13 & 1,10);
  iVar3 = zb_buf_get_ptr_off_func(uVar1,uVar2);
...
_L0:
    ...
    if (iVar4 == 0) {
      uVar9 = zb_buf_get_ptr_off_func(uVar1,uVar2);
      uVar9 = 0x52 - (uVar9 & 0xffff);
    }
    else {
      iVar4 = zb_buf_get_max_size_func(uVar1);
      iVar6 = zb_buf_get_ptr_off_func(uVar1,uVar2);
    ...
    if (iVar4 == 0xffff) {
      ...
      esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_L0,uVar1,"ESP_ZIGBEE_COMMAND",
                    "esp_zb_zcl_send_report_attr_command",0x105);
      return;
    }
    if ((uVar9 & 0xffff) < iVar4 + 3U) {
      iVar4 = zb_zcl_can_cluster_be_fragmented
                        (*(undefined2 *)(iVar3 + 0x34),*(undefined2 *)(iVar3 + 2));
      if (iVar4 == 0) {
      ...
      iVar4 = zb_buf_get_max_size_func(uVar1);
      uVar8 = zb_buf_get_func(0,iVar4 + 1);
    ...
    *puVar7 = *(undefined1 *)(puVar5 + 1);
    uVar2 = esp_zb_zcl_put_attribute_value(puVar7 + 1,*(undefined4 *)(puVar5 + 3),iVar4);
    iVar3 = 0;
  } while( true );
}
