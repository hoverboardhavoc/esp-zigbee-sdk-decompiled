 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_command.o -> esp_zb_zcl_drlc_get_scheduled_events_req
 *
...
void esp_zb_zcl_drlc_get_scheduled_events_req(int param_1)

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_LC6,uVar2,"ESP_ZIGBEE_COMMAND",
                  "esp_zb_zcl_drlc_get_scheduled_events_req",0x8aa,
