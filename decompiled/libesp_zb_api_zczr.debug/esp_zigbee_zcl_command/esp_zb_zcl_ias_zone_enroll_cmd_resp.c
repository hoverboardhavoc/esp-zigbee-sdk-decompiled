 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_command.o -> esp_zb_zcl_ias_zone_enroll_cmd_resp
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_L0,uVar4,"ESP_ZIGBEE_COMMAND",
                  "esp_zb_zcl_ias_zone_enroll_cmd_resp",0x5a0,*(undefined1 *)(param_1 + 9));
    ...
    *pcVar5 = *pcVar5 + '\x01';
    ...
    if (iVar2 == 0) {
      ...
      esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_LC6,uVar4,"ESP_ZIGBEE_COMMAND",
                    "esp_zb_zcl_ias_zone_enroll_cmd_resp",0x5a1,
