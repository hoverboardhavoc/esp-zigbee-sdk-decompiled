 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_simple_meas.o -> esp_zb_zcl_carbon_dioxide_measurement_init_server
 *
...
{
  zb_zcl_add_cluster_handlers(0x40d,1,check_value_carbon_dioxide_measurement_server,0,0);
  return;
}
