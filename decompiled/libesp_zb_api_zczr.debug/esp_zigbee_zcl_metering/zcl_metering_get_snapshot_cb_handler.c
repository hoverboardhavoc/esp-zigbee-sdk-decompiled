 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_metering.o -> zcl_metering_get_snapshot_cb_handler
 *
...

{
  ...
  uStack_78 = *(undefined1 *)(iVar6 + 4);
  uStack_76 = 0x702;
  uStack_74 = *puVar3;
  uStack_70 = puVar3[1];
  uStack_6c = *(undefined1 *)(puVar3 + 2);
  uStack_68 = *(undefined4 *)((int)puVar3 + 9);
  uStack_64 = 0;
  uStack_60 = 0;
  uStack_5c = 0;
  uStack_58 = 0;
  ...
  uStack_38 = 0;
  uStack_34 = 0;
  esp_zb_core_action_handler_schedule(0xc,auStack_7c);
  iVar8 = esp_err_to_zb_ret();
  local_b0 = uStack_64;
  uStack_ac = uStack_60;
  cVar1 = (char)uStack_5c;
    ...
    if (uVar4 < 6) {
      ...
      if ((uVar4 - 2 & 0xff) < 2) {
        ...
        for (uVar5 = 0; uVar5 < uVar13; uVar5 = uVar5 + 1 & 0xff) {
          ...
          if (uVar4 < 3) {
            if (uVar12 < 3) {
              bStack_89 = (byte)uVar4;
              if (uVar4 + uVar12 < 4) {
                iStack_88 = uVar10 * 6 + iVar7;
                iVar6 = uVar11 * 6 + uVar14;
                uStack_84._0_2_ = CONCAT11((char)iVar6,(char)uVar12);
                uStack_84._0_3_ = CONCAT12((char)((uint)iVar6 >> 8),(undefined2)uStack_84);
                uStack_84 = CONCAT13((char)((uint)iVar6 >> 0x10),(undefined3)uStack_84);
                bStack_80 = (byte)((uint)iVar6 >> 0x18);
              }
              else {
                iStack_88 = uVar10 * 6 + iVar7;
                uVar10 = uVar10 + uVar4 & 0xff;
                uVar12 = (uVar4 - 3) + uVar12 & 0xff;
                iVar6 = uVar11 * 6 + uVar14;
                uStack_84 = CONCAT13((char)((uint)iVar6 >> 0x10),
                                     CONCAT12((char)((uint)iVar6 >> 8),
                                              CONCAT11((char)iVar6,(char)(3 - uVar4))));
                bStack_80 = (byte)((uint)iVar6 >> 0x18);
                uVar11 = (3 - uVar4 & 0xff) + uVar11 & 0xff;
                uVar4 = 0;
              }
            }
            else {
              ...
              iVar6 = uVar11 * 6 + uVar14;
              uStack_84._0_2_ = CONCAT11((char)iVar6,3);
              uStack_84._0_3_ = CONCAT12((char)((uint)iVar6 >> 8),(undefined2)uStack_84);
              uStack_84 = CONCAT13((char)((uint)iVar6 >> 0x10),(undefined3)uStack_84);
              bStack_80 = (byte)((uint)iVar6 >> 0x18);
      ...
      for (uVar5 = 0; uVar5 < uVar13; uVar5 = uVar5 + 1 & 0xff) {
        ...
        if (uVar4 < 6) {
          if (uVar12 < 6) {
            ...
            if (uVar4 + uVar12 < 7) {
              ...
              uStack_98._0_3_ = (undefined3)((uint)iVar7 >> 8);
              uVar10 = uVar10 + uVar4 & 0xff;
              uStack_98 = CONCAT13((char)(6 - uVar4),(undefined3)uStack_98);
              uVar12 = (uVar4 - 6) + uVar12 & 0xff;
              iStack_94 = uVar11 * 6 + iVar6;
              uVar11 = (6 - uVar4 & 0xff) + uVar11 & 0xff;
              uVar4 = 0;
            }
          }
          else {
        ...
        zb_buf_get_out_func();
        zb_zcl_metering_send_cmd_publish_snapshot
                  (iVar2 + 1,2,*(undefined1 *)(iVar2 + 0xb),*(undefined1 *)(iVar2 + 0xc),&local_b0,0
                  );
      }
      return 0;
    }
