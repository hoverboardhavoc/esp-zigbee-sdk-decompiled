 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_cluster.o -> esp_zb_cluster_list_add_binary_input_cluster
 *
...

{
  ...
  if (param_1 == 0) {
    ...
    do {
      ...
      if (*psVar2 == 0xf && *(byte *)(psVar2 + 4) == param_3) {
        uVar4 = esp_log_timestamp();
        esp_log_write(1,"ESP_ZIGBEE_CLUSTER",&_L0,uVar4,"ESP_ZIGBEE_CLUSTER",0xf);
        return 0x102;
      }
    ...
    if (param_3 == 1) {
      puVar5 = &zb_zcl_binary_input_init_server;
    }
    else if (param_3 == 2) {
      puVar5 = &zb_zcl_binary_input_init_client;
    }
    else {
