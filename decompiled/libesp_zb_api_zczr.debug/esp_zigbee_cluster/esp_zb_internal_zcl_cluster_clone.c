 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_cluster.o -> esp_zb_internal_zcl_cluster_clone
 *
...

{
  ...
  if ((param_1 == (void *)0x0) || (param_2 == (void *)0x0)) {
    ...
    esp_log_write(1,0x10000,&_L0,uVar2,0x10000,"esp_zb_internal_zcl_cluster_clone",0xa5,
                  "esp_zb_internal_zcl_cluster_clone");
    iVar1 = 0x102;
  }
  else {
