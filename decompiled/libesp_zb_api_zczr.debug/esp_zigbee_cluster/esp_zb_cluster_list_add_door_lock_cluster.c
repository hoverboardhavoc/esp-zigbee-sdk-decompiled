...

{
  ...
  aiStack_24[0] = 0;
  iVar1 = esp_zb_cluster_list_get_tail(param_1,param_2,0x101,param_3,aiStack_24);
  if (aiStack_24[0] == 0) {
    if (param_3 == 1) {
      puVar2 = &esp_zb_zcl_door_lock_init_server;
    }
    else if (param_3 == 2) {
      puVar2 = &esp_zb_zcl_door_lock_init_client;
    }
    else {
