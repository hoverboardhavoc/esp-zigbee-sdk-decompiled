 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_cluster.o -> esp_zb_cluster_list_add_ec_measurement_cluster
 *
...
int esp_zb_cluster_list_add_ec_measurement_cluster(int param_1,undefined4 param_2,int param_3)

{
  ...
  if (aiStack_24[0] == 0) {
    if (param_3 == 1) {
      puVar2 = &esp_zb_zcl_ec_measurement_init_server;
    }
    else {
