 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_cluster.o -> esp_zb_cluster_list_add_wind_speed_measurement_cluster
 *
...
int esp_zb_cluster_list_add_wind_speed_measurement_cluster
...

{
  ...
  aiStack_24[0] = 0;
  iVar1 = esp_zb_cluster_list_get_tail(param_1,param_2,0x40b,param_3,aiStack_24);
  if (aiStack_24[0] == 0) {
    if (param_3 == 1) {
      puVar2 = &esp_zb_zcl_wind_speed_measurement_init_server;
    }
    else {
