 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_attribute.o -> esp_zb_multistate_value_cluster_add_attr
 *
...

{
  ...
  aiStack_24[0] = 0;
  iVar4 = esp_zb_attr_list_get_tail(param_1,0x14,param_2,aiStack_24);
  if (aiStack_24[0] != 0) {
    free(__ptr);
    return aiStack_24[0];
  }
