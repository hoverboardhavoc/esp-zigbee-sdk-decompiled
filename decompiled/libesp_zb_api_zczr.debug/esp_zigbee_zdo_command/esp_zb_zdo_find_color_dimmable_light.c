 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zdo_command.o -> esp_zb_zdo_find_color_dimmable_light
 *
...
void esp_zb_zdo_find_color_dimmable_light(undefined2 *param_1,undefined4 param_2,undefined4 param_3)
