 ...
 * Source: libesp_zb_api_zczr.debug -> esp_zigbee_zcl_commissioning.o -> esp_zcl_process_commissioning_srv_specific_commands
 *
...

{
  ...
  if (param_1 == 0xff) {
    ...
    *(undefined1 **)(iVar1 + 0x240) = s_commissioning_server_cmd_list;
    uVar2 = 1;
  }
  else {
    ...
    if (iVar1 == 0) {
      ...
      uVar2 = esp_zcl_process_commissioning_srv_commands(param_1,auStack_30);
    }
    else {
      uVar2 = esp_log_timestamp();
      esp_log_write(1,"ESP_ZIGBEE_ZCL_COMMISSIONING",&_L0,uVar2,"ESP_ZIGBEE_ZCL_COMMISSIONING",
                    "esp_zcl_process_commissioning_srv_specific_commands",0x249);
      uVar2 = 1;
    }
  }
  return uVar2;
