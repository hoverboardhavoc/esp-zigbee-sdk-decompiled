 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_api_zdo_command.o -> find_device_cb
 *
  ...
  if ((*(char *)(iVar2 + 1) == '\0') && (*(char *)(iVar2 + 4) != '\0')) {
    ...
    if (iVar3 != 0) {
      _esp_error_check_failed
                ("/home/likunqiao/esp/esp-zboss/components/esp_zb_sdk/src/esp_zigbee_api_zdo_command.c"
