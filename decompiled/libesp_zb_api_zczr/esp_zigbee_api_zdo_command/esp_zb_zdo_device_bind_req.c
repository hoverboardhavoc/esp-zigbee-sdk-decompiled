 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_api_zdo_command.o -> esp_zb_zdo_device_bind_req
 *
...
void esp_zb_zdo_device_bind_req(undefined1 *param_1,undefined4 param_2)

{
  ...
  *(undefined2 *)(puVar9 + 0x16) = *(undefined2 *)(param_1 + 0x16);
  iVar10 = zb_zdo_bind_req(uVar8,bind_device_cb);
  *(undefined4 *)(bind_user_cb + iVar10 * 4) = param_2;
  return;
}
