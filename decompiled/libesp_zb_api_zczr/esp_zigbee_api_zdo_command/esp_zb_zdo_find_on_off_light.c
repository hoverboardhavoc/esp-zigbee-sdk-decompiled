 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_api_zdo_command.o -> esp_zb_zdo_find_on_off_light
 *
...
void esp_zb_zdo_find_on_off_light(undefined2 *param_1,undefined4 param_2)
