 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_api_zdo_command.o -> esp_zb_zdo_active_ep_req
 *
...
void esp_zb_zdo_active_ep_req(undefined2 *param_1,undefined4 param_2)

{
  ...
  *puVar3 = (char)uVar1;
  ...
  iVar4 = zb_zdo_active_ep_req(uVar2,active_ep_cb);
  *(undefined4 *)(active_ep_user_cb + iVar4 * 4) = param_2;
  return;
}
