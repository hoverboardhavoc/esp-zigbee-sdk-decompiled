 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_api_zcl_command.o -> esp_zb_zcl_level_move_to_level_with_onoff_cmd_req
 *
...

{
  ...
  puVar2 = (undefined1 *)zb_zcl_start_command_header(1,0,4,0);
  *puVar2 = *(undefined1 *)(param_1 + 0x10);
  uVar3 = zb_put_next_htole16(puVar2 + 1,*(undefined2 *)(param_1 + 0x12));
