 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_api_attribute.o -> esp_zb_level_cluster_add_attr
 *
...
undefined4 esp_zb_level_cluster_add_attr(int param_1,uint param_2,undefined4 param_3)
  ...
  if (param_1 == 0) {
    ...
    if ((*(ushort **)(param_1 + 0xc))[4] == 8) {
      ...
      *(undefined4 *)(__ptr + 6) = 0;
      ...
      uVar2 = esp_log_timestamp();
      esp_log_write(1,"ESP_ZIGBEE_ATTRIBUTE",&_LC9,uVar2,"ESP_ZIGBEE_ATTRIBUTE");
      uVar2 = 0x102;
    }
  }
  return uVar2;
