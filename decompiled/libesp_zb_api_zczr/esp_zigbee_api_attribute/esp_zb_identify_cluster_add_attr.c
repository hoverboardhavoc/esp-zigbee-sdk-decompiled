 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_api_attribute.o -> esp_zb_identify_cluster_add_attr
 *
...
undefined4 esp_zb_identify_cluster_add_attr(int param_1,uint param_2,undefined4 param_3)
