 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_on_off_cmd_req
 *
...
byte esp_zb_zcl_on_off_cmd_req(int param_1)

{
  ...
  uVar4 = zb_zcl_start_command_header(1,0,*(undefined1 *)(param_1 + 0x10),0);
