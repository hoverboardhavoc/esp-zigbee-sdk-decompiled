 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_identify_query_cmd_req
 *
...
byte esp_zb_zcl_identify_query_cmd_req(int param_1)

{
  ...
  if ((iVar2 != 0) && (iVar4 = zb_buf_get_out_func(), iVar4 != 0)) {
    uVar5 = zb_zcl_start_command_header(1,0,1,0);
