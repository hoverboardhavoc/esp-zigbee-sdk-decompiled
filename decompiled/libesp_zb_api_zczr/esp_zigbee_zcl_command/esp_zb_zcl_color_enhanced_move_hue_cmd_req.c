 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_color_enhanced_move_hue_cmd_req
 *
...
byte esp_zb_zcl_color_enhanced_move_hue_cmd_req(int param_1)
