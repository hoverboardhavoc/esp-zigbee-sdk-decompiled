...

{
  ...
  if (iVar5 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_LC7,uVar8,"ESP_ZIGBEE_COMMAND",
                  "esp_zb_zcl_report_attr_cmd_req",0x11e,param_1[10]);
    uVar8 = 0x106;
  }
  else if ((*(byte *)(iVar5 + 3) & 4) == 0) {
    uVar8 = esp_log_timestamp();
    esp_log_write(1,"ESP_ZIGBEE_COMMAND",&_LC8,uVar8,"ESP_ZIGBEE_COMMAND",
                  "esp_zb_zcl_report_attr_cmd_req",0x11f,param_1[10]);
    uVar8 = 0x106;
  }
  else {
