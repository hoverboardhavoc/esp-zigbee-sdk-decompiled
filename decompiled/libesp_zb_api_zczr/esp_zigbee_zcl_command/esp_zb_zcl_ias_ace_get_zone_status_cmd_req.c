 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_ias_ace_get_zone_status_cmd_req
 *
...
byte esp_zb_zcl_ias_ace_get_zone_status_cmd_req(int param_1)

{
  ...
  puVar4 = (undefined1 *)zb_zcl_start_command_header(1,0,9,0);
  *puVar4 = *(undefined1 *)(param_1 + 0x10);
  puVar4[1] = *(undefined1 *)(param_1 + 0x11);
  puVar4[2] = *(undefined1 *)(param_1 + 0x12);
  uVar5 = zb_put_next_htole16(*(undefined2 *)(param_1 + 0x13));
