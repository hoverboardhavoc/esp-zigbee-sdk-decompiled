 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_ias_ace_get_zone_information_cmd_req
 *
...
byte esp_zb_zcl_ias_ace_get_zone_information_cmd_req(int param_1)

{
  ...
  puVar4 = (undefined1 *)zb_zcl_start_command_header(1,0,6,0);
