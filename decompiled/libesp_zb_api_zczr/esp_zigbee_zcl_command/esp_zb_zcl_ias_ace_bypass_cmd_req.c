 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_zcl_command.o -> esp_zb_zcl_ias_ace_bypass_cmd_req
 *
...
byte esp_zb_zcl_ias_ace_bypass_cmd_req(int param_1)

{
  ...
  *pbVar6 = bVar1;
  pvVar5 = memcpy(pbVar6 + 1,(void *)(param_1 + 0x111),(uint)bVar1);
  zb_zcl_finish_and_send_packet
            (iVar3,(int)pvVar5 + (uint)*(byte *)(param_1 + 0x110),param_1,
