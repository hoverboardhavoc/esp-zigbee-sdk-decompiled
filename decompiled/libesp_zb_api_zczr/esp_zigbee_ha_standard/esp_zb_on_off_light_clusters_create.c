 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_ha_standard.o -> esp_zb_on_off_light_clusters_create
 *
...
undefined4 esp_zb_on_off_light_clusters_create(int param_1)

{
  ...
  uVar2 = esp_zb_on_off_cluster_create(iVar3);
