 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_ha_standard.o -> esp_zb_window_covering_controller_clusters_create
 *
...

{
  ...
  esp_zb_cluster_list_add_window_covering_cluster(uVar1,uVar2,2);
  return uVar1;
}
