 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_ha_standard.o -> esp_zb_window_covering_controller_cluster_create
 *
...
undefined4 esp_zb_window_covering_controller_cluster_create(int param_1)
