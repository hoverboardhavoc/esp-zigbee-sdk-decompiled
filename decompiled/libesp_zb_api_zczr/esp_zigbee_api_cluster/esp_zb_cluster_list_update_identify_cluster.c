 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_api_cluster.o -> esp_zb_cluster_list_update_identify_cluster
 *
...
undefined4 esp_zb_cluster_list_update_identify_cluster(int param_1,int param_2,int param_3)
