 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_api_cluster.o -> esp_zb_cluster_list_add_scenes_cluster
 *
...
undefined4 esp_zb_cluster_list_add_scenes_cluster(int param_1,int param_2,uint param_3)

{
  ...
  else if (*(short *)(*(int *)(param_2 + 0xc) + 8) == 5) {
    psVar1 = *(short **)(param_1 + 0x10);
    do {
      psVar2 = psVar1;
      if (psVar2 == (short *)0x0) break;
      if (*psVar2 == 5 && *(byte *)(psVar2 + 4) == param_3) {
        uVar5 = esp_log_timestamp();
        esp_log_write(1,"ESP_ZIGBEE_CLUSTER",&_LC5,uVar5,"ESP_ZIGBEE_CLUSTER",5);
        return 0x102;
      }
