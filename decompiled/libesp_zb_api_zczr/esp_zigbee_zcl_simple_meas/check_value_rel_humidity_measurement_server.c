 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_zcl_simple_meas.o -> check_value_rel_humidity_measurement_server
 *
...
int check_value_rel_humidity_measurement_server(uint param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (param_1 == 3) {
    ...
    if ((param_1 & 0xfffffffd) == 0) {
      iVar3 = zb_zcl_get_attr_desc_a(param_2,0x405,1,1);
    ...
    iVar3 = zb_zcl_get_attr_desc_a(param_2,0x405,1,2);
    if (**(ushort **)(iVar3 + 6) != 0xffff) {
