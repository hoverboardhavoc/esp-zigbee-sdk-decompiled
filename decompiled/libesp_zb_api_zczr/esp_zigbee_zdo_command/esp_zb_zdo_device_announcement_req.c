 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_zdo_command.o -> esp_zb_zdo_device_announcement_req
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log_write(1,0x10000,&_L0,uVar2,0x10000,"esp_zb_zdo_device_announcement_req",0x343);
  }
  else {
