 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_zdo_command.o -> ieee_addr_req_timeout
 *
...

{
  ...
  esp_log_write(3,0x10000,&_LC6,uVar1,0x10000);
  iVar2 = esp_zb_zdo_callback_find(param_1);
  if ((iVar2 != 0) && (*(code **)(iVar2 + 4) != (code *)0x0)) {
    (**(code **)(iVar2 + 4))(0x85,&ZDO_INVALID_IEEE_ADDR,*(undefined4 *)(iVar2 + 8));
  }
