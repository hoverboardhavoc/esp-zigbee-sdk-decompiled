 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_api_core.o -> esp_zb_device_add_basic_reset_default_cb
 *
...
void esp_zb_device_add_basic_reset_default_cb(undefined4 param_1)

{
  ...
  zcl_basic_reset_factory_user_cb = param_1;
  return;
}
