...

{
  ...
  iVar3 = esp_zb_cluster_list_check(param_1,param_2,0xe);
  if (iVar3 == 0) {
    ...
    while (__ptr_00 != (short *)0x0) {
      if (*__ptr_00 == sVar1) {
        local_30 = CONCAT22(uVar2,0xe);
        if (param_3 == 1) {
          puVar5 = &zb_zcl_analog_value_init_server;
        }
        else if (param_3 == 2) {
          puVar5 = &zb_zcl_analog_value_init_client;
        }
        else {
