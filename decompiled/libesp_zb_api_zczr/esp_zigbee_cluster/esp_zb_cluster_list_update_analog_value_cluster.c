 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_cluster.o -> esp_zb_cluster_list_update_analog_value_cluster
 *
...

{
  ...
  iVar2 = esp_zb_cluster_list_check(param_1,param_2,0xe);
  if (iVar2 == 0) {
    ...
    while (__ptr_00 != (short *)0x0) {
      if (*__ptr_00 == sVar1) {
        ...
        if (param_3 == 1) {
          puVar4 = &zb_zcl_analog_value_init_server;
        }
        else if (param_3 == 2) {
          puVar4 = &zb_zcl_analog_value_init_client;
        }
        else {
