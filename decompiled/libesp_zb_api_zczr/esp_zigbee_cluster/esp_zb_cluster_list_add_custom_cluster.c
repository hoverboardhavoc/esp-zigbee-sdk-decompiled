...

{
  ...
  if (aiStack_2c[0] == 0) {
    ...
    if (param_3 == 1) {
      puVar4 = &esp_zb_zcl_custom_cluster_init_server;
    }
    else if (param_3 == 2) {
      puVar4 = &esp_zb_zcl_custom_cluster_init_client;
    }
    else {
      puVar4 = (undefined *)0x0;
    }
    *(char *)((int)__ptr + 0xb) = (char)puVar4;
    *(char *)(__ptr + 6) = (char)((uint)puVar4 >> 8);
    *__ptr = uVar1;
    __ptr[1] = extraout_a0;
    ...
    *(char *)((int)__ptr + 0xd) = (char)((uint)puVar4 >> 0x10);
