 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_cluster.o -> esp_zb_cluster_list_update_occupancy_sensing_cluster
 *
...
int esp_zb_cluster_list_update_occupancy_sensing_cluster(int param_1,int param_2,undefined1 param_3)
