...

{
  ...
  if (param_1 == 0) {
    esp_zb_door_lock_cluster_add_attr(0,&lu8_lockstate_16);
    esp_zb_door_lock_cluster_add_attr(uVar1,1,&lu8_locktype_15);
    esp_zb_door_lock_cluster_add_attr(uVar1,2,&lu8_actuator_enable_14);
  }
  else {
