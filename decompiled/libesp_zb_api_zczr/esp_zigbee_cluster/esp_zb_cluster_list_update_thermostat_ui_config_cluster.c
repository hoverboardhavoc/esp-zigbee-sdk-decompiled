 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_cluster.o -> esp_zb_cluster_list_update_thermostat_ui_config_cluster
 *
...

{
  ...
  iVar2 = esp_zb_cluster_list_check(param_1,param_2,0x204);
  if (iVar2 == 0) {
