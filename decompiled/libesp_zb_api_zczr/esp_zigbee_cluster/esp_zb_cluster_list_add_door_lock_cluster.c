...
undefined4 esp_zb_cluster_list_add_door_lock_cluster(int param_1,int param_2,uint param_3)

{
  ...
  else if (*(short *)(*(int *)(param_2 + 0xc) + 10) == 0x101) {
    psVar1 = *(short **)(param_1 + 0x10);
    do {
      psVar2 = psVar1;
      if (psVar2 == (short *)0x0) break;
      if (*psVar2 == 0x101 && *(byte *)(psVar2 + 4) == param_3) {
        uVar5 = esp_log_timestamp();
        esp_log_write(1,"ESP_ZIGBEE_CLUSTER",&_LC5,uVar5,"ESP_ZIGBEE_CLUSTER",0x101);
        return 0x102;
      }
