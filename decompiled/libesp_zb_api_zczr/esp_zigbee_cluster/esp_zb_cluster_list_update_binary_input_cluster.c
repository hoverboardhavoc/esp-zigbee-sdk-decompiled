...
undefined4 esp_zb_cluster_list_update_binary_input_cluster(int param_1,int param_2,int param_3)

{
  ...
  if (param_1 == 0) {
    ...
    uVar4 = esp_log_timestamp();
    esp_log_write(1,"ESP_ZIGBEE_CLUSTER",&_LC11,uVar4,"ESP_ZIGBEE_CLUSTER");
    uVar4 = 0x102;
  }
  return uVar4;
}
