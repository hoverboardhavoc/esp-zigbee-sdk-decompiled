 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_cluster.o -> esp_zb_cluster_list_update_pm2_5_measurement_cluster
 *
...

{
  ...
  iVar2 = esp_zb_cluster_list_check(param_1,param_2,0x42a);
  if (iVar2 == 0) {
