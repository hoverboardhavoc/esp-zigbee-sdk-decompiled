...

{
  ...
  if (param_1 == 0) {
    esp_zb_color_control_cluster_add_attr(3,&lu16_color_control_current_X_34);
    esp_zb_color_control_cluster_add_attr(uVar1,4,&lu16_color_control_current_Y_33);
    esp_zb_color_control_cluster_add_attr(uVar1,8,&lu8_color_mode_32);
    esp_zb_color_control_cluster_add_attr(uVar1,0xf,&lu8_options_31);
    esp_zb_color_control_cluster_add_attr(uVar1,0x4001,&eu8_enhanced_color_mode_30);
    esp_zb_color_control_cluster_add_attr(uVar1,0x400a,&lu16_color_capabilities_29);
  }
  else {
