 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_cluster.o -> esp_zb_analog_value_cluster_create
 *
...
undefined4 esp_zb_analog_value_cluster_create(undefined1 *param_1)

{
  ...
  esp_zb_analog_value_cluster_add_attr(uVar1,0x51,&uStack_14);
  esp_zb_analog_value_cluster_add_attr(uVar1,0x55,&uStack_13);
  esp_zb_analog_value_cluster_add_attr(uVar1,0x6f,auStack_12);
  return uVar1;
}
