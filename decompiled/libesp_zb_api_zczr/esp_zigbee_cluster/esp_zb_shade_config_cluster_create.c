...

{
  ...
  if (param_1 == 0) {
    esp_zb_shade_config_cluster_add_attr(2,&lu8_status_26);
    esp_zb_shade_config_cluster_add_attr(uVar1,0x10,&lu8_closed_limit_25);
    esp_zb_shade_config_cluster_add_attr(uVar1,0x11,&lu8_mode_24);
  }
  else {
