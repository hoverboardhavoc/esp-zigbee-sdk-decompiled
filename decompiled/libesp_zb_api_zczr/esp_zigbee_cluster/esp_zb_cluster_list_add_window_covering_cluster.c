...

{
  ...
  iStack_24 = 0;
  iVar3 = esp_zb_cluster_list_get_tail(param_1,param_2,0x102,param_3,&iStack_24);
  iVar1 = iStack_24;
  if (iStack_24 == 0) {
    uVar4 = zcl_get_attr_lists(param_2);
    uVar2 = zcl_get_attr_count(param_2);
    uStack_34 = CONCAT22(uVar2,0x102);
    if (param_3 == 1) {
      puVar5 = &zb_zcl_window_covering_init_server;
    }
    else if (param_3 == 2) {
      puVar5 = &zb_zcl_window_covering_init_client;
    }
    else {
