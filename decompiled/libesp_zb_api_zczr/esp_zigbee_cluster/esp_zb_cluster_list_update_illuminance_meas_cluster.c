 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_cluster.o -> esp_zb_cluster_list_update_illuminance_meas_cluster
 *
...

{
  ...
  iVar3 = esp_zb_cluster_list_check(param_1,param_2,0x400);
  if (iVar3 == 0) {
