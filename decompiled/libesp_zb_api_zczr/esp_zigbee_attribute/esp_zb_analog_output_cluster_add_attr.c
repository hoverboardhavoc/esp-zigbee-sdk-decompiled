...
int esp_zb_analog_output_cluster_add_attr(int param_1,uint param_2,char *param_3)

{
  ...
  aiStack_24[0] = 0;
  iVar4 = esp_zb_attr_list_get_tail(param_1,0xd,param_2,aiStack_24);
  if (aiStack_24[0] != 0) {
    free(__ptr);
    return aiStack_24[0];
  }
...
_L0:
    ...
    if ((0x6f < param_2) || ((param_2 != 0x68 && (param_2 != 0x6a)))) goto _L0;
  }
  *(undefined1 *)((int)__ptr + 3) = 1;
  *(undefined1 *)(__ptr + 1) = 0x39;
  pcVar5 = (char *)malloc(4);
