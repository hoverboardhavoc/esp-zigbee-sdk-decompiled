...
int esp_zb_carbon_dioxide_measurement_cluster_add_attr(int param_1,int param_2,void *param_3)

{
  ...
  aiStack_24[0] = 0;
  iVar2 = esp_zb_attr_list_get_tail(param_1,0x40d,param_2,aiStack_24);
  iVar1 = aiStack_24[0];
  if (aiStack_24[0] == 0) {
    *__ptr = (short)param_2;
    if (param_2 == 0) {
