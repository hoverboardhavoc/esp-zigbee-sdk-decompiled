...
undefined4 esp_zb_ias_zone_cluster_add_attr(int param_1,uint param_2,undefined4 param_3)

{
  ...
  if ((*(ushort **)(param_1 + 0xc))[5] != 0x500) {
    uVar2 = esp_log_timestamp();
    esp_log_write(1,"ESP_ZIGBEE_ATTRIBUTE",&_LC16,uVar2,"ESP_ZIGBEE_ATTRIBUTE");
    return 0x102;
  }
  do {
    puVar3 = puVar1;
