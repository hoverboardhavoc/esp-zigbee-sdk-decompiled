 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_core.o -> esp_zb_groups_view_group_resp_cb
 *
...
void esp_zb_groups_view_group_resp_cb(undefined4 param_1)

{
  esp_zb_check_initialize_endpoint_handler();
  zcl_view_group_resp_user_cb = param_1;
  return;
}
