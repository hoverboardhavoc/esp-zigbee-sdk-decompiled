...
_L0:
        if (pbVar1 != (byte *)0x0) {
          ...
          uStack_24 = *(undefined2 *)(pbVar1 + 1);
          iVar2 = (*zb_core_action_cb)(0x1001,local_40,zb_core_action_cb);
        }
      }
      else {
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_L0,uVar3,"ESP_ZIGBEE_CORE","zcl_cmd_write_attr_resp_handler"
                  ,0x484);
  }
  return iVar2;
}
