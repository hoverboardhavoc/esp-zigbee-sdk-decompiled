...

{
  ...
  if (uVar1 < 10) {
    *(undefined2 *)(&DAT_00015ace + uVar1 * 0xc) = param_2;
    (&DAT_00015ad1)[uVar1 * 0xc] = 0;
    if ((&DAT_00015ad4)[uVar1 * 3] != 0) {
      device_scene_free_fields();
      (&DAT_00015ad4)[uVar1 * 3] = 0;
    }
    puVar5 = (undefined2 *)(&DAT_00015ad4)[uVar1 * 3];
    for (; param_3 != (undefined2 *)0x0; param_3 = *(undefined2 **)(param_3 + 4)) {
      puVar2 = (undefined2 *)malloc(0xc);
      (&DAT_00015ad1)[uVar1 * 0xc] = (&DAT_00015ad1)[uVar1 * 0xc] + *(char *)(param_3 + 1) + '\x03';
      *puVar2 = *param_3;
    ...
    if (iVar3 != 0) {
      ...
      esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC42,uVar4,"ESP_ZIGBEE_CORE",
                    "esp_zb_zcl_scenes_table_store",0x34c);
      iVar3 = -1;
    }
  }
  else {
