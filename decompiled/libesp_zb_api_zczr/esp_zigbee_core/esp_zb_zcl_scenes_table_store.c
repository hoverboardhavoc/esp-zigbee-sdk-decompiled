...

{
  ...
  if (uVar1 < 10) {
    *(undefined2 *)(&DAT_000136e6 + uVar1 * 0xc) = param_2;
    (&DAT_000136e9)[uVar1 * 0xc] = 0;
    if ((&DAT_000136ec)[uVar1 * 3] != 0) {
      device_scene_free_fields();
    }
    puVar4 = (undefined2 *)(&DAT_000136ec)[uVar1 * 3];
    for (; param_3 != (undefined2 *)0x0; param_3 = *(undefined2 **)(param_3 + 4)) {
      puVar2 = (undefined2 *)malloc(0xc);
      (&DAT_000136e9)[uVar1 * 0xc] = (&DAT_000136e9)[uVar1 * 0xc] + *(char *)(param_3 + 1) + '\x03';
      *puVar2 = *param_3;
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC32,uVar3,"ESP_ZIGBEE_CORE","esp_zb_zcl_scenes_table_store"
                  ,0x27c,param_1);
    uVar3 = 0xffffffff;
  }
  return uVar3;
