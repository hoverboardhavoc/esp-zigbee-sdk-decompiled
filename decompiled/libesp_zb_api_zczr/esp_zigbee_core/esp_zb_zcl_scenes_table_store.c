...

{
  ...
  if (uVar1 < 10) {
    *(undefined2 *)(&DAT_00015942 + uVar1 * 0xc) = param_2;
    (&DAT_00015945)[uVar1 * 0xc] = 0;
    if ((&DAT_00015948)[uVar1 * 3] != 0) {
      device_scene_free_fields();
      (&DAT_00015948)[uVar1 * 3] = 0;
    }
    puVar5 = (undefined2 *)(&DAT_00015948)[uVar1 * 3];
    for (; param_3 != (undefined2 *)0x0; param_3 = *(undefined2 **)(param_3 + 4)) {
      puVar2 = (undefined2 *)malloc(0xc);
      (&DAT_00015945)[uVar1 * 0xc] = (&DAT_00015945)[uVar1 * 0xc] + *(char *)(param_3 + 1) + '\x03';
      *puVar2 = *param_3;
