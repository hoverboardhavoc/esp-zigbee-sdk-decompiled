...
int zcl_thermostat_value_cb_handler(void)

{
  ...
  local_20 = 0;
  uStack_1a = 0x201;
  uStack_18 = *(undefined1 *)(iVar2 + 0xc);
  uStack_16 = *(undefined2 *)(iVar2 + 0xe);
  uStack_14 = *(undefined2 *)(iVar2 + 0x10);
  if (zb_core_action_cb == (code *)0x0) {
    return 0;
  }
  iVar2 = (*zb_core_action_cb)(7,&local_20);
  if (iVar2 == 0x105) {
    iVar1 = -0x1c;
  }
  else if (iVar2 < 0x106) {
