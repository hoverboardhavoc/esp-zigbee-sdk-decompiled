 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_core.o -> esp_zb_device_add_level_control_set_value_cb
 *
...
void esp_zb_device_add_level_control_set_value_cb(undefined4 param_1)

{
  zcl_level_control_set_value_cb = param_1;
  return;
}
