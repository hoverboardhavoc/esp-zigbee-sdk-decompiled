 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_core.o -> esp_zb_device_add_ias_zone_enroll_response_cb
 *
...
void esp_zb_device_add_ias_zone_enroll_response_cb(undefined4 param_1)

{
  zcl_ias_zone_enroll_resp_cb = param_1;
  return;
}
