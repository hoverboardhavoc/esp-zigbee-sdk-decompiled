...

{
  ...
  iVar1 = zb_aps_is_endpoint_in_group(DAT_00017818,DAT_000177e8);
  if (iVar1 == 0) {
    ...
    *puVar2 = 0x19;
    ...
    puVar2[3] = 0x85;
    puVar2[4] = 0xff;
    pcVar3 = (char *)zb_put_next_htole16(puVar2 + 5,DAT_00017818);
  }
  else {
    puVar2 = (undefined1 *)zb_buf_reuse_func(param_1);
    *puVar2 = 0x19;
    ...
    puVar2[3] = 0;
    puVar2[4] = 0;
    pcVar4 = (char *)zb_put_next_htole16(puVar2 + 5,DAT_00017818);
    *pcVar4 = '\0';
    pcVar3 = pcVar4 + 1;
    for (uVar5 = 0; uVar5 < 0x10; uVar5 = uVar5 + 1 & 0xff) {
      if (((&esp_zb_zcl_scenes_table)[uVar5 * 0xc] == DAT_000177e8) &&
         ((&DAT_0001781e)[uVar5 * 6] == DAT_00017818)) {
        *pcVar4 = *pcVar4 + '\x01';
        *pcVar3 = (&DAT_00017822)[uVar5 * 0xc];
        pcVar3 = pcVar3 + 1;
      }
      else if ((&DAT_0001781e)[uVar5 * 6] == -1) {
        puVar2[4] = puVar2[4] + '\x01';
      }
    }
  }
  zb_zcl_finish_and_send_packet
            (param_1,pcVar3,&scene_resp_info,2,DAT_000177e7,DAT_000177e8,DAT_000177ec >> 8 & 0xffff,
             5);
  return;
}
