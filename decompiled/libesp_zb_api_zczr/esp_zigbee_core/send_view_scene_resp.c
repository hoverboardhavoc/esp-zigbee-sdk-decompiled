...

{
  ...
  if ((param_2 == 0xff) || (*(short *)(&DAT_000176fa + param_2 * 0xc) == -1)) {
    iVar4 = zb_aps_is_endpoint_in_group(DAT_000176de,DAT_000176c4);
    if (iVar4 == 0) {
      cVar5 = -0x7b;
    }
    else {
  ...
  *puVar2 = 0x19;
  ...
  puVar2[2] = 1;
  puVar2[3] = cVar5;
  puVar2 = (undefined1 *)zb_put_next_htole16(puVar2 + 4,DAT_000176de);
  *puVar2 = DAT_000176e0;
  puVar3 = puVar2 + 1;
  if (cVar5 == '\0') {
    puVar2[1] = (&DAT_000176fc)[param_2 * 0xc];
    puVar2[2] = (&DAT_000176fd)[param_2 * 0xc];
    puVar2[3] = 0;
    puVar3 = puVar2 + 4;
    for (puVar1 = (undefined2 *)(&DAT_00017700)[param_2 * 3]; puVar1 != (undefined2 *)0x0;
  ...
  zb_zcl_finish_and_send_packet
            (param_1,puVar3,&scene_resp_info,2,DAT_000176c3,DAT_000176c4,DAT_000176c8 >> 8 & 0xffff,
             5);
  return;
}
