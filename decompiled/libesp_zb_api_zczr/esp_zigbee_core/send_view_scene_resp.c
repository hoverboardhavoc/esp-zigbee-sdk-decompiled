...

{
  ...
  if ((param_2 == 0xff) || ((&esp_zb_zcl_scenes_table)[param_2 * 6] == -1)) {
    iVar4 = zb_aps_is_endpoint_in_group(DAT_00012250,DAT_00012238);
    if (iVar4 == 0) {
      cVar8 = -0x7b;
    }
    else {
  ...
  *puVar2 = 0x19;
  ...
  puVar2[2] = 1;
  puVar2[3] = cVar8;
  puVar2 = (undefined1 *)zb_put_next_htole16(puVar2 + 4,DAT_00012250);
  *puVar2 = DAT_00012252;
  puVar3 = puVar2 + 1;
  if (cVar8 == '\0') {
    puVar2[1] = (&DAT_000121b6)[param_2 * 0xc];
    puVar2[2] = (&DAT_000121b7)[param_2 * 0xc];
    puVar2[3] = 0;
    puVar3 = puVar2 + 4;
    puVar1 = (undefined2 *)(&DAT_000121bc)[param_2 * 3];
    uVar7 = 0;
    bVar5 = 0;
    while( true ) {
      if ((byte)(&DAT_000121b9)[param_2 * 0xc] <= bVar5) break;
      ...
      *puVar3 = *(undefined1 *)(puVar1 + 1);
      ...
      bVar5 = *(char *)(uVar7 * 0xc + (&DAT_000121bc)[param_2 * 3] + 2) + bVar5;
      uVar7 = uVar7 + 1 & 0xff;
      puVar1 = *(undefined2 **)(puVar1 + 4);
    }
  }
  zb_zcl_finish_and_send_packet
            (param_1,puVar3,&scene_resp_info,2,DAT_00012237,DAT_00012238,DAT_0001223c,5);
  return;
}
