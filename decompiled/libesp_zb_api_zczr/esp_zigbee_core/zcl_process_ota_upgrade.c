...

{
  ...
  if (bVar1 == 3) {
    ...
    if (iVar7 != 0) {
      ...
      esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC27,uVar4,"ESP_ZIGBEE_CORE",uVar3);
    }
    do {
      ...
      uVar4 = esp_log_timestamp();
      esp_log_write(3,"ESP_ZIGBEE_CORE",&_LC29,uVar4,"ESP_ZIGBEE_CORE");
      esp_restart();
_L0:
      uVar4 = esp_log_timestamp();
      ...
      if ((uVar6 < 0x38) && (uVar5 = *(byte *)(param_1 + 0x14) + uVar6, 0x38 < uVar5)) {
        ...
        if (update_partition == 0) {
          __assert_func("//home/xieqinan/ESP/esp-zboss/components/esp_zb_sdk/src/esp_zigbee_core.c",
                        0x2e9,"zcl_process_ota_upgrade","update_partition != NULL");
        }
        else {
          ...
          if (iVar2 != 0) {
            ...
            esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC24,uVar4,"ESP_ZIGBEE_CORE",uVar3);
            return;
          }
        }
        ...
        if (iVar7 != 0) {
          uVar4 = esp_log_timestamp();
          esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC25,uVar4,"ESP_ZIGBEE_CORE",iVar7);
          return;
        }
      }
