 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_core.o -> esp_zb_device_add_scenes_store_cmd_cb
 *
...
void esp_zb_device_add_scenes_store_cmd_cb(undefined4 param_1)

{
  zcl_scenes_store_user_cb = param_1;
  return;
}
