...

{
  ...
  *puVar7 = (char)iVar3;
  if (iVar3 == 0) {
    ...
    if ((iVar3 == 0xff) || ((&DAT_00018e5e)[iVar3 * 6] == -1)) {
      *puVar7 = 0x8b;
      uStack_38 = 0x8b;
      uVar5 = esp_log_timestamp();
      esp_log_write(2,"ESP_ZIGBEE_CORE",&_LC68,uVar5,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar2 + 1),
                    *puVar2);
    }
    else {
      uStack_24 = (&DAT_00018e64)[iVar3 * 3];
      *puVar7 = 0;
      uVar5 = esp_log_timestamp();
      esp_log_write(3,"ESP_ZIGBEE_CORE",&_LC67,uVar5,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar2 + 1),
                    *puVar2);
    }
  }
