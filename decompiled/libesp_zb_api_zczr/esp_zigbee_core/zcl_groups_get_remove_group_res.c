 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_core.o -> zcl_groups_get_remove_group_res
 *
...

{
  ...
  if (iVar1 == 0) {
    ...
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_L0,uVar4,"ESP_ZIGBEE_CORE","zcl_groups_get_remove_group_res"
                  ,0x7f6);
  }
  return iVar1;
}
