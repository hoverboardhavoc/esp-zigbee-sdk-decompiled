 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_core.o -> esp_zb_check_initialize_device_callback
 *
...
void esp_zb_check_initialize_device_callback(void)

{
  int iVar1;
  
  if (zb_device_cb_initialized_2 != '\0') {
    return;
  }
  iVar1 = zb_zcl_get_ctx();
  *(code **)(iVar1 + 0x9c) = zcl_device_callback_entry;
  zb_device_cb_initialized_2 = 1;
  return;
}
