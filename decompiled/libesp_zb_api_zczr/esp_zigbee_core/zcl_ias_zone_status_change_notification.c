...

{
  ...
  if (iVar2 == 0) {
    ...
    uStack_14 = __ptr[2];
    auStack_34[0] = (uint)(5 >= uVar1);
    iVar2 = (*zb_core_action_cb)(0x1031,auStack_34,zb_core_action_cb);
    free(__ptr);
  }
  else {
    uVar4 = esp_log_timestamp();
    esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC7,uVar4,"ESP_ZIGBEE_CORE",
                  "zcl_ias_zone_status_change_notification",0x66e);
  }
  return iVar2;
}
