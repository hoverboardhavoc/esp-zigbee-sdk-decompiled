 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_core.o -> esp_zb_zcl_groups_get_remove_group_res
 *
...
void esp_zb_zcl_groups_get_remove_group_res(undefined4 param_1)

{
  ...
  if ((uVar1 < 3) ||
    ...
    (*zcl_remove_group_resp_user_cb)(1,0,zcl_remove_group_resp_user_cb);
  }
  else {
    (*zcl_remove_group_resp_user_cb)
              (*puVar2,*(undefined2 *)(puVar2 + 1),zcl_remove_group_resp_user_cb);
  }
  return;
}
