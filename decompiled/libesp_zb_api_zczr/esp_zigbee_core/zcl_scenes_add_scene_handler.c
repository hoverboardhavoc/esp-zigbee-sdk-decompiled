  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 == 0xff) {
      *puVar10 = 0x89;
      ...
      puVar9 = (undefined2 *)(&DAT_00015a58)[iVar2 * 3];
      do {
        ...
        if (uVar3 < 3) {
          ...
          if (uVar3 < bVar1) {
            ...
            if (puVar4 != (undefined2 *)0x0) {
              ...
              (&DAT_00015a54)[iVar7] = *(undefined1 *)(puVar8 + 1);
              (&DAT_00015a52)[iVar2 * 6] = *(undefined2 *)((int)puVar8 + 3);
              (&DAT_00015a55)[iVar7] = (&DAT_00015a55)[iVar7] + bVar1;
      ...
      *puVar10 = 0;
      ...
      if (iVar2 == 0) {
        ...
        esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC50,uVar11,"ESP_ZIGBEE_CORE",
                      "zcl_scenes_add_scene_handler",0x2b9);
        uVar11 = 0xffffffff;
      }
    }
  }
