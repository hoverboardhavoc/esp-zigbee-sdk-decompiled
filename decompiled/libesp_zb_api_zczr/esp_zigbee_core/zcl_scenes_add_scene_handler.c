...

{
  ...
  *puVar9 = (char)iVar3;
  if (iVar3 == 0) {
    ...
    if (iVar3 != 0xff) {
      uVar10 = 0;
      if ((&DAT_00015ba2)[iVar3 * 6] != -1) {
        device_scenes_table_record_free();
        uVar10 = 0xffffffe5;
      }
      iVar8 = iVar3 * 0xc;
      puVar11 = (undefined2 *)(&DAT_00015ba8)[iVar3 * 3];
      while (uVar4 = zb_buf_len_func(param_1), 2 < uVar4) {
        ...
        (&DAT_00015ba2)[iVar3 * 6] = *puVar2;
        (&DAT_00015ba6)[iVar8] = *(undefined1 *)(puVar2 + 1);
        (&DAT_00015ba4)[iVar3 * 6] = *(undefined2 *)((int)puVar2 + 3);
        (&DAT_00015ba7)[iVar8] = bVar7 + (&DAT_00015ba7)[iVar8];
