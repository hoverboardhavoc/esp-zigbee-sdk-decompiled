  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 == 0xff) {
      *puVar10 = 0x89;
      ...
      esp_log_write(2,"ESP_ZIGBEE_CORE",&_LC54,uVar11,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar8 + 1))
      ;
      uVar11 = 0;
    }
    else {
      if ((&esp_zb_zcl_scenes_table)[iVar2 * 6] == -1) {
        ...
        uVar11 = esp_log_timestamp();
        esp_log_write(2,"ESP_ZIGBEE_CORE",&_LC52,uVar11,"ESP_ZIGBEE_CORE",
                      *(undefined1 *)(puVar8 + 1),*puVar8);
        uVar11 = 0xffffffe5;
      }
      puVar9 = (undefined2 *)(&DAT_000158e8)[iVar2 * 3];
      do {
        ...
        if (uVar3 < 3) {
          ...
          if (uVar3 < bVar1) {
            ...
            if (puVar4 != (undefined2 *)0x0) {
              ...
              (&DAT_000158e4)[iVar7] = *(undefined1 *)(puVar8 + 1);
              *(undefined2 *)(&DAT_000158e2 + iVar7) = *(undefined2 *)((int)puVar8 + 3);
              (&DAT_000158e5)[iVar7] = (&DAT_000158e5)[iVar7] + bVar1;
      ...
      *puVar10 = 0;
      ...
      if (iVar2 == 0) {
        ...
        esp_log_write(3,"ESP_ZIGBEE_CORE",&_LC53,uVar6,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar8 + 1)
                      ,*puVar8);
      }
      else {
        uVar11 = esp_log_timestamp();
        esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC49,uVar11,"ESP_ZIGBEE_CORE",
