  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 == 0xff) {
      *puVar10 = 0x89;
      ...
      esp_log_write(2,"ESP_ZIGBEE_CORE",&_LC42,uVar11,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar9 + 1))
      ;
      uVar11 = 0;
    }
    else {
      if (*(short *)(&DAT_000176fa + iVar2 * 0xc) == -1) {
        uVar11 = 0;
      }
      else {
      ...
      puVar12 = (undefined2 *)(&DAT_00017700)[iVar2 * 3];
      do {
        ...
        if (uVar3 < 3) {
          ...
          if (uVar3 < bVar8) {
            ...
            if (puVar4 != (undefined2 *)0x0) {
              iVar7 = iVar2 * 0xc;
              *(undefined2 *)(&DAT_000176fa + iVar7) = *puVar9;
              (&DAT_000176fe)[iVar7] = *(undefined1 *)(puVar9 + 1);
              *(undefined2 *)(&DAT_000176fc + iVar7) = *(undefined2 *)((int)puVar9 + 3);
              (&DAT_000176ff)[iVar7] = (&DAT_000176ff)[iVar7] + bVar8;
      ...
      *puVar10 = 0;
      ...
      if (iVar2 == 0) {
        ...
        esp_log_write(3,"ESP_ZIGBEE_CORE",&_LC41,uVar6,"ESP_ZIGBEE_CORE",*(undefined1 *)(puVar9 + 1)
                      ,*puVar9);
      }
      else {
        uVar11 = esp_log_timestamp();
        esp_log_write(1,"ESP_ZIGBEE_CORE",&_LC37,uVar11,"ESP_ZIGBEE_CORE",
                      "zcl_scenes_add_scene_handler",0x314);
        uVar11 = 0xffffffff;
      }
    }
  }
