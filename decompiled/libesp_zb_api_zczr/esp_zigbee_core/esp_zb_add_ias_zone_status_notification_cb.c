 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_core.o -> esp_zb_add_ias_zone_status_notification_cb
 *
...
void esp_zb_add_ias_zone_status_notification_cb(undefined4 param_1)

{
  esp_zb_check_initialize_endpoint_handler();
  zcl_ias_zone_status_notification_cb = param_1;
  return;
}
