...

{
  ...
  puVar11 = (undefined4 *)&esp_zb_zcl_scenes_table;
  __dest = (undefined4 *)&esp_zb_zcl_scenes_table;
  uVar5 = 2;
  do {
    uVar10 = uVar5 + 8;
    do {
      if (((uVar3 + 2 & 0xffff) < uVar10) || (__dest == &zcl_cli_resp_user_cb)) {
        do {
          if (*(short *)((int)puVar11 + 2) != -1) {
            zb_zcl_scenes_set_scene_count(*(undefined1 *)puVar11,1);
          }
          puVar11 = puVar11 + 3;
        } while (puVar11 != &zcl_cli_resp_user_cb);
        return;
      }
    } while (iVar6 != 0);
