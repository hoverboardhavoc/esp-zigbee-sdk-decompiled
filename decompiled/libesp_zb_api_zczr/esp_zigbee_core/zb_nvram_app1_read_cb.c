  ...
  if (param_1 < 2) {
    ...
    while (uVar10 + 8 <= (uVar9 + 2 & 0xffff)) {
      ...
      if (iVar12 == 0) {
        ...
        (&DAT_00018f0d)[iVar19] = uVar1;
        *(undefined1 *)(&DAT_00018f0e + uVar17 * 6) = uVar2;
        *(undefined1 *)((int)&DAT_00018f0e + iVar19 + 1) = uVar3;
        *(undefined1 *)(&DAT_00018f10 + uVar17 * 6) = uVar4;
        *(undefined1 *)((int)&DAT_00018f10 + iVar19 + 1) = uVar5;
        (&DAT_00018f12)[iVar19] = uVar6;
        (&DAT_00018f13)[iVar19] = uVar7;
        uVar10 = uVar10 + 8;
