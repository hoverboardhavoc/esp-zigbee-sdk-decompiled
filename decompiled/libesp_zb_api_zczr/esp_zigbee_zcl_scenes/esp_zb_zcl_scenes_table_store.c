 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_zcl_scenes.o -> esp_zb_zcl_scenes_table_store
 *
...

{
  ...
  if (uVar4 < 0x10) {
    iVar5 = (&DAT_00011598)[uVar4 * 3];
    (&DAT_00011594)[uVar4 * 6] = param_1;
    (&DAT_00011597)[uVar4 * 0xc] = 0;
    if (iVar5 != 0) {
      device_scene_free_fields();
      (&DAT_00011598)[uVar4 * 3] = 0;
    }
    puVar7 = (undefined2 *)(&DAT_00011598)[uVar4 * 3];
    for (; param_2 != (undefined2 *)0x0; param_2 = *(undefined2 **)(param_2 + 4)) {
      puVar6 = (undefined2 *)malloc(0xc);
      cVar1 = *(char *)(param_2 + 1);
      (&DAT_00011597)[uVar4 * 0xc] = (&DAT_00011597)[uVar4 * 0xc] + '\x03' + cVar1;
      uVar3 = *param_2;
      *(char *)(puVar6 + 1) = cVar1;
