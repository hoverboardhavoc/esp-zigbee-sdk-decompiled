 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_zcl_scenes.o -> zcl_scenes_store_scene_handler
 *
...

{
  ...
  *puVar8 = (char)iVar5;
  if (iVar5 == 0) {
    ...
    if (iVar5 != 0xff) {
      iVar6 = -0x1b;
      if ((&DAT_00011592)[iVar5 * 6] == -1) {
        (&DAT_00011592)[iVar5 * 6] = uVar3;
        (&DAT_00011596)[iVar5 * 0xc] = uVar2;
        (&DAT_00011594)[iVar5 * 6] = 0;
        iVar6 = 0;
      }
      *puVar8 = 0;
      goto _L0;
