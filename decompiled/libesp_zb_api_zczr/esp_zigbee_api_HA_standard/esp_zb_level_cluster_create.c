 ...
 * Source: libesp_zb_api_zczr -> esp_zigbee_api_HA_standard.o -> esp_zb_level_cluster_create
 *
...
undefined4 esp_zb_level_cluster_create(int param_1)

{
  ...
  if (param_1 == 0) {
    esp_zb_level_cluster_add_attr(0,&lu8_level_control_current_level_6);
  }
  else {
    esp_zb_level_cluster_add_attr(0,param_1);
  }
  return uVar1;
}
