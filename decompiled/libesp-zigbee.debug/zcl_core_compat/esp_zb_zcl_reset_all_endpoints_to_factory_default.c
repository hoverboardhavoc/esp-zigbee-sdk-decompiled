 ...
 * Source: libesp-zigbee.debug -> zcl_core_compat.o -> esp_zb_zcl_reset_all_endpoints_to_factory_default
 *
...

{
  ...
  if (cb == (esp_zb_zcl_reset_default_attr_callback_t)0x0) {
    ...
    do {
      ...
      iVar2 = ezb_af_endpoint_reset(*puVar1,zcl_reset_default_attr_adapter);
    } while (iVar2 == 0);
