 ...
 * Source: libesp-zigbee.debug -> zcl_core_compat.o -> esp_zb_zcl_reset_endpoint_to_factory_default
 *
...

{
  ...
  if (cb == (esp_zb_zcl_reset_default_attr_callback_t)0x0) {
    ...
    ezb_af_endpoint_reset(CONCAT31(in_register_00002029,endpoint),zcl_reset_default_attr_adapter);
