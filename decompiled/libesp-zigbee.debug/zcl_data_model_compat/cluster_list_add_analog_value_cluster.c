 ...
 * Source: libesp-zigbee.debug -> zcl_data_model_compat.o -> cluster_list_add_analog_value_cluster
 *
...
void cluster_list_add_analog_value_cluster(int param_1,int param_2,byte param_3)
