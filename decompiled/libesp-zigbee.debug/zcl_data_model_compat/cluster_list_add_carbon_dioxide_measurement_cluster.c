 ...
 * Source: libesp-zigbee.debug -> zcl_data_model_compat.o -> cluster_list_add_carbon_dioxide_measurement_cluster
 *
...

{
  ...
  if (cluster_list == (esp_zb_cluster_list_t *)0x0) {
    ...
    zcl_cluster_desc_add_revision_attr((zcl_cluster_desc_t *)attr_list,2);
