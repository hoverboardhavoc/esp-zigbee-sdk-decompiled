 ...
 * Source: libesp-zigbee.debug -> zcl_data_model_compat.o -> cluster_list_add_ias_zone_cluster
 *
...
esp_err_t cluster_list_add_ias_zone_cluster
...

{
  ...
  if (cluster_list == (esp_zb_cluster_list_t *)0x0) {
    ...
    if ((role_mask & 1) == 0) {
      puVar3 = &ezb_zcl_ias_zone_cluster_client_init;
    }
    else {
      puVar3 = &ezb_zcl_ias_zone_cluster_server_init;
    }
