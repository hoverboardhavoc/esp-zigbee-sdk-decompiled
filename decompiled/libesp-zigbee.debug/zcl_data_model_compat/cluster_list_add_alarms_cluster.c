 ...
 * Source: libesp-zigbee.debug -> zcl_data_model_compat.o -> cluster_list_add_alarms_cluster
 *
...

{
  ...
  if (cluster_list == (esp_zb_cluster_list_t *)0x0) {
    ...
    if ((role_mask & 1) != 0) {
      uStack_12 = 0xf;
      ezb_zcl_cluster_desc_add_manuf_attr(attr_list,0xeffe,0x21,0x40,0x131b,&uStack_12);
      ezb_zcl_cluster_desc_add_manuf_attr(attr_list,0xefff,0,0x40,0x131b,0);
    }
