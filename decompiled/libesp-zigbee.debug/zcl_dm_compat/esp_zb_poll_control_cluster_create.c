...

{
  ...
  if (peVar1 != (esp_zb_attribute_list_t *)0x0) {
    long_poll_interval_min = 0;
    uStack_18 = 0;
    uStack_1a = 0;
    if (cfg != (esp_zb_poll_control_cluster_cfg_t *)0x0) {
      long_poll_interval_min = cfg->check_in_interval_min;
      uStack_18 = cfg->long_poll_interval_min;
      uStack_1a = cfg->fast_poll_timeout_max;
    }
    poll_control_cluster_add_attr(peVar1,4,&long_poll_interval_min);
    poll_control_cluster_add_attr(peVar1,5,&stack0xffffffe8);
