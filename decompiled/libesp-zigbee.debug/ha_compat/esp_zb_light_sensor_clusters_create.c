 ...
 * Source: libesp-zigbee.debug -> ha_compat.o -> esp_zb_light_sensor_clusters_create
 *
...

{
  ...
  uVar3 = esp_zb_illuminance_meas_cluster_create(peVar1);
  esp_zb_cluster_list_add_illuminance_meas_cluster(peVar2,uVar3,1);
  return peVar2;
}
