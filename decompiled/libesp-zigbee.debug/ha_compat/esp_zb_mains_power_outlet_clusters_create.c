 ...
 * Source: libesp-zigbee.debug -> ha_compat.o -> esp_zb_mains_power_outlet_clusters_create
 *
...
esp_zb_mains_power_outlet_clusters_create(esp_zb_mains_power_outlet_cfg_t *outlet_cfg)

{
  esp_zb_on_off_cluster_cfg_t *peVar1;
  ...
  if (outlet_cfg == (esp_zb_mains_power_outlet_cfg_t *)0x0) {
    peVar1 = (esp_zb_on_off_cluster_cfg_t *)0x0;
    peVar4 = (esp_zb_scenes_cluster_cfg_t *)0x0;
    peVar5 = (esp_zb_groups_cluster_cfg_t *)0x0;
    peVar6 = (esp_zb_identify_cluster_cfg_t *)0x0;
  }
  else {
    peVar6 = &outlet_cfg->identify_cfg;
    peVar5 = &outlet_cfg->groups_cfg;
    peVar4 = &outlet_cfg->scenes_cfg;
    peVar1 = &outlet_cfg->on_off_cfg;
  }
  peVar2 = (esp_zb_cluster_list_t *)esp_zb_zcl_cluster_list_create();
  uVar3 = esp_zb_basic_cluster_create(outlet_cfg);
  ...
  uVar3 = esp_zb_on_off_cluster_create(peVar1);
