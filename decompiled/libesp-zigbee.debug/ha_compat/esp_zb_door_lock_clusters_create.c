 ...
 * Source: libesp-zigbee.debug -> ha_compat.o -> esp_zb_door_lock_clusters_create
 *
...
{
  esp_zb_door_lock_cluster_cfg_t *peVar1;
  ...
  if (door_lock == (esp_zb_door_lock_cfg_t *)0x0) {
    peVar1 = (esp_zb_door_lock_cluster_cfg_t *)0x0;
    ...
    peVar1 = &door_lock->door_lock_cfg;
  }
  peVar2 = (esp_zb_cluster_list_t *)esp_zb_zcl_cluster_list_create();
  uVar3 = esp_zb_basic_cluster_create(door_lock);
  ...
  uVar3 = esp_zb_door_lock_cluster_create(peVar1);
  esp_zb_cluster_list_add_door_lock_cluster(peVar2,uVar3,1);
  return peVar2;
}
