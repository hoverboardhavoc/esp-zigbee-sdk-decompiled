 ...
 * Source: libesp-zigbee.debug -> ha_compat.o -> esp_zb_on_off_switch_clusters_create
 *
...

{
  ...
  if (switch_cfg == (esp_zb_on_off_switch_cfg_t *)0x0) {
    peVar1 = (esp_zb_identify_cluster_cfg_t *)0x0;
  }
  else {
    peVar1 = &switch_cfg->identify_cfg;
  }
  peVar2 = (esp_zb_cluster_list_t *)esp_zb_zcl_cluster_list_create();
  uVar3 = esp_zb_basic_cluster_create(switch_cfg);
