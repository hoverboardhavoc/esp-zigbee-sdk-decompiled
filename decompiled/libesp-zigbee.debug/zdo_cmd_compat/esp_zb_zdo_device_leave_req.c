...

{
  ...
  if ((cmd_req != (esp_zb_zdo_mgmt_leave_req_param_t *)0x0) &&
     (req.cb = (ezb_zdo_nwk_mgmt_leave_req_callback_t)calloc(1,0xc),
     req.cb != (ezb_zdo_nwk_mgmt_leave_req_callback_t)0x0)) {
    *(esp_zb_zdo_leave_callback_t *)req.cb = user_cb;
    *(void **)(req.cb + 4) = user_ctx;
    req._0_4_ = *(undefined4 *)(cmd_req->device_address + 2);
    req.field.device_addr.field_0.u64._2_4_ =
         CONCAT13((char)(*(uint *)&cmd_req->dst_nwk_addr >> 0x17),
                  CONCAT12((char)(*(uint *)&cmd_req->dst_nwk_addr >> 0x16),
                           *(undefined2 *)(cmd_req->device_address + 6))) & 0x101ffff;
    uStack_24 = CONCAT22(*(undefined2 *)cmd_req->device_address,cmd_req->dst_nwk_addr);
