 ...
 * Source: libesp-zigbee.debug -> zcl_cmd_compat.o -> esp_zb_zcl_color_enhanced_step_hue_cmd_req
 *
...
uint8_t esp_zb_zcl_color_enhanced_step_hue_cmd_req
                  (esp_zb_zcl_color_enhanced_step_hue_cmd_t *cmd_req)

{
  uint8_t uVar1;
  int iVar2;
  undefined1 local_30 [4];
  ezb_zcl_color_control_enhanced_step_hue_cmd_t req;
  ...
  if (cmd_req == (esp_zb_zcl_color_enhanced_step_hue_cmd_t *)0x0) {
    esp_log(0x11,"ZCL_CMD_COMPAT","%s(%d): Invalid Argument",
            "esp_zb_zcl_color_enhanced_step_hue_cmd_req",0x454);
    uVar1 = 0xff;
  }
  else {
    ...
    req.cmd_ctrl.cnf_ctx.user_ctx =
         (void *)CONCAT31(req.cmd_ctrl.cnf_ctx.user_ctx._1_3_,cmd_req->step_mode);
    req.cmd_ctrl.cnf_ctx.user_ctx =
         (void *)CONCAT22(cmd_req->step_size,req.cmd_ctrl.cnf_ctx.user_ctx._0_2_);
    req.payload._0_2_ = cmd_req->transition_time;
    iVar2 = ezb_zcl_color_control_enhanced_step_hue_cmd_req(local_30);
    if (iVar2 == 0) {
