...

{
  ...
  ezb_zcl_scenes_store_scene_cmd_t req;
  ...
  if (cmd_req == (esp_zb_zcl_scenes_store_scene_cmd_t *)0x0) {
    ...
    iVar3 = ezb_zcl_scenes_store_scene_cmd_req((ezb_zcl_cluster_cmd_ctrl_t *)auStack_2c);
    if (iVar3 == 0) {
