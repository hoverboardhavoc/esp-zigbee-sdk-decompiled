 ...
 * Source: libesp-zigbee.debug -> zcl_cmd_compat.o -> esp_zb_zcl_thermostat_clear_weekly_schedule_cmd_req
 *
...
uint8_t esp_zb_zcl_thermostat_clear_weekly_schedule_cmd_req
                  (esp_zb_thermostat_clear_weekly_schedule_cmd_t *cmd_req)

{
  uint8_t uVar1;
  int iVar2;
  undefined1 auStack_28 [4];
  ezb_zcl_thermostat_clear_weekly_schedule_cmd_t req;
  ...
  if (cmd_req == (esp_zb_thermostat_clear_weekly_schedule_cmd_t *)0x0) {
    esp_log(0x11,"ZCL_CMD_COMPAT","%s(%d): Invalid Argument",
            "esp_zb_zcl_thermostat_clear_weekly_schedule_cmd_req",0x53d);
    uVar1 = 0xff;
  }
  else {
    ...
    ;
    iVar2 = ezb_zcl_thermostat_clear_weekly_schedule_cmd_req
