 ...
 * Source: libesp-zigbee.debug -> zcl_cmd_compat.o -> esp_zb_zcl_level_move_to_level_cmd_req
 *
...

{
  ...
  if (cmd_req == (esp_zb_zcl_move_to_level_cmd_t *)0x0) {
    esp_log(0x11,"ZCL_CMD_COMPAT","%s(%d): Invalid Argument",
            "esp_zb_zcl_level_move_to_level_cmd_req",600);
    uVar1 = 0xff;
  }
  else {
    ...
    iVar2 = ezb_zcl_level_move_to_level_cmd_req(local_30);
    if (iVar2 == 0) {
