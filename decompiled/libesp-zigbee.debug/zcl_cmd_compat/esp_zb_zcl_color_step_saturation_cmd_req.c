 ...
 * Source: libesp-zigbee.debug -> zcl_cmd_compat.o -> esp_zb_zcl_color_step_saturation_cmd_req
 *
...

{
  ...
  ezb_zcl_color_control_step_saturation_cmd_t req;
