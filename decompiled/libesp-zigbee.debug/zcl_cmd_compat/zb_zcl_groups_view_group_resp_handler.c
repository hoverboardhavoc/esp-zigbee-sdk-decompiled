 ...
 * Source: libesp-zigbee.debug -> zcl_cmd_compat.o -> zb_zcl_groups_view_group_resp_handler
 *
...

{
  ...
  uStack_38 = CONCAT31(uStack_38._1_3_,*(undefined1 *)(param_1 + 0xc));
  uStack_18 = CONCAT22(uStack_18._2_2_,*(undefined2 *)(param_1 + 0xe));
