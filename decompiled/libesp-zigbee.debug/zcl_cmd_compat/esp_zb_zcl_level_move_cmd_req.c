 ...
 * Source: libesp-zigbee.debug -> zcl_cmd_compat.o -> esp_zb_zcl_level_move_cmd_req
 *
...

{
  ...
  if (cmd_req == (esp_zb_zcl_level_move_cmd_t *)0x0) {
    esp_log(0x11,"ZCL_CMD_COMPAT","%s(%d): Invalid Argument","esp_zb_zcl_level_move_cmd_req",0x276);
    uVar2 = 0xff;
  }
  else {
    ...
    iVar3 = ezb_zcl_level_move_cmd_req((ezb_zcl_cluster_cmd_ctrl_t *)auStack_2c);
    if (iVar3 == 0) {
