 ...
 * Source: libesp-zigbee.debug -> zcl_cmd_compat.o -> zb_zcl_set_attr_value_handler
 *
...

{
  ...
  local_20 = *arg;
  app_message.info = *(esp_zb_device_cb_common_info_t *)((int)arg + 8);
  app_message.attribute._0_4_ = *(undefined4 *)((int)arg + 0xc);
  app_message.attribute.data._0_4_ = *(undefined4 *)((int)arg + 0x10);
