...

{
  ...
  if (param_1 == 0) {
    ...
    convert_to_ezb_specific_cmd_ctrl(&uStack_44,param_1);
    uStack_44 = CONCAT31(uStack_44._1_3_,2);
    uStack_2c = CONCAT13(uStack_2c._3_1_,*(undefined3 *)(param_1 + 10));
    uStack_28 = CONCAT22(uStack_28._2_2_,*(undefined2 *)(param_1 + 0xe));
    uStack_14 = *(undefined4 *)(param_1 + 0x10);
    iVar1 = ezb_zcl_scenes_add_scene_cmd_req(&uStack_44);
    if (iVar1 == 0) {
