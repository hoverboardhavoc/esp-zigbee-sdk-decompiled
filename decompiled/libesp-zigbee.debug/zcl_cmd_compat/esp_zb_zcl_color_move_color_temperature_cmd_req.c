 ...
 * Source: libesp-zigbee.debug -> zcl_cmd_compat.o -> esp_zb_zcl_color_move_color_temperature_cmd_req
 *
...
uint8_t esp_zb_zcl_color_move_color_temperature_cmd_req
...

{
  ...
  ezb_zcl_color_control_move_color_temperature_cmd_t req;
  ...
  req.payload.move_mode = '\0';
  req.payload._1_1_ = 0;
  req.payload.rate = 0;
  req.payload.color_temperature_min_mireds = 0;
  req.payload.color_temperature_max_mireds = 0;
  if (cmd_req == (esp_zb_zcl_color_move_color_temperature_cmd_t *)0x0) {
    esp_log(0x11,"ZCL_CMD_COMPAT","%s(%d): Invalid Argument",
            "esp_zb_zcl_color_move_color_temperature_cmd_req",0x487);
    uVar1 = 0xff;
  }
  else {
    ...
    req.cmd_ctrl.cnf_ctx.user_ctx =
         (void *)CONCAT22(cmd_req->rate,req.cmd_ctrl.cnf_ctx.user_ctx._0_2_);
    req.payload.rate = SUB42(req.payload._0_4_,2);
    req.payload._0_2_ = cmd_req->color_temperature_maximum;
    iVar2 = ezb_zcl_color_control_move_color_temperature_cmd_req
