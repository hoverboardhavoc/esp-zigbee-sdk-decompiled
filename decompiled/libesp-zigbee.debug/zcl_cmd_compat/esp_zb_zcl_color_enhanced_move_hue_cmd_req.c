 ...
 * Source: libesp-zigbee.debug -> zcl_cmd_compat.o -> esp_zb_zcl_color_enhanced_move_hue_cmd_req
 *
...
uint8_t esp_zb_zcl_color_enhanced_move_hue_cmd_req
                  (esp_zb_zcl_color_enhanced_move_hue_cmd_t *cmd_req)

{
  uint8_t uVar1;
  int iVar2;
  undefined1 local_30 [4];
  ezb_zcl_color_control_enhanced_move_hue_cmd_t req;
  ...
  req.payload._1_1_ = 0;
  req.payload.rate = 0;
  if (cmd_req == (esp_zb_zcl_color_enhanced_move_hue_cmd_t *)0x0) {
    esp_log(0x11,"ZCL_CMD_COMPAT","%s(%d): Invalid Argument",
            "esp_zb_zcl_color_enhanced_move_hue_cmd_req",0x445);
    uVar1 = 0xff;
  }
  else {
    ...
    iVar2 = ezb_zcl_color_control_enhanced_move_hue_cmd_req(local_30);
    if (iVar2 == 0) {
