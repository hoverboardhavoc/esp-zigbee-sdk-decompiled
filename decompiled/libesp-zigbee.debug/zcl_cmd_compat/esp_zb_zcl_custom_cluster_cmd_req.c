 ...
 * Source: libesp-zigbee.debug -> zcl_cmd_compat.o -> esp_zb_zcl_custom_cluster_cmd_req
 *
...

{
  ...
  uStack_14 = 0;
  if (param_1 == 0) {
    esp_log(0x11,"ZCL_CMD_COMPAT","%s(%d): Invalid Argument","esp_zb_zcl_custom_cluster_cmd_req",
            0x652);
    uVar2 = 0xff;
  }
  else {
