 ...
 * Source: libesp-zigbee.debug -> zcl_cmd_compat.o -> esp_zb_zcl_read_attr_cmd_req
 *
...

{
  ...
  req.payload._1_3_ = 0;
  if (cmd_req == (esp_zb_zcl_read_attr_cmd_t *)0x0) {
    esp_log(0x11,"ZCL_CMD_COMPAT","%s(%d): Invalid Argument","esp_zb_zcl_read_attr_cmd_req",0x85);
    uVar1 = 0xff;
  }
  else {
    ...
    iVar2 = ezb_zcl_read_attr_cmd_req((ezb_zcl_cmd_ctrl_t *)auStack_34);
    if (iVar2 == 0) {
