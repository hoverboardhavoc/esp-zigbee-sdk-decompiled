...

{
  ...
  if (param_2 != (char *)0x0) {
    ...
    if (iVar1 == 0) {
      ...
      if (iVar1 == 0) {
        ...
        esp_log_write(1,0x10000,&_LC24,uVar3,0x10000);
        return;
      }
      uVar3 = esp_log_timestamp();
      esp_log_write(3,0x10000,&_LC25,uVar3,0x10000,uStack_24,uStack_23,uStack_22);
      iVar1 = zb_secur_ic_set(3,&uStack_24);
      if (iVar1 != 0) {
        uVar3 = esp_log_timestamp();
        esp_log_write(1,0x10000,&_LC26,uVar3,0x10000);
        return;
      }
      uVar3 = esp_log_timestamp();
    ...
    if ((param_3 != 0) && (iVar1 = strcmp(param_1,"add"), iVar1 == 0)) {
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          esp_log_write(3,0x10000,&_LC25,uVar3,0x10000,uStack_24,uStack_23,uStack_22);
          uVar3 = esp_log_timestamp();
          esp_log_write(3,0x10000,&_LC30,uVar3,0x10000,uStack_2c,uStack_2b,uStack_2a);
          uVar3 = esp_log_timestamp();
          esp_log_write(3,0x10000,&_LC4,uVar3,0x10000);
          return;
        }
  ...
  if ((param_2 == (char *)0x0) || (iVar1 = strcmp(param_1,"policy"), iVar1 != 0)) {
    uVar3 = esp_log_timestamp();
    esp_log_write(1,0x10000,&_LC34,uVar3,0x10000);
  }
  else {
