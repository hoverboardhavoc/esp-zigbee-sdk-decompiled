...

{
  ...
  if (iVar2 != 0) {
    iVar2 = __getreent();
    arg_print_errors(*(undefined4 *)(iVar2 + 0xc),DAT_00014874,*param_2);
    return 1;
  }
  if (1 < param_1) {
    if (*(int *)(DAT_00014834 + 0x34) != 0) {
      cmd_zb_role(**(undefined4 **)(DAT_00014834 + 0x38));
    }
    if (*(int *)(DAT_00014838 + 0x34) != 0) {
      cmd_zb_nwk_type(**(undefined4 **)(DAT_00014838 + 0x38));
    }
    if (*(int *)(DAT_00014844 + 0x34) != 0) {
      cmd_zb_start(param_1 + -2,param_2 + 2);
    }
    if (*(int *)(DAT_00014848 + 0x34) != 0) {
      cmd_zb_nwk_commissioning(**(undefined4 **)(DAT_00014848 + 0x38));
    }
    if (*(int *)(DAT_0001483c + 0x34) != 0) {
      cmd_zb_extpanid(**(undefined4 **)(DAT_0001483c + 0x38));
    }
    if (*(int *)(DAT_00014840 + 0x34) != 0) {
      cmd_zb_panid(**(undefined4 **)(DAT_00014840 + 0x38));
    }
    if (*(int *)(DAT_0001484c + 0x34) != 0) {
      cmd_zb_nwk_state(param_1 + -2,param_2 + 2);
    }
    if (*(int *)(DAT_00014850 + 0x34) != 0) {
      cmd_zb_channel(**(undefined4 **)(DAT_00014850 + 0x38));
    }
    if (*(int *)(DAT_00014854 + 0x34) != 0) {
      cmd_zb_channel_mask(param_1 + -2,param_2 + 2);
    }
    if ((*(int *)(DAT_00014858 + 0x34) != 0) &&
       (pcVar1 = (char *)**(undefined4 **)(DAT_00014858 + 0x38), pcVar1 != (char *)0x0)) {
      iVar2 = strcmp(pcVar1,"add");
      if (iVar2 == 0) {
        if ((*(int *)(DAT_0001485c + 0x34) == 0) || (*(int *)(DAT_00014860 + 0x34) == 0)) {
          uVar3 = esp_log_timestamp();
          esp_log_write(1,0x10000,&_L0,uVar3,0x10000);
        }
        else {
          cmd_zb_install_code(pcVar1,**(undefined4 **)(DAT_0001485c + 0x38),
                              **(undefined4 **)(DAT_00014860 + 0x38));
        }
      }
      pcVar1 = (char *)**(undefined4 **)(DAT_00014858 + 0x38);
      iVar2 = strcmp(pcVar1,"set");
      if ((iVar2 == 0) && (*(int *)(DAT_0001485c + 0x34) != 0)) {
        cmd_zb_install_code(pcVar1,**(undefined4 **)(DAT_0001485c + 0x38),0);
      }
      pcVar1 = (char *)**(undefined4 **)(DAT_00014858 + 0x38);
    ...
    if (*(int *)(DAT_00014864 + 0x34) != 0) {
      cmd_zb_legacy(**(undefined4 **)(DAT_00014864 + 0x38));
    }
    if (*(int *)(DAT_00014868 + 0x34) != 0) {
      cmd_zb_nwkkey(**(undefined4 **)(DAT_00014868 + 0x38));
    }
    if (*(int *)(DAT_0001486c + 0x34) != 0) {
      cmd_zb_factory_reset(**(undefined4 **)(DAT_0001486c + 0x38));
    }
    if (*(int *)(DAT_00014870 + 0x34) != 0) {
      cmd_zb_child_max(**(undefined4 **)(DAT_00014870 + 0x38));
    }
