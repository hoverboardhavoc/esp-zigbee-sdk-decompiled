...
void cmd_zb_tlk_set_timeout(int param_1,undefined4 *param_2)

{
  ...
  if ((param_1 == 0) || (param_2 == (undefined4 *)0x0)) {
    ...
    esp_log_write(1,0x10000,&_LC8,uVar2,0x10000,"cmd_zb_tlk_set_timeout",0x440);
  }
  else {
    __s1 = (char *)*param_2;
    ...
    if (iVar1 == 0) {
      ...
      if (iVar1 == 0) {
        ...
        if ((__s1 == (char *)0x0) || (iVar1 = atoi(__s1), iVar1 < 1)) {
          iVar1 = zb_zll_get_device_info();
