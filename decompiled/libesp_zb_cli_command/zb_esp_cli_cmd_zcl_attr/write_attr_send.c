...

{
  ...
  if (iVar5 == 0) {
    ...
    *pcVar7 = cVar1 + '\x01';
    pcVar6[1] = cVar1;
    pcVar6[2] = '\x02';
    puVar4 = (undefined1 *)zb_put_next_htole16(pcVar6 + 3,*(undefined2 *)(&DAT_00011462 + iVar5));
    *puVar4 = (&DAT_00011464)[iVar5];
    uVar8 = zb_zcl_put_value_to_packet(puVar4 + 1,&DAT_00011465 + param_2 * 0x3c);
