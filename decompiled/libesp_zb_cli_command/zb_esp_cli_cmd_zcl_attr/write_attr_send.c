...

{
  ...
  if (iVar5 == 0) {
    ...
    *pcVar7 = cVar1 + '\x01';
    pcVar6[1] = cVar1;
    pcVar6[2] = '\x02';
    puVar4 = (undefined1 *)zb_put_next_htole16(pcVar6 + 3,*(undefined2 *)(&DAT_0001142e + iVar5));
    *puVar4 = (&DAT_00011430)[iVar5];
    uVar8 = zb_zcl_put_value_to_packet(puVar4 + 1,&DAT_00011431 + param_2 * 0x3c);
