            ...
            if (iVar4 == 0) {
              ...
              if (iVar4 == 0) {
                ...
                if (iVar4 == 0) {
                  ...
                  sVar5 = strlen(pcVar7);
                  iVar4 = parse_hex_str(pcVar7,sVar5 & 0xff,&DAT_00011464 + uVar3 * 0x3c,1,1);
                  if (iVar4 == 0) {
                    uVar6 = esp_log_timestamp();
                    ...
                    sVar5 = strlen(pcVar7);
                    if ((&DAT_00011464)[uVar3 * 0x3c] == 'B') {
                      (&DAT_00011465)[uVar3 * 0x3c] = (char)sVar5;
                      strncpy((char *)(uVar3 * 0x3c + 0x11466),(char *)param_2[6],0x1f);
                    }
                    else {
                      iVar4 = parse_hex_str(pcVar7,&DAT_00011465 + uVar3 * 0x3c,0x20,1);
                      if (iVar4 == 0) {
                        uVar6 = esp_log_timestamp();
                    ...
                    *(undefined4 *)(&DAT_00011450 + uVar3 * 0x3c) = 1;
