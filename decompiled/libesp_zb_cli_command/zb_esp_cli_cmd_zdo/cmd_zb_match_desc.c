      ...
      *(char *)((int)puVar2 + 3) = (char)(uStack_24 >> 8);
      ...
      if (iVar3 == 0) {
        ...
        *(char *)((int)puVar2 + 5) = (char)(uStack_24 >> 8);
        uVar4 = esp_log_timestamp();
        esp_log_write(3,&_LC3,&_LC69,uVar4,&_LC3,uStack_24 & 0xffff);
        ...
        if (iVar5 == 0) {
          ...
          *(undefined1 *)(puVar2 + 3) = uStack_25;
          uVar4 = esp_log_timestamp();
          esp_log_write(3,&_LC3,&_LC71,uVar4,&_LC3,uStack_25);
          if ((byte)puVar2[3] == 0) {
            iVar5 = 2;
          }
          else {
          ...
          if (iVar6 == 0) {
            ...
            *(undefined1 *)((int)puVar2 + 7) = uStack_25;
            uVar4 = esp_log_timestamp();
            esp_log_write(3,&_LC3,&_LC74,uVar4,&_LC3,*(undefined1 *)((int)puVar2 + 7));
            if (*(byte *)((int)puVar2 + 7) != 0) {
              ...
              if (iVar5 == 0) {
                uVar4 = esp_log_timestamp();
                esp_log_write(1,&_LC3,&_LC75,uVar4,&_LC3);
                goto _L0;
              }
            }
            ...
            if (iVar5 + 2U == param_1) {
              ...
              if (iVar6 == 0) {
                ...
                uVar4 = esp_log_timestamp();
                esp_log_write(3,&_LC3,&_LC79,uVar4,&_LC3,uStack_24 >> 0x10);
              }
              else {
                uVar4 = esp_log_timestamp();
                esp_log_write(1,&_LC3,&_LC80,uVar4,&_LC3);
                iVar3 = 0;
              }
            }
            else {
            ...
            if (iVar5 == 0) {
              ...
              *(bool *)(iVar5 + 6) = 0xfff7 < *puVar2;
              ...
              esp_log_write(3,&_LC3,&_LC81,uVar4,&_LC3,pcVar7);
              ...
              *(char *)(iVar5 + 4) = (char)iVar6;
              if (iVar6 != 0xff) {
                ...
                iVar1 = zb_schedule_app_alarm
                                  (cmd_zb_match_desc_timeout,(uStack_24 >> 0x10) * 1000000,
                                   (int)((ulonglong)(uStack_24 >> 0x10) * 1000000 >> 0x20));
                if (iVar1 == 0) {
                  return;
                }
                uVar4 = esp_log_timestamp();
              ...
              esp_log_write(3,&_LC3,&_LC82,uVar4,&_LC3);
            }
          }
        }
      }
