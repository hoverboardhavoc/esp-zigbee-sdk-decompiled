...
undefined4 zdo_op_nwk_mgmt_permit_joining_req(int param_1,undefined1 *param_2,int param_3)

{
  ...
  if ((param_1 == 0) || (param_2 == (undefined1 *)0x0)) {
    ...
    auStack_22[0]._0_1_ = *param_2;
    iVar1 = zmsg_append_bytes(1,auStack_22);
    if (iVar1 != 0) {
      return 0x8a;
    }
    auStack_22[0] = CONCAT11(auStack_22[0]._1_1_,param_2[1]);
