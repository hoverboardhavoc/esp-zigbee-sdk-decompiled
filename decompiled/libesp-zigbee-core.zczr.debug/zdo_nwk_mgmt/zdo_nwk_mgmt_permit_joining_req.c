 ...
 * Source: libesp-zigbee-core.zczr.debug -> zdo_nwk_mgmt.o -> zdo_nwk_mgmt_permit_joining_req
 *
...

{
  ...
  if (req == (zdo_nwk_mgmt_permit_joining_req_t *)0x0) {
    ...
    iVar3 = zdo_packet_init(&uStack_28,0x36,req->dst_nwk_addr,req->cb,req->user_ctx);
    if (iVar3 == 0) {
