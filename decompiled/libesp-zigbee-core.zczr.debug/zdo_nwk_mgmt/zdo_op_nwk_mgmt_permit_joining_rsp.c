...
zdp_status_t
zdo_op_nwk_mgmt_permit_joining_rsp
          (zdo_packet_payload_t *payload,zdp_nwk_mgmt_permit_joining_rsp_field_t *rsp,_Bool is_write
          )

{
  ...
  if ((payload == (zdo_packet_payload_t *)0x0) ||
     (rsp == (zdp_nwk_mgmt_permit_joining_rsp_field_t *)0x0)) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/zdo/zdo_nwk_mgmt.c",0x118,
