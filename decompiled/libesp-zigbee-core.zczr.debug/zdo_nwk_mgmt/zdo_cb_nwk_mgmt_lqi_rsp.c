...

{
  ...
  int extraout_a1;
  zdp_nwk_mgmt_leave_rsp_field_t azStack_34 [12];
  
  if ((rsp != (zdp_nwk_mgmt_lqi_rsp_field_t *)0x0) && (ctx != (zdo_packet_ctx_t *)0x0)) {
    zdo_packet_notify_result(ctx,0);
    return '\0';
  }
  iVar2 = __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/zdo/zdo_nwk_mgmt.c",0x23d,
  ...
  if (iVar2 == 0) {
    ...
    zVar1 = zdo_op_nwk_mgmt_leave_rsp(*(zdo_packet_payload_t **)(iVar2 + 0x14),azStack_34,false);
    if (CONCAT31(extraout_var,zVar1) == 0) {
      zVar1 = zdo_cb_nwk_mgmt_leave_rsp(azStack_34,(zdo_packet_ctx_t *)(iVar2 + 8));
    }
    else {
      zVar1 = 0xfe;
    }
