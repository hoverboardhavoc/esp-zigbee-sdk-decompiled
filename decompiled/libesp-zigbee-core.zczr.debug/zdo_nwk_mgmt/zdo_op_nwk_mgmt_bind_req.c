...
undefined4 zdo_op_nwk_mgmt_bind_req(int param_1,undefined1 *param_2,int param_3)

{
  ...
  if ((param_1 == 0) || (param_2 == (undefined1 *)0x0)) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/zdo/zdo_nwk_mgmt.c",0x18b,
