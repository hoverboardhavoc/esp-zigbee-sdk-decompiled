...
void ezb_zcl_time_cluster_server_init(void)

{
  ...
  uStack_24 = 0x1000a;
  pcStack_20 = time_cluster_srv_check_value_handler;
  pcStack_1c = time_cluster_srv_write_attr_hook;
  uStack_18 = 0;
  uStack_14 = 0;
  iVar2 = time_server_ctx_init();
  if (iVar2 == 0) {
