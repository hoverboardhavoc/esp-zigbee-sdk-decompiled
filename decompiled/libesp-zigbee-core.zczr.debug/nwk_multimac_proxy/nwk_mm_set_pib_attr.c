  ...
  if (param_1 == 0xff) {
    ...
    while (!bVar1) {
      ...
      if (iVar2 != 0) {
        ...
        pcVar4 = *(code **)(*(int *)(*(int *)(iVar2 + 0xc84) + 4) + 0xc);
        iVar2 = core_globals_get();
        iVar2 = (*pcVar4)(*(undefined4 *)(iVar2 + 0xc84),param_2,param_3);
        if (iVar2 != 0) {
    ...
    pcVar4 = *(code **)(*(int *)(*(int *)(iVar3 + param_1 * 0xc + 0xc84) + 4) + 0xc);
    iVar3 = core_globals_get();
    iVar3 = (*pcVar4)(*(undefined4 *)(iVar3 + param_1 * 0xc + 0xc84),param_2,param_3);
  }
  return iVar3;
}
