...

{
  ...
  *(undefined4 *)(iVar1 + 0x978) = 0;
  ...
  do {
    __assert_func("//build/esp-zigbee/src/core/aps/aps_bind.c",0x1b4,"aps_bind_table_deinit",&_LC3);
_L0:
    __assert_func("//build/esp-zigbee/src/core/aps/aps_bind.c",0x1b3,"aps_bind_table_deinit",&_LC3);
_L0:
