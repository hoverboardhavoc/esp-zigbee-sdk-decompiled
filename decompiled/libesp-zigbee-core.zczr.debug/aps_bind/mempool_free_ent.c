 ...
 * Source: libesp-zigbee-core.zczr.debug -> aps_bind.o -> mempool_free_ent
 *
...

{
  ...
  __assert_func("//build/esp-zigbee/src/core/common/mempool.h",0x69,"mempool_free_ent",0x10608);
