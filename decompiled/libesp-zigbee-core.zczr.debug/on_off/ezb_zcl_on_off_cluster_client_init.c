 ...
 * Source: libesp-zigbee-core.zczr.debug -> on_off.o -> ezb_zcl_on_off_cluster_client_init
 *
...

{
  ...
  template.write_attr_handler = on_off_cluster_cli_cmd_disc_handler;
  ...
  ep_id_00 = __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/on_off.c",
                           0x2cd,"ezb_zcl_on_off_cluster_client_init",
