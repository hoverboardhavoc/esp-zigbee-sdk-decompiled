 ...
 * Source: libesp-zigbee-core.zczr.debug -> on_off.o -> on_off_cluster_srv_cmd_proc_handler
 *
...

{
  ...
  if (bVar1 == 0x40) {
    eVar3 = on_off_cluster_off_with_effect_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
    iVar2 = CONCAT31(extraout_var_03,eVar3);
  }
  else if (bVar1 < 0x41) {
    if (bVar1 == 1) {
      eVar3 = on_off_cluster_on_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var_01,eVar3);
    }
    else if (bVar1 == 2) {
      eVar3 = on_off_cluster_toggle_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var_02,eVar3);
    }
    else {
      if (bVar1 != 0) goto _L0;
      eVar3 = on_off_cluster_off_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var,eVar3);
    }
  }
  else if (bVar1 == 0x41) {
    eVar3 = on_off_cluster_on_with_recall_global_scene_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
    iVar2 = CONCAT31(extraout_var_04,eVar3);
  }
  else if (bVar1 == 0x42) {
    eVar3 = on_off_cluster_on_with_timed_off_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
