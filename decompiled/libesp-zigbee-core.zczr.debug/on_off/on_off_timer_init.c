...

{
  ...
  if ((pzVar1 != (zcl_attr_desc_t *)0x0) && (pzVar2 != (zcl_attr_desc_t *)0x0)) {
    ...
    if (pzVar1 == (zcl_attr_desc_t *)0x0) {
      __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/on_off.c",0x28b,"on_off_timer_init"
                    ,"on_off_timer_attr_desc");
    }
    else {
    ...
    ep_id_00 = __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/on_off.c",0x28d,
