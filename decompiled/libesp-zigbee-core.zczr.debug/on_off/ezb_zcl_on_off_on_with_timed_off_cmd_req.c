 ...
 * Source: libesp-zigbee-core.zczr.debug -> on_off.o -> ezb_zcl_on_off_on_with_timed_off_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_on_off_on_with_timed_off_cmd_t *)0x0) {
    ...
    if (iVar2 == 0) {
      eVar1 = zcl_cmd_to_packet(&uStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,0x42,6);
      if (eVar1 == 0) {
