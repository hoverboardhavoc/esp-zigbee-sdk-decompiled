...

{
  ...
  if ((packet == (zcl_packet_t *)0x0) || (rsp == (zcl_packet_t *)0x0)) {
    __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/on_off.c",0x176,
  ...
  psVar4 = (short *)__assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/on_off.c",0x178,
                                  "on_off_cluster_toggle_cmd_handler","attr_desc");
