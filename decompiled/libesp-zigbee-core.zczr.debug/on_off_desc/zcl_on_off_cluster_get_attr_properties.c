...
ezb_err_t zcl_on_off_cluster_get_attr_properties
...

{
  ...
  if (type == (uint8_t *)0x0) {
    ...
    if ((CONCAT22(in_register_0000202a,cluster_role) - 1U & 0xffff) < 2) {
      ...
      pcVar3 = "zcl_on_off_cluster_get_attr_properties";
      uVar2 = __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/on_off_desc.c"
                            ,0x16);
      type = (uint8_t *)pcVar3;
