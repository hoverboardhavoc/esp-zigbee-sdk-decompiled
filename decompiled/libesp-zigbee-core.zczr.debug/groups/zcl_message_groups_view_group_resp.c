...
uint zcl_message_groups_view_group_resp
               (undefined4 param_1,undefined1 param_2,undefined2 param_3,undefined4 param_4)

{
  ...
  if (uVar1 == 0) {
    ...
    uStack_2c = CONCAT22(param_3,(undefined2)uStack_2c);
