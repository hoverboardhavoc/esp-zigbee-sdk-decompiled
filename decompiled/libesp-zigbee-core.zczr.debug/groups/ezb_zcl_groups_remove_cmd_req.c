 ...
 * Source: libesp-zigbee-core.zczr.debug -> groups.o -> ezb_zcl_groups_remove_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_groups_remove_group_cmd_t *)0x0) {
    ...
    if (iVar2 == 0) {
      eVar1 = zcl_cmd_to_packet(&uStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,3,4);
      if (eVar1 == 0) {
