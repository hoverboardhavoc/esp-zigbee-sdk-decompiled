...

{
  ...
  if (bVar1 == 2) {
    eVar3 = groups_cluster_get_group_membership_rsp_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
    iVar2 = CONCAT31(extraout_var_02,eVar3);
  }
  else if (bVar1 < 3) {
    if (bVar1 == 0) {
      eVar3 = groups_cluster_add_group_rsp_cmd_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var_01,eVar3);
    }
    else {
      if (bVar1 != 1) goto _L0;
      eVar3 = groups_cluster_view_group_rsp_cmd_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var,eVar3);
    }
  }
  else if (bVar1 == 3) {
    eVar3 = groups_cluster_remove_group_rsp_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
