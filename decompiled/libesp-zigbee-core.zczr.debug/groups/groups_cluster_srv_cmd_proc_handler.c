 ...
 * Source: libesp-zigbee-core.zczr.debug -> groups.o -> groups_cluster_srv_cmd_proc_handler
 *
...

{
  ...
  if (bVar1 == 3) {
    eVar3 = groups_cluster_remove_group_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
    iVar2 = CONCAT31(extraout_var_03,eVar3);
  }
  else if (bVar1 < 4) {
    if (bVar1 == 1) {
      eVar3 = groups_cluster_view_group_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var_01,eVar3);
    }
    else if (bVar1 == 2) {
      eVar3 = groups_cluster_get_group_membership_cmd_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var_02,eVar3);
    }
    else {
      if (bVar1 != 0) goto _L0;
      eVar3 = groups_cluster_add_group_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var,eVar3);
    }
  }
  else if (bVar1 == 4) {
    eVar3 = groups_cluster_remove_all_groups_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
