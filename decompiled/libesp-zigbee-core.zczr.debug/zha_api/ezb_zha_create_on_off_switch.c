 ...
 * Source: libesp-zigbee-core.zczr.debug -> zha_api.o -> ezb_zha_create_on_off_switch
 *
...
ezb_af_ep_desc_t ezb_zha_create_on_off_switch(uint8_t ep_id,ezb_zha_on_off_switch_config_t *cfg)

{
  ...
  if (cfg == (ezb_zha_on_off_switch_config_t *)0x0) {
