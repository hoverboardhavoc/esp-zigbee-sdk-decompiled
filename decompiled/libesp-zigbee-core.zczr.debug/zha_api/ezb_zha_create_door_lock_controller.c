 ...
 * Source: libesp-zigbee-core.zczr.debug -> zha_api.o -> ezb_zha_create_door_lock_controller
 *
...

{
  ...
  ezb_af_endpoint_add_cluster_desc(pvVar2,uVar3);
  uVar3 = ezb_zcl_door_lock_create_cluster_desc(0,2);
  ezb_af_endpoint_add_cluster_desc(pvVar2,uVar3);
  uVar3 = ezb_zcl_identify_create_cluster_desc(0,2);
  ezb_af_endpoint_add_cluster_desc(pvVar2,uVar3);
  uVar3 = ezb_zcl_groups_create_cluster_desc(0,2);
  ezb_af_endpoint_add_cluster_desc(pvVar2,uVar3);
  uVar3 = ezb_zcl_scenes_create_cluster_desc(0,2);
  ezb_af_endpoint_add_cluster_desc(pvVar2,uVar3);
  return pvVar2;
}
