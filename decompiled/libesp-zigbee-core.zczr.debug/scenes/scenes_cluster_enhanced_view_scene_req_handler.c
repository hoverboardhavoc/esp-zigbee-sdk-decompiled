...
ezb_zcl_status_t
scenes_cluster_enhanced_view_scene_req_handler(zcl_packet_t *packet,zcl_packet_t *rsp)

{
  ...
  if ((packet == (zcl_packet_t *)0x0) || (rsp == (zcl_packet_t *)0x0)) {
    __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/scenes.c",0x462,
...
_L0:
    ...
    unaff_s4 = CONCAT31(extraout_var,eVar2);
    ...
    zmsg_append_bytes(rsp->payload,2,&uStack_28);
    uStack_28 = CONCAT11(uStack_28._1_1_,unaff_s0->transition_time_100ms != '\0');
    zmsg_append_bytes(rsp->payload,1,&uStack_28);
...
_L0:
  if ((packet->header).dst_addr.u.short_addr < 0xfff8) {
    ...
    eVar2 = zcl_packet_setup_response(rsp,packet,0x41);
  }
  else {
    eVar2 = 0xfe;
  }
