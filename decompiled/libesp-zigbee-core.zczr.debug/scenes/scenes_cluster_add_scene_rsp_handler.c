 ...
 * Source: libesp-zigbee-core.zczr.debug -> scenes.o -> scenes_cluster_add_scene_rsp_handler
 *
...
void scenes_cluster_add_scene_rsp_handler(int param_1,undefined4 param_2)
