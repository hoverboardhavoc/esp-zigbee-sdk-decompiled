 ...
 * Source: libesp-zigbee-core.zczr.debug -> scenes.o -> scenes_cluster_remove_scene_rsp_handler
 *
...
ezb_zcl_status_t scenes_cluster_remove_scene_rsp_handler(zcl_packet_t *packet,zcl_packet_t *rsp)
