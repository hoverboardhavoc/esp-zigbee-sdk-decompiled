 ...
 * Source: libesp-zigbee-core.zczr.debug -> scenes.o -> ezb_zcl_scenes_copy_scene_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_scenes_copy_scene_cmd_t *)0x0) {
    ...
    if (iVar2 == 0) {
      eVar1 = zcl_cmd_to_packet(&uStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,0x42,5);
      if (eVar1 == 0) {
        uStack_3a = CONCAT11(uStack_3a._1_1_,(cmd_req->payload).mode);
        eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3a);
        if (eVar1 == 0) {
          uStack_3a = (cmd_req->payload).group_id_from;
          eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_3a);
          if (eVar1 == 0) {
            uStack_3a = CONCAT11(uStack_3a._1_1_,(cmd_req->payload).scene_id_from);
            eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3a);
            if (eVar1 == 0) {
              uStack_3a = (cmd_req->payload).group_id_to;
              eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_3a);
              if (eVar1 == 0) {
                uStack_3a = CONCAT11(uStack_3a._1_1_,(cmd_req->payload).scene_id_to);
                eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3a);
                if (eVar1 == 0) {
