...
joined_r0x000120bc:
    ...
    if (bVar1 != 8) {
_L0:
      __assert_func("//build/esp-zigbee/src/core/mac/mac.c",0x253,"mac_do_transmit",&_L0);
      goto _L0;
    }
...
_L0:
    dev_00 = (mac_device *)
             __assert_func("//build/esp-zigbee/src/core/mac/mac.c",0x259,"mac_do_transmit",
                           "(mac_pal_transmit()) == 0");
