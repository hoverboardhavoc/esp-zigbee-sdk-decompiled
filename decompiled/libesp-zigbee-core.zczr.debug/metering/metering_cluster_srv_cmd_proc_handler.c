...

{
  ...
  if (bVar1 == 6) {
    eVar3 = metering_cluster_get_snapshot_cmd_handler
    ...
    if (bVar1 == 0) {
      eVar3 = metering_cluster_get_profile_cmd_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)&cnf_ctx.user_ctx,
                         (ezb_zcl_cmd_cnf_ctx_t *)local_40);
      ...
      if (bVar1 != 3) goto _L0;
      eVar3 = metering_cluster_req_fast_poll_mode_cmd_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)&cnf_ctx.user_ctx);
      iVar2 = CONCAT31(extraout_var,eVar3);
    }
  }
  else if (bVar1 == 8) {
    eVar3 = metering_cluster_get_sampled_data_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)&cnf_ctx.user_ctx,
                       (ezb_zcl_cmd_cnf_ctx_t *)local_40);
