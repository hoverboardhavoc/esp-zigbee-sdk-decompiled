...

{
  ...
  if (bVar1 == 6) {
    eVar3 = metering_cluster_publish_snapshot_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
    iVar2 = CONCAT31(extraout_var_02,eVar3);
  }
  else if (bVar1 < 7) {
    if (bVar1 == 0) {
      eVar3 = metering_cluster_get_profile_rsp_cmd_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var_01,eVar3);
    }
    else {
      if (bVar1 != 3) goto _L0;
      eVar3 = metering_cluster_req_fast_poll_mode_rsp_cmd_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var,eVar3);
    }
  }
  else if (bVar1 == 7) {
    eVar3 = metering_cluster_get_sampled_data_rsp_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
