...
ezb_err_t touchlink_send_join_router_rsp(uint8_t status,uint8_t tsn,void *arg)

{
  ...
  rsp._16_4_ = touchlink_join_router_rsp_confirm;
  ...
  eVar2 = zcl_touchlink_network_join_router_rsp(&uStack_2c);
  return eVar2;
}
