 ...
 * Source: libesp-zigbee-core.zczr.debug -> touchlink_join_router.o -> touchlink_send_join_router_rsp
 *
...
void touchlink_send_join_router_rsp(undefined1 param_1,undefined1 param_2,undefined4 param_3)

{
  ...
  pcStack_18 = touchlink_join_router_rsp_confirm;
  ...
  zcl_touchlink_network_join_router_rsp(&uStack_2c);
  return;
}
