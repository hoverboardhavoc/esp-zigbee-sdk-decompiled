 ...
 * Source: libesp-zigbee-core.zczr.debug -> carbon_dioxide_measurement_desc.o -> ezb_zcl_carbon_dioxide_measurement_cluster_desc_add_attr
 *
...
ezb_err_t ezb_zcl_carbon_dioxide_measurement_cluster_desc_add_attr
...

{
  ...
  if (cluster_desc == (ezb_zcl_cluster_desc_t)0x0) {
    ...
    if (*cluster_desc == 0x40d) {
      eVar1 = zcl_carbon_dioxide_measurement_cluster_get_attr_properties
