 ...
 * Source: libesp-zigbee-core.zczr.debug -> ota_upgrade_cli.o -> ota_upgrade_download_stop_retry
 *
...

{
  ...
  if (param_1 == 0) {
    iVar1 = __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/ota_upgrade_cli.c"
                          ,0x171,"ota_upgrade_download_stop_retry","context");
  }
  else {
    iVar1 = param_1;
  ...
  zcl_packet_free((void *)(param_1 + 0x4c));
