 ...
 * Source: libesp-zigbee-core.zczr.debug -> electrical_measurement.o -> ezb_zcl_electrical_meas_get_prof_info_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_electrical_measurement_get_prof_info_cmd_t *)0x0) {
    ...
    if ((iVar1 == 0) &&
       (iVar1 = zcl_cmd_to_packet(&uStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,0,0xb04),
       iVar1 == 0)) {
