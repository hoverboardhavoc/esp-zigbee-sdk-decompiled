  ...
  if (param_1 == 0) {
    ...
    if (iVar1 == 0) {
      if (*(char *)(param_1 + 0x20) == '\0') {
        iVar1 = electrical_measurement_cluster_get_prof_info_cmd_handler
                          (param_1,&uStack_38,&local_40);
      }
      else if (*(char *)(param_1 + 0x20) == '\x01') {
        iVar1 = electrical_measurement_cluster_get_meas_prof_cmd_handler
                          (param_1,&uStack_38,&local_40);
      }
      else {
