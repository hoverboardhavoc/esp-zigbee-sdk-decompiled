 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_ace.o -> ias_ace_cluster_fire_cmd_handler
 *
...
ezb_zcl_status_t ias_ace_cluster_fire_cmd_handler(zcl_packet_t *packet,zcl_packet_t *rsp)

{
  ...
  if (packet == (zcl_packet_t *)0x0) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/ias_ace.c",0x131,
                  "ias_ace_cluster_fire_cmd_handler","packet");
  }
  else {
