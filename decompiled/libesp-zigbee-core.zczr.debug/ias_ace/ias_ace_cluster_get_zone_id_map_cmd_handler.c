...

{
  ...
  if ((packet == (zcl_packet_t *)0x0) || (rsp == (zcl_packet_t *)0x0)) {
    __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/ias_ace.c",0x14c,
  ...
  piVar2 = (int *)__assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/ias_ace.c",0x14e,
                                "ias_ace_cluster_get_zone_id_map_cmd_handler","table");
  while( true ) {
    in_a4 = in_a4 + 1;
_L0:
