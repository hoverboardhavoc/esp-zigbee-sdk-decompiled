 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_ace.o -> ias_ace_cluster_panel_status_changed_cmd_handler
 *
...
ezb_zcl_status_t
ias_ace_cluster_panel_status_changed_cmd_handler(zcl_packet_t *packet,zcl_packet_t *rsp)

{
  ...
  ezb_zcl_ias_ace_panel_status_changed_message_t message;
  uint16_t offset;
  ...
  if ((packet == (zcl_packet_t *)0x0) || (rsp == (zcl_packet_t *)0x0)) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/ias_ace.c",0x252,
                  "ias_ace_cluster_panel_status_changed_cmd_handler","packet && rsp");
  }
  else {
      ...
      if (CONCAT22(extraout_var_02,uVar2) == 0) {
        ...
        if (uVar3 < (ushort)message._18_2_) {
          ...
          if (uVar3 == 0) {
            ...
            zcl_core_action_schedule(0x27,&uStack_28);
