 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_ace.o -> ezb_zcl_ias_ace_get_zone_status_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_ias_ace_get_zone_status_cmd_t *)0x0) {
    ...
    if ((iVar1 == 0) &&
       (iVar1 = zcl_cmd_to_packet(&uStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,9,0x501),
       iVar1 == 0)) {
      uStack_3a = CONCAT11(uStack_3a._1_1_,(cmd_req->payload).starting_zone_id);
      iVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3a);
      if (iVar1 == 0) {
        uStack_3a = CONCAT11(uStack_3a._1_1_,(cmd_req->payload).max_num_zone_ids);
        iVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3a);
        if (iVar1 == 0) {
          uStack_3a = CONCAT11(uStack_3a._1_1_,(cmd_req->payload).zone_status_mask_flag);
          iVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3a);
          if (iVar1 == 0) {
