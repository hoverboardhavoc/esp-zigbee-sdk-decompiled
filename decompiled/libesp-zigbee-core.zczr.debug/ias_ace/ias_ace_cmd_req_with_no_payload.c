 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_ace.o -> ias_ace_cmd_req_with_no_payload
 *
...
ezb_err_t ias_ace_cmd_req_with_no_payload
                    (ezb_zcl_ias_ace_cmd_with_no_payload_t *cmd_req,uint8_t cmd_id)

{
  ...
  packet._34_2_ = 0;
  if (cmd_req == (ezb_zcl_ias_ace_cmd_with_no_payload_t *)0x0) {
    iVar1 = -1;
  }
  else {
    ...
    if ((iVar1 == 0) &&
       (iVar1 = zcl_cmd_to_packet(&uStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,
                                  CONCAT31(in_register_0000202d,cmd_id),0x501), iVar1 == 0)) {
