 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_ace.o -> ezb_zcl_ias_ace_get_zone_information_cmd_req
 *
...
ezb_err_t ezb_zcl_ias_ace_get_zone_information_cmd_req(ezb_zcl_ias_ace_get_zone_info_cmd_t *cmd_req)

{
  ...
  packet._34_2_ = 0;
  if (cmd_req == (ezb_zcl_ias_ace_get_zone_info_cmd_t *)0x0) {
    iVar1 = -1;
  }
  else {
    iVar1 = zcl_packet_init(&uStack_38,0);
    if ((iVar1 == 0) &&
       (iVar1 = zcl_cmd_to_packet(&uStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,6,0x501),
       iVar1 == 0)) {
