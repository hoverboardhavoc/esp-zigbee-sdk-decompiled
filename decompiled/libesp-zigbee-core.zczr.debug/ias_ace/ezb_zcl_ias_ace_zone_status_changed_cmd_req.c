 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_ace.o -> ezb_zcl_ias_ace_zone_status_changed_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_ias_ace_zone_status_changed_cmd_t *)0x0) {
    ...
    if ((iVar1 == 0) &&
       (iVar1 = zcl_cmd_to_packet(&uStack_38,0,1,(cmd_req->cmd_ctrl).dis_default_rsp,0,3,0x501),
       iVar1 == 0)) {
      if ((cmd_req->payload).zone_label[0] < 0x11) {
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 == 0) {
            uStack_3a = CONCAT11(uStack_3a._1_1_,(cmd_req->payload).aud_notif);
            iVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3a);
            if (iVar1 == 0) {
              ...
              if (uVar2 == 0) {
                ...
                iVar1 = zmsg_append_bytes(packet._32_4_,uVar2 + 1,(cmd_req->payload).zone_label);
              }
              if (iVar1 == 0) {
