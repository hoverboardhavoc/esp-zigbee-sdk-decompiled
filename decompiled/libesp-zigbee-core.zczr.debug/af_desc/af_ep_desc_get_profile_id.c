 ...
 * Source: libesp-zigbee-core.zczr.debug -> af_desc.o -> af_ep_desc_get_profile_id
 *
...
uint16_t af_ep_desc_get_profile_id(af_ep_desc_t *ep_desc)

{
  int iVar1;
  
  if (ep_desc != (af_ep_desc_t *)0x0) {
    return ep_desc->profile_id;
  }
