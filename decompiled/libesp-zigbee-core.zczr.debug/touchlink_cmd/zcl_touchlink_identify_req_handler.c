 ...
 * Source: libesp-zigbee-core.zczr.debug -> touchlink_cmd.o -> zcl_touchlink_identify_req_handler
 *
...
zcl_status_t zcl_touchlink_identify_req_handler(zcl_packet_t *packet)

{
  ...
  if (packet == (zcl_packet_t *)0x0) {
    ...
    af_read_le16(packet->payload,&uStack_2e,(uint16_t *)&req.transaction_id);
    uVar3 = zmsg_get_length(packet->payload);
    if (uVar3 < uStack_2e) {
      zVar2 = 0x80;
    }
    else {
      uVar1 = touchlink_identify_req_handler(&stack0xffffffd4);
