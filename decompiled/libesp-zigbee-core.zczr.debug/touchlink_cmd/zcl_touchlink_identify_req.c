...
int zcl_touchlink_identify_req(undefined4 *param_1)

{
  ...
  if (param_1 == (undefined4 *)0x0) {
    ...
    if (iVar1 == 0) {
      ...
      iVar1 = zcl_touchlink_cmd_to_packet(&uStack_38,0,6,&local_50);
      if (iVar1 == 0) {
        uStack_3c = param_1[3];
        iVar1 = zmsg_append_bytes(uStack_14,4,&uStack_3c);
        if (iVar1 == 0) {
          uStack_3c = CONCAT22(uStack_3c._2_2_,*(undefined2 *)(param_1 + 4));
