 ...
 * Source: libesp-zigbee-core.zczr.debug -> touchlink_cmd.o -> zcl_touchlink_scan_rsp
 *
...

{
  ...
  if (cmd_rsp == (zcl_touchlink_scan_rsp_t *)0x0) {
    ...
    if (iVar2 == 0) {
      eVar1 = zcl_touchlink_cmd_to_packet((zcl_packet_t *)auStack_38,'\x01','\x01',unaff_s1);
      if (eVar1 == 0) {
        packet.header.fc = (cmd_rsp->cmd_ctrl).tsn;
        packet.header._20_4_ = packet.header._20_4_ | 0x200000;
        uStack_3c = cmd_rsp->transaction_id;
        eVar1 = zmsg_append_bytes(packet._32_4_,4,&uStack_3c);
        if (eVar1 == 0) {
          uStack_3c = CONCAT31(uStack_3c._1_3_,cmd_rsp->rssi_correction);
          eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3c);
          if (eVar1 == 0) {
            uStack_3c = CONCAT31(uStack_3c._1_3_,cmd_rsp->zigbee_info);
            eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3c);
            if (eVar1 == 0) {
              uStack_3c = CONCAT31(uStack_3c._1_3_,cmd_rsp->touchlink_info);
              eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3c);
              if (eVar1 == 0) {
                uStack_3c = CONCAT22(uStack_3c._2_2_,cmd_rsp->key_bitmask);
                eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_3c);
                if (eVar1 == 0) {
                  uStack_3c = cmd_rsp->response_id;
                  eVar1 = zmsg_append_bytes(packet._32_4_,4,&uStack_3c);
                  if ((eVar1 == 0) &&
                     (eVar1 = zmsg_append_bytes(packet._32_4_,8,&cmd_rsp->ext_panid), eVar1 == 0)) {
                    uStack_3c = CONCAT31(uStack_3c._1_3_,cmd_rsp->nwk_update_id);
                    eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3c);
                    if (eVar1 == 0) {
                      uStack_3c = CONCAT31(uStack_3c._1_3_,cmd_rsp->channel);
                      eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3c);
                      if (eVar1 == 0) {
                        uStack_3c = CONCAT22(uStack_3c._2_2_,cmd_rsp->pan_id);
                        eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_3c);
                        if (eVar1 == 0) {
                          uStack_3c = CONCAT22(uStack_3c._2_2_,cmd_rsp->nwk_addr);
                          eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_3c);
                          if (eVar1 == 0) {
                            uStack_3c = CONCAT31(uStack_3c._1_3_,cmd_rsp->n_subdevs);
                            eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3c);
                            if (eVar1 == 0) {
                              uStack_3c = CONCAT31(uStack_3c._1_3_,cmd_rsp->total_group_ids);
                              eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3c);
                              if (eVar1 == 0) {
                                if (cmd_rsp->n_subdevs == '\x01') {
                                  uStack_3c = CONCAT31(uStack_3c._1_3_,(cmd_rsp->sub_device).ep_id);
                                  eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3c);
                                  if (eVar1 != 0) goto _L0;
                                  uStack_3c = CONCAT22(uStack_3c._2_2_,
                                                       (cmd_rsp->sub_device).profile_id);
                                  eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_3c);
                                  if (eVar1 != 0) goto _L0;
                                  uStack_3c = CONCAT22(uStack_3c._2_2_,
                                                       (cmd_rsp->sub_device).device_id);
                                  eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_3c);
                                  if (eVar1 != 0) goto _L0;
                                  uStack_3c = CONCAT31(uStack_3c._1_3_,(cmd_rsp->sub_device).version
                                                      );
                                  eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3c);
                                  if (eVar1 != 0) goto _L0;
                                  uStack_3c = CONCAT31(uStack_3c._1_3_,
                                                       (cmd_rsp->sub_device).n_group_ids);
                                  eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_3c);
                                  if (eVar1 != 0) goto _L0;
                                }
