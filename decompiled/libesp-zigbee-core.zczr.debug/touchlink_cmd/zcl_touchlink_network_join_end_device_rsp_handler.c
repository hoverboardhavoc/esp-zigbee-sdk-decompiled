 ...
 * Source: libesp-zigbee-core.zczr.debug -> touchlink_cmd.o -> zcl_touchlink_network_join_end_device_rsp_handler
 *
...
zcl_status_t zcl_touchlink_network_join_end_device_rsp_handler(zcl_packet_t *packet)

{
  ...
  if (packet == (zcl_packet_t *)0x0) {
    ...
    if (uVar3 < uStack_2e) {
      ...
      uVar1 = touchlink_join_ed_rsp_handler(&stack0xffffffd4);
