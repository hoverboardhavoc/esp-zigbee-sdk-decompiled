 ...
 * Source: libesp-zigbee-core.zczr.debug -> touchlink_cmd.o -> zcl_touchlink_network_start_req
 *
...

{
  ...
  if (cmd_req == (zcl_touchlink_network_start_req_t *)0x0) {
    ...
    if (iVar2 == 0) {
      eVar1 = zcl_touchlink_cmd_to_packet((zcl_packet_t *)auStack_38,'\0','\x10',unaff_s1);
      if (eVar1 == 0) {
        ...
        if ((eVar1 == 0) &&
             ...
             (eVar1 = zmsg_append_bytes(packet._32_4_,0x10,cmd_req->encrypted_nwk_key), eVar1 == 0))
          {
            ...
            if (eVar1 == 0) {
              ...
              if (eVar1 == 0) {
                uStack_3c = CONCAT22(uStack_3c._2_2_,cmd_req->nwk_addr);
                eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_3c);
                if (eVar1 == 0) {
                      ...
                      if (eVar1 == 0) {
                        ...
                        if (eVar1 == 0) {
                          ...
                          if (eVar1 == 0) {
                            ...
                            eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_3c);
                            if ((eVar1 == 0) &&
                               (eVar1 = zmsg_append_bytes(packet._32_4_,8,
                                                          &cmd_req->initiator_ieee_addr), eVar1 == 0
                               )) {
                              uStack_3c = CONCAT22(uStack_3c._2_2_,cmd_req->initiator_nwk_addr);
                              eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_3c);
                              if (eVar1 == 0) {
