...
int zcl_touchlink_network_start_req(undefined4 *param_1)

{
  ...
  if (param_1 == (undefined4 *)0x0) {
    ...
    if (iVar1 == 0) {
      ...
      iVar1 = zcl_touchlink_cmd_to_packet(&uStack_38,0,0x10,&local_50);
      if (iVar1 == 0) {
        uStack_3c = param_1[3];
        ...
        if ((iVar1 == 0) && (iVar1 = zmsg_append_bytes(uStack_14,8,param_1 + 4), iVar1 == 0)) {
          ...
          if ((iVar1 == 0) &&
            ...
            iVar1 = zmsg_append_bytes(uStack_14,1,&uStack_3c);
            if (iVar1 == 0) {
              uStack_3c = CONCAT22(uStack_3c._2_2_,*(undefined2 *)((int)param_1 + 0x2a));
                      ...
                      if (iVar1 == 0) {
                        ...
                        if (iVar1 == 0) {
                          ...
                          if (iVar1 == 0) {
                            ...
                            iVar1 = zmsg_append_bytes(uStack_14,2,&uStack_3c);
                            if ((iVar1 == 0) &&
                               (iVar1 = zmsg_append_bytes(uStack_14,8,(int)param_1 + 0x3a),
                               iVar1 == 0)) {
                              uStack_3c = CONCAT22(uStack_3c._2_2_,
                                                   *(undefined2 *)((int)param_1 + 0x42));
                              iVar1 = zmsg_append_bytes(uStack_14,2,&uStack_3c);
                              if (iVar1 == 0) {
                                zcl_packet_intrp_send(&uStack_38,param_1 + 0x11);
