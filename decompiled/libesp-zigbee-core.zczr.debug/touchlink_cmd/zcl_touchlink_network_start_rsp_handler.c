...
undefined1 zcl_touchlink_network_start_rsp_handler(undefined4 *param_1)

{
  ...
  if (param_1 == (undefined4 *)0x0) {
    ...
    af_read_le8(param_1[9],&uStack_3a,&uStack_28);
    af_read_bytes(param_1[9],&uStack_3a,8,(int)&uStack_28 + 1);
    af_read_le8(param_1[9],&uStack_3a,(int)&uStack_20 + 1);
    af_read_le8(param_1[9],&uStack_3a,(int)&uStack_20 + 2);
    ...
    if (uVar2 < uStack_3a) {
      ...
      uVar1 = touchlink_network_start_rsp_handler(&uStack_38);
