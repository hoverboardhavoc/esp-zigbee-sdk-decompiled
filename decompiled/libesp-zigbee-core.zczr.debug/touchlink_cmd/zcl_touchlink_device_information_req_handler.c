 ...
 * Source: libesp-zigbee-core.zczr.debug -> touchlink_cmd.o -> zcl_touchlink_device_information_req_handler
 *
...
zcl_status_t zcl_touchlink_device_information_req_handler(zcl_packet_t *packet)

{
  ...
  if (packet == (zcl_packet_t *)0x0) {
    ...
    if (uVar3 < uStack_2e) {
      ...
      uVar1 = touchlink_device_info_req_handler(&stack0xffffffd4);
