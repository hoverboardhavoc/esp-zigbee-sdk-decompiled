 ...
 * Source: libesp-zigbee-core.zczr.debug -> on_off_switch_config_desc.o -> ezb_zcl_on_off_switch_config_cluster_desc_add_attr
 *
...

{
  ...
  if (cluster_desc == (ezb_zcl_cluster_desc_t)0x0) {
    ...
    if (*cluster_desc == 7) {
      eVar1 = zcl_on_off_switch_config_cluster_get_attr_properties
