...

{
  ...
  if ((iVar5 == 0) ||
     (iVar5 = nwk_secur_get_seclevel(), (iVar5 != 0) != ((*(ushort *)(param_1 + 0x16) & 2) != 0)))
  goto _L0;
  uStack_30 = 0;
  uStack_2c = 0;
  uStack_28 = 0;
  ...
  uVar3 = uStack_30 >> 0x10;
  if ((iVar5 == 0) || (0xfff7 < uVar3 != (((int)(uStack_30 & 0xff) >> 3 & 3U) != 0))) goto _L0;
