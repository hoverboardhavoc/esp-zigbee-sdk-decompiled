...
undefined4
zcl_ias_zone_cluster_get_attr_properties(int param_1,uint param_2,char *param_3,char *param_4)

{
  ...
  if (param_3 == (char *)0x0) {
    ...
    if ((param_1 - 1U & 0xffff) < 2) {
      ...
      param_3 = "zcl_ias_zone_cluster_get_attr_properties";
      param_2 = __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/ias_zone_desc.c"
                              ,0x19);
    }
    if (param_2 == 0x10) {
      *param_4 = '\x03';
