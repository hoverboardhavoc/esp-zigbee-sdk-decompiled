 ...
 * Source: libesp-zigbee-core.zczr.debug -> thermostat.o -> thermostat_cluster_cli_cmd_proc_handler
 *
  ...
  if (param_1 == 0) {
    ...
    if (iVar1 == 0) {
      if (*(char *)(param_1 + 0x20) == '\0') {
        iVar1 = thermostat_get_weekly_schedule_rsp_cmd_handler(param_1,&uStack_38);
      }
      else {
