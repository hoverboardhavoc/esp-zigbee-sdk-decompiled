 ...
 * Source: libesp-zigbee-core.zczr.debug -> thermostat.o -> ezb_zcl_thermostat_cluster_client_init
 *
...

{
  ...
  template.write_attr_handler = thermostat_cluster_cli_cmd_disc_handler;
  template.cmd_disc_handler = thermostat_cluster_cli_cmd_proc_handler;
  iVar1 = zcl_cluster_template_add(&uStack_24);
  if (iVar1 == 0) {
    return;
  }
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/thermostat.c",0x57d,
