...

{
  ...
  if (bVar1 == 2) {
    eVar3 = thermostat_get_weekly_schedule_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
    iVar2 = CONCAT31(extraout_var_02,eVar3);
  }
  else if (bVar1 < 3) {
    if (bVar1 == 0) {
      eVar3 = thermostat_setpoint_raise_or_lower_cmd_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var_01,eVar3);
    }
    else {
      if (bVar1 != 1) goto _L0;
      eVar3 = thermostat_set_weekly_schedule_cmd_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var,eVar3);
    }
  }
  else if (bVar1 == 3) {
    eVar3 = thermostat_clear_weekly_schedule_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
