 ...
 * Source: libesp-zigbee-core.zczr.debug -> window_covering.o -> window_covering_cluster_srv_cmd_proc_handler
 *
...

{
  ...
  if (param_1 == 0) {
    ...
    if (iVar1 == 0) {
      if ((*(byte *)(param_1 + 0x20) < 9) &&
         ((0x1b7U >> (*(byte *)(param_1 + 0x20) & 0x1f) & 1) != 0)) {
        iVar1 = window_covering_cluster_movement_cmd_handler(param_1,&uStack_38);
      }
      else {
