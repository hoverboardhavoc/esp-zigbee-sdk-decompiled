...

{
  ...
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/window_covering.c",0x103,
  ...
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/window_covering.c",0x111,
