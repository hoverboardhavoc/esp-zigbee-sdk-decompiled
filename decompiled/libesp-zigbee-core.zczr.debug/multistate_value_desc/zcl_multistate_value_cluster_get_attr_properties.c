...
undefined4
zcl_multistate_value_cluster_get_attr_properties
...

{
  ...
  if ((param_1 - 1U & 0xffff) < 2) {
    ...
    param_3 = "zcl_multistate_value_cluster_get_attr_properties";
    param_2 = __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/multistate_value_desc.c"
                            ,0x19);
  }
  if (param_2 == 0x57) {
_L0:
