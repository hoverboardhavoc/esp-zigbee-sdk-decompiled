  ...
  if (iVar1 != 0) {
    ...
    *(undefined **)(iVar1 + 8) = puVar2;
    ...
    if ((param_2 & 1) != 0) {
      ...
      ezb_zcl_metering_cluster_desc_add_attr(iVar1,0x300,&uStack_17);
      ezb_zcl_metering_cluster_desc_add_attr(iVar1,0x303,&uStack_16);
      ezb_zcl_metering_cluster_desc_add_attr(iVar1,0x306,auStack_15);
    }
  }
  return iVar1;
}
