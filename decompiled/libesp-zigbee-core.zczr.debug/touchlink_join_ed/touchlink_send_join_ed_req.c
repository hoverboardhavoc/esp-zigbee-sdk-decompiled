...
ezb_err_t touchlink_send_join_ed_req(touchlink_disc_dev_info_t *dev_info)
  ...
  if (dev_info == (touchlink_disc_dev_info_t *)0x0) {
    ...
    if (iVar2 == 0) {
      ...
      if (iVar2 == 0) {
        ...
        req._42_2_ = touchlink_assign_short_addr();
        ...
        req._56_4_ = touchlink_join_ed_req_confirm;
        ...
        eVar6 = zcl_touchlink_network_join_end_device_req(auStack_54);
      }
    }
  }
  return eVar6;
