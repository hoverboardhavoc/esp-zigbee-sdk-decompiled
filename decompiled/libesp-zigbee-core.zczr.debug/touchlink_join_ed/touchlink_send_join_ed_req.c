 ...
 * Source: libesp-zigbee-core.zczr.debug -> touchlink_join_ed.o -> touchlink_send_join_ed_req
 *
...
undefined4 touchlink_send_join_ed_req(int param_1)
  ...
  if (param_1 == 0) {
    ...
    if (iVar2 == 0) {
      ...
      if (iVar2 == 0) {
        ...
        uStack_1c = 1;
        uStack_1a = 0xfeff;
        pcStack_18 = touchlink_join_ed_req_confirm;
        ...
        uVar4 = zcl_touchlink_network_join_end_device_req(auStack_54);
      }
    }
  }
  return uVar4;
