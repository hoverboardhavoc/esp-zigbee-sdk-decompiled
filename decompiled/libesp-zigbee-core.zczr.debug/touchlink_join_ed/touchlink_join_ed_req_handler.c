 ...
 * Source: libesp-zigbee-core.zczr.debug -> touchlink_join_ed.o -> touchlink_join_ed_req_handler
 *
...
void touchlink_join_ed_req_handler(int param_1)

{
  ...
  if (param_1 == 0) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/touchlink/touchlink_join_ed.c",0x5b,
                  "touchlink_join_ed_req_handler",&_L0);
_L0:
...
_L0:
  ...
  touchlink_send_join_ed_rsp(*(undefined1 *)(param_1 + 10),iVar9);
  return;
}
