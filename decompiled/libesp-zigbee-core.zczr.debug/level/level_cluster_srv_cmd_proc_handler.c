...

{
  ...
  if (bVar1 == 4) {
_L0:
    eVar3 = level_cluster_move_to_level_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
...
_L0:
    eVar3 = level_cluster_step_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
    iVar2 = CONCAT31(extraout_var,eVar3);
  }
  else if (bVar1 == 7) {
_L0:
    eVar3 = level_cluster_stop_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
    iVar2 = CONCAT31(extraout_var_01,eVar3);
  }
  else if (bVar1 < 8) {
    if (bVar1 == 5) {
_L0:
      eVar3 = level_cluster_move_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
...
_L0:
    ...
    if (bVar1 != 8) goto _L0;
    eVar3 = level_cluster_move_to_closest_frequency_cmd_handler
