 ...
 * Source: libesp-zigbee-core.zczr.debug -> level.o -> ezb_zcl_level_cluster_client_init
 *
...

{
  ...
  template.write_attr_handler = level_cluster_cli_cmd_disc_handler;
  template.cmd_disc_handler = (zcl_cluster_disc_cmd_t)0x0;
  iVar1 = zcl_cluster_template_add(&uStack_24);
  if (iVar1 == 0) {
    return;
  }
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/level.c",699,
