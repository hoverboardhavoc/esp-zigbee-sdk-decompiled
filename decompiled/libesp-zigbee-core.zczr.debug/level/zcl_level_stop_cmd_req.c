 ...
 * Source: libesp-zigbee-core.zczr.debug -> level.o -> zcl_level_stop_cmd_req
 *
...
ezb_err_t zcl_level_stop_cmd_req(_Bool is_on_off,ezb_zcl_level_stop_cmd_t *req)

{
  ...
  packet._34_2_ = 0;
  if (req == (ezb_zcl_level_stop_cmd_t *)0x0) {
    iVar1 = 2;
  }
  else {
    ...
    if (iVar1 == 0) {
      ...
      if (iVar1 == 0) {
        uStack_39 = (req->payload).options_mask;
        iVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_39);
        if (iVar1 == 0) {
          uStack_39 = (req->payload).options_override;
          iVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_39);
          if (iVar1 == 0) {
