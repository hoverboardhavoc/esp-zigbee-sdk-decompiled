...

{
  ...
  *(byte *)(param_1 + 0x1a) = bVar2;
  bVar2 = bVar2 | param_2 & 3;
  *(byte *)(param_1 + 0x1a) = bVar2;
  if (param_3 == 0) {
    *(byte *)(param_1 + 0x1a) = bVar1 & 0xf8 | param_2 & 3;
  }
  else {
    *(byte *)(param_1 + 0x1a) = bVar2 | 4;
  }
  if (param_4 == 0) {
    *(byte *)(param_1 + 0x1a) = *(byte *)(param_1 + 0x1a) & 0xf7;
  }
  else {
    *(byte *)(param_1 + 0x1a) = *(byte *)(param_1 + 0x1a) | 8;
  }
  if (param_5 == 0) {
