...
void zcl_general_disc_cmd_rsp_handler(int param_1,int param_2)

{
  ...
  if ((((param_1 == 0) || (*(int *)(param_1 + 0x24) == 0)) || (param_2 == 0)) ||
     (*(int *)(param_2 + 0x24) == 0)) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/zcl/zcl_general_cmd.c",0x3e5,
                  "zcl_general_disc_cmd_rsp_handler",
                  "packet && packet->payload && rsp && rsp->payload");
  }
  else {
    unaff_s4 = zcl_packet_to_message(&uStack_38,param_1);
    if (unaff_s4 != 0) {
      uVar2 = 0x80;
      goto _L0;
    }
  ...
  uStack_2c = CONCAT31(uStack_2c._1_3_,*(char *)(param_1 + 0x20) == '\x12');
  while (uStack_3a < uVar2) {
    pvVar1 = calloc(1,8);
    af_read_le8(*(undefined4 *)(param_1 + 0x24),&uStack_3a,pvVar1);
    *(void **)((int)pvVar1 + 4) = pvStack_28;
    pvStack_28 = pvVar1;
  }
  uStack_24 = CONCAT31(uStack_24._1_3_,0xfe);
  zcl_core_action_schedule(7,&uStack_38);
