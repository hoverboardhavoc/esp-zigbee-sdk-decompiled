...
int zcl_read_report_config_cmd_req(int param_1)
  ...
  if (param_1 == 0) {
    ...
    if (iVar1 == 0) {
      ...
      iVar2 = zcl_cmd_to_packet(&uStack_38,0,uVar3 & 1,uVar3 >> 1 & 1,uVar3 >> 2 & 1,
                                *(undefined2 *)(param_1 + 0xe),8,*(undefined2 *)(param_1 + 0xc));
      iVar1 = iVar2;
      if (iVar2 == 0) {
        while ((iVar2 < (int)(uint)*(ushort *)(param_1 + 0x1c) && (*(int *)(param_1 + 0x20) != 0)))
        {
          puVar4 = (undefined1 *)(*(int *)(param_1 + 0x20) + iVar2 * 4);
          uStack_3a = CONCAT11(uStack_3a._1_1_,*puVar4);
          iVar1 = zmsg_append_bytes(uStack_14,1,&uStack_3a);
          if (iVar1 != 0) goto _L0;
          uStack_3a = *(undefined2 *)(puVar4 + 2);
