...
void zcl_general_configure_reporting_rsp_handler(int param_1,int param_2)

{
  ...
  if ((((param_1 == 0) || (*(int *)(param_1 + 0x24) == 0)) || (param_2 == 0)) ||
     (*(int *)(param_2 + 0x24) == 0)) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/zcl/zcl_general_cmd.c",0x2ab,
...
_L0:
    if (uStack_36 < uVar2) {
      ...
      zcl_core_action_schedule(3,&uStack_34);
...
_L0:
  ...
  return;
_L0:
  af_read_le8(*(undefined4 *)(param_1 + 0x24),&uStack_36,(int)&local_40 + 1);
