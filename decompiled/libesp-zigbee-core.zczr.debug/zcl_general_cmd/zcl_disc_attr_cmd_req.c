 ...
 * Source: libesp-zigbee-core.zczr.debug -> zcl_general_cmd.o -> zcl_disc_attr_cmd_req
 *
...

{
  ...
  if (cmd_req == (zcl_disc_attr_cmd_t *)0x0) {
    ...
    if (iVar2 == 0) {
      ...
      if (eVar1 == 0) {
        uStack_3a = (cmd_req->payload).start_attr_id;
        eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_3a);
        if (eVar1 == 0) {
          uStack_3a = CONCAT11(uStack_3a._1_1_,(cmd_req->payload).max_attr_number);
