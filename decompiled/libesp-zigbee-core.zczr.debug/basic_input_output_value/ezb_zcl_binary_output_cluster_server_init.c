 ...
 * Source: libesp-zigbee-core.zczr.debug -> basic_input_output_value.o -> ezb_zcl_binary_output_cluster_server_init
 *
...

{
  ...
  uStack_24 = 0x10010;
  template._0_4_ = binary_basic_cluster_srv_check_value_handler;
  ...
  pcVar1 = ezb_zcl_binary_output_cluster_client_init;
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/basic_input_output_value.c",0xd5,
                "ezb_zcl_binary_output_cluster_server_init",
  ...
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/basic_input_output_value.c",0xd5,
                "ezb_zcl_binary_output_cluster_client_init",
                "zcl_cluster_template_add(&template) == EZB_ZCL_STATUS_SUCCESS");
  return;
}
