 ...
 * Source: libesp-zigbee-core.zczr.debug -> basic_input_output_value.o -> ezb_zcl_analog_output_cluster_client_init
 *
...

{
  ...
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/basic_input_output_value.c",0xd2,
                "ezb_zcl_analog_output_cluster_client_init",
