 ...
 * Source: libesp-zigbee-core.zczr.debug -> basic_input_output_value.o -> ezb_zcl_binary_input_cluster_server_init
 *
...

{
  ...
  pcVar1 = ezb_zcl_binary_input_cluster_client_init;
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/basic_input_output_value.c",0xd4,
                "ezb_zcl_binary_input_cluster_server_init",
  ...
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/basic_input_output_value.c",0xd4,
                "ezb_zcl_binary_input_cluster_client_init",
                "zcl_cluster_template_add(&template) == EZB_ZCL_STATUS_SUCCESS");
  return;
}
