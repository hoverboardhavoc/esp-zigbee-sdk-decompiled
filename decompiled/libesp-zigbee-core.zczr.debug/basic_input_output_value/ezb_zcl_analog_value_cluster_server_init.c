...

{
  ...
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/basic_input_output_value.c",0xd3,
                "ezb_zcl_analog_value_cluster_server_init",
  ...
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/basic_input_output_value.c",0xd3,
                "ezb_zcl_analog_value_cluster_client_init",
                "zcl_cluster_template_add(&template) == EZB_ZCL_STATUS_SUCCESS");
  return;
}
