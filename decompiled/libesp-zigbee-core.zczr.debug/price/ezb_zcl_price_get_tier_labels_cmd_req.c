 ...
 * Source: libesp-zigbee-core.zczr.debug -> price.o -> ezb_zcl_price_get_tier_labels_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_price_get_tier_labels_cmd_t *)0x0) {
    ...
    if (iVar2 == 0) {
      eVar1 = zcl_cmd_to_packet(auStack_3c + 1,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,10,0x700);
      if (eVar1 == 0) {
