...

{
  ...
  if (param_1 == 0) {
    ...
    if (iVar2 == 0) {
      ...
      if (cVar1 == 'A') {
        iVar2 = touchlink_commissioning_get_group_ids_rsp_cmd_handler(param_1,&uStack_38);
      }
      else if (cVar1 == 'B') {
        iVar2 = touchlink_commissioning_get_endpoint_list_rsp_cmd_handler(param_1,&uStack_38);
      }
      else if (cVar1 == '@') {
        iVar2 = touchlink_commissioning_endpoint_info_cmd_handler(param_1,&uStack_38);
      }
      else {
