...

{
  ...
  template.write_attr_handler = touchlink_commissioning_cluster_cli_cmd_disc_handler;
  template.cmd_disc_handler = touchlink_commissioning_cluster_cli_cmd_proc_handler;
