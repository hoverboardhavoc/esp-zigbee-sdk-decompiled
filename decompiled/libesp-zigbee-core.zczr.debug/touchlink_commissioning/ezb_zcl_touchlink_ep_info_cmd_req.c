...

{
  ...
  if (cmd_req == (ezb_zcl_touchlink_ep_info_cmd_req_t *)0x0) {
    ...
    if (iVar2 == 0) {
      eVar1 = zcl_cmd_to_packet(&uStack_38,0,1,(cmd_req->cmd_ctrl).dis_default_rsp,0,0x40,0x1000);
      if (eVar1 == 0) {
        uStack_40 = *(uint *)&(cmd_req->ieee_addr).field_0;
        uStack_3c = *(undefined4 *)((int)&(cmd_req->ieee_addr).field_0 + 4);
        eVar1 = zmsg_append_bytes(packet._32_4_,8,&uStack_40);
        if (eVar1 == 0) {
          uStack_40 = CONCAT22(uStack_40._2_2_,cmd_req->nwk_addr);
          eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_40);
          if (eVar1 == 0) {
            uStack_40 = CONCAT31(uStack_40._1_3_,cmd_req->ep_id);
            eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_40);
            if (eVar1 == 0) {
              uStack_40 = CONCAT22(uStack_40._2_2_,cmd_req->profile_id);
              eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_40);
              if (eVar1 == 0) {
                uStack_40 = CONCAT22(uStack_40._2_2_,cmd_req->device_id);
                eVar1 = zmsg_append_bytes(packet._32_4_,2,&uStack_40);
                if (eVar1 == 0) {
                  uStack_40 = CONCAT31(uStack_40._1_3_,cmd_req->device_version) & 0xffffff0f;
                  eVar1 = zmsg_append_bytes(packet._32_4_,1,&uStack_40);
                  if (eVar1 == 0) {
