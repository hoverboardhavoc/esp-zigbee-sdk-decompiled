...
undefined4 touchlink_commissioning_join_ed(int param_1)

{
  ...
  if (iVar1 == 0) {
    ...
    iVar1 = touchlink_commissioning_action_permission(3,param_1 + 0xf);
    if (iVar1 == 0) {
      uVar2 = 0xffffffff;
    }
    else {
      touchlink_commissioning_set_task(6);
      uVar2 = touchlink_send_join_ed_req(param_1);
    }
  }
  return uVar2;
}
