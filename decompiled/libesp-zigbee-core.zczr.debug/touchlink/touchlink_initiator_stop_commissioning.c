 ...
 * Source: libesp-zigbee-core.zczr.debug -> touchlink.o -> touchlink_initiator_stop_commissioning
 *
...

{
  ...
  if (ptVar1->role == '\x01') {
    touchlink_initiator_set_commissioning_device((touchlink_disc_dev_info_t *)0x0);
  }
