...
ezb_err_t touchlink_commissioning_join_router(touchlink_disc_dev_info_t *dev_info)

{
  ...
  if (CONCAT31(extraout_var,_Var1) == 0) {
    ...
    _Var1 = touchlink_commissioning_action_permission
                      (TOUCHLINK_ACTION_JOIN_ROUTER,&(dev_info->basic).ieee_addr);
    if (CONCAT31(extraout_var_00,_Var1) == 0) {
      ...
      if (dev_info == (touchlink_disc_dev_info_t *)0x0) {
        ...
        eVar2 = touchlink_send_join_router_req(dev_info);
      }
    }
  }
  return eVar2;
