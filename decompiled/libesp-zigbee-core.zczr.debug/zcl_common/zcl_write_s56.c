...
void zcl_write_s56(uint8_t *buf,ezb_zcl_int56_t val)

{
  ...
  uStack_4 = (uint8_t)in_a2;
  uStack_3 = (uint8_t)((uint)in_a2 >> 8);
  bStack_2 = (byte)((uint)in_a2 >> 0x10);
  *buf = uStack_8;
  buf[1] = uStack_7;
  buf[2] = uStack_6;
  buf[3] = uStack_5;
