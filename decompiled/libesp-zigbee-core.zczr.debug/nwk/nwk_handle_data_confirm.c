...

{
  ...
  zmsg_read_bytes(0,2,&cnf.field_0xa);
  if ((cnf._10_2_ & 3) == 0) {
    cnf.nsdu = (zmsg_t *)0x0;
  ...
  else if ((cnf._10_2_ & 3) == 1) {
    local_20 = (zmsg_t *)((uint)local_20 & 0xffffff00);
    uVar1 = zmsg_get_offset(msg);
    zmsg_read_bytes(msg,uVar1,1,&local_20);
    uVar2 = (uint)local_20 & 0xff;
    if (uVar2 == 0xb) {
