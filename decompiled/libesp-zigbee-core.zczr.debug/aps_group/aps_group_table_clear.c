...

{
  ...
  __assert_func("//build/esp-zigbee/src/core/aps/aps_group.c",0xdc,"aps_group_table_clear",&_LC3);
  iVar2 = core_globals_get();
  iVar2 = *(int *)(iVar2 + 0x95c);
  iVar3 = core_globals_get();
  iVar4 = *(int *)(iVar3 + 0x960);
  ...
  __assert_func("//build/esp-zigbee/src/core/aps/aps_group.c",0xe2,"aps_group_table_deinit",&_LC3);
