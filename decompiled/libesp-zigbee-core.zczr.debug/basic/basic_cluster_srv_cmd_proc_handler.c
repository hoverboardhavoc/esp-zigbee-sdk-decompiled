 ...
 * Source: libesp-zigbee-core.zczr.debug -> basic.o -> basic_cluster_srv_cmd_proc_handler
 *
  ...
  if (param_1 == 0) {
    ...
    if (iVar1 == 0) {
      if (*(char *)(param_1 + 0x20) == '\0') {
        iVar1 = basic_cluster_reset_to_factory_default_cmd_handler(param_1,&uStack_38);
      }
      else {
