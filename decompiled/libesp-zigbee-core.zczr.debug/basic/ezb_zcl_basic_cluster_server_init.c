...

{
  ...
  template.write_attr_handler = basic_cluster_srv_cmd_disc_handler;
  template.cmd_disc_handler = basic_cluster_srv_cmd_proc_handler;
  iVar2 = zcl_cluster_template_add(&uStack_24);
  if (iVar2 == 0) {
    return;
  }
  pcVar1 = ezb_zcl_basic_cluster_client_init;
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/basic.c",0x8e,
  ...
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/basic.c",0x9c,
