...
ezb_err_t zcl_pressure_measurement_cluster_get_attr_properties
...

{
  ...
  if ((CONCAT22(in_register_0000202a,cluster_role) - 1U & 0xffff) < 2) {
    ...
    pcVar2 = "zcl_pressure_measurement_cluster_get_attr_properties";
    uVar1 = __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/pressure_measurement_desc.c"
                          ,0x19);
    type = (uint8_t *)pcVar2;
