...

{
  ...
  *puVar2 = uVar1 + '\x01';
  ...
  if (iVar3 == 0) {
    ...
    __assert_func("//build/esp-zigbee/src/core/aps/aps_frame.c",0x11c,"aps_frame_append_cmd_hdr",
  ...
  __assert_func("//build/esp-zigbee/src/core/aps/aps_frame.c",0x120,"aps_frame_append_cmd_hdr",
