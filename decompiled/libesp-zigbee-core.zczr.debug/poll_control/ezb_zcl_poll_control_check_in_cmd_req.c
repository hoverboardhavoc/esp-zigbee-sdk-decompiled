 ...
 * Source: libesp-zigbee-core.zczr.debug -> poll_control.o -> ezb_zcl_poll_control_check_in_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_poll_control_check_in_cmd_t *)0x0) {
    ...
    if (iVar2 == 0) {
      eVar1 = zcl_cmd_to_packet(&uStack_38,0,1,(cmd_req->cmd_ctrl).dis_default_rsp,0,0,0x20);
      if (eVar1 == 0) {
