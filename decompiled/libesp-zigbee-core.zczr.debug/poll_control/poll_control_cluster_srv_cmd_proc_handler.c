...

{
  ...
  if (bVar1 == 2) {
    eVar3 = poll_control_cluster_srv_set_long_poll_interval_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
    iVar2 = CONCAT31(extraout_var_02,eVar3);
  }
  else if (bVar1 < 3) {
    if (bVar1 == 0) {
      eVar3 = poll_control_cluster_srv_check_in_rsp_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var_01,eVar3);
    }
    else {
      if (bVar1 != 1) goto _L0;
      eVar3 = poll_control_cluster_srv_fast_poll_stop_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var,eVar3);
    }
  }
  else if (bVar1 == 3) {
    eVar3 = poll_control_cluster_srv_set_short_poll_interval_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
