 ...
 * Source: libesp-zigbee-core.zczr.debug -> poll_control.o -> ezb_zcl_poll_control_set_short_poll_interval_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_poll_control_set_short_poll_interval_cmd_t *)0x0) {
    ...
    if (iVar2 == 0) {
      eVar1 = zcl_cmd_to_packet(&uStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,3,0x20);
      if (eVar1 == 0) {
