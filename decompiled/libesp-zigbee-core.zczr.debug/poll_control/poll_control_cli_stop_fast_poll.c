...

{
  ...
  auStack_28 = (packet->header).src_addr.addr_mode;
  cmd_req.cmd_ctrl.dst_addr._0_4_ = *(undefined4 *)((int)&(packet->header).src_addr.u + 2);
  cmd_req.cmd_ctrl.dst_addr.u._4_1_ = (packet->header).src_ep;
  cmd_req.cmd_ctrl.dst_addr.u.group_addr.bcast =
