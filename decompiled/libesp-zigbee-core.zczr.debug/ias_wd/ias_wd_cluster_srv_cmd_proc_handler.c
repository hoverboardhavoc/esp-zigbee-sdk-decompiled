 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_wd.o -> ias_wd_cluster_srv_cmd_proc_handler
 *
  ...
  if (arg == (void *)0x0) {
    ...
    if (iVar1 == 0) {
      if (*(char *)((int)arg + 0x20) == '\0') {
        eVar2 = ias_wd_cluster_start_warning_cmd_handler
                          ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
        iVar1 = CONCAT31(extraout_var,eVar2);
      }
      else if (*(char *)((int)arg + 0x20) == '\x01') {
        eVar2 = ias_wd_cluster_squawk_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
