...
void ias_wd_cluster_squawk_cmd_handler(int param_1,int param_2)

{
  ...
  uStack_1c = CONCAT31((int3)((uint)uStack_1c >> 8),
                       bStack_13 & 0xf0 | (byte)((bStack_13 >> 2 & 3) << 2) | bStack_13 & 3);
  uVar1 = zcl_packet_to_message(&uStack_28,param_1);
  if (uVar1 == 0) {
    uStack_18 = CONCAT31(uStack_18._1_3_,0xfe);
    iStack_20 = param_1;
    zcl_core_action_schedule(0x2e,&uStack_28);
