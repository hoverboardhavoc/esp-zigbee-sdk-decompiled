 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_wd.o -> ezb_zcl_ias_wd_start_warning_cmd_req
 *
...
int ezb_zcl_ias_wd_start_warning_cmd_req(int param_1)

{
  ...
  if (param_1 == 0) {
    ...
    if ((iVar1 == 0) &&
       (iVar1 = zcl_cmd_to_packet(&uStack_38,0,0,*(undefined1 *)(param_1 + 0xc),0,0,0x502),
       iVar1 == 0)) {
      uVar2 = *(uint *)(param_1 + 0x18);
      uStack_3a = CONCAT11(uStack_3a._1_1_,
                           (byte)((uVar2 >> 4 & 3) << 2) | (byte)(uVar2 >> 6) & 3 |
                           (byte)((uVar2 & 0xf) << 4));
