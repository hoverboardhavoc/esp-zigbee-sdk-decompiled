 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_wd.o -> ezb_zcl_ias_wd_squawk_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_ias_wd_squawk_cmd_t *)0x0) {
    ...
    if ((iVar1 == 0) &&
       (iVar1 = zcl_cmd_to_packet(&uStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,1,0x502),
       iVar1 == 0)) {
      uVar2 = *(uint *)&cmd_req->payload;
      bStack_39 = (byte)((uVar2 >> 4 & 0xf) << 4) | (byte)((uVar2 >> 2 & 3) << 2) | (byte)uVar2 & 3;
      iVar1 = zmsg_append_bytes(packet._32_4_,1,&bStack_39);
      if (iVar1 == 0) {
