...

{
  ...
  if (req == (apsme_update_device_req_t *)0x0) {
    ...
    iVar1 = *(int *)((int)&req->field_0 + 4);
    if (*(int *)&req->field_0 == 0 && iVar1 == 0) {
      msg = (zmsg_t *)0x0;
      eVar3 = 2;
    }
    else if ((*(int *)&req->field_0 == -1) && (iVar1 == -1)) {
      msg = (zmsg_t *)0x0;
      eVar3 = 2;
    }
    else {
      piVar2 = (int *)nwk_get_extended_address();
      if ((*(int *)&req->field_0 == *piVar2) && (*(int *)((int)&req->field_0 + 4) == piVar2[1])) {
      ...
      if (msg == (zmsg_t *)0x0) {
        ...
        zmsg_append_bytes(msg,2,&uStack_18);
        uStack_18 = CONCAT31(uStack_18._1_3_,req->status);
        zmsg_append_bytes(msg,1,&uStack_18);
        eVar3 = aps_send_cmd(msg,(ezb_extaddr_t *)req,true);
        if (eVar3 == 0) {
          return 0;
        }
      }
