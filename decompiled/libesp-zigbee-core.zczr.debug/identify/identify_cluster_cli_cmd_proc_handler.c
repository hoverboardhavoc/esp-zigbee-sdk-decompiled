 ...
 * Source: libesp-zigbee-core.zczr.debug -> identify.o -> identify_cluster_cli_cmd_proc_handler
 *
  ...
  if (param_1 == 0) {
    ...
    if (iVar1 == 0) {
      if (*(char *)(param_1 + 0x20) == '\0') {
        iVar1 = identify_cluster_identify_query_rsp_handler(param_1,&uStack_38);
        if (iVar1 == 0) {
