 ...
 * Source: libesp-zigbee-core.zczr.debug -> identify.o -> identify_cluster_srv_cmd_proc_handler
 *
...

{
  ...
  if (param_1 == 0) {
    ...
    if (iVar2 == 0) {
      ...
      if (cVar1 == '\x01') {
        iVar2 = identify_cluster_query_cmd_handler(param_1,&uStack_38);
      }
      else if (cVar1 == '@') {
        iVar2 = identify_cluster_trigger_effect_cmd_handler(param_1,&uStack_38);
      }
      else if (cVar1 == '\0') {
        iVar2 = identify_cluster_identify_cmd_handler(param_1,&uStack_38);
      }
      else {
