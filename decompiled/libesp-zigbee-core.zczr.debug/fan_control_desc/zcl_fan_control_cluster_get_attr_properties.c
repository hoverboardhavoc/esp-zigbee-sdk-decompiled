...
ezb_err_t zcl_fan_control_cluster_get_attr_properties
...

{
  ...
  if (type == (uint8_t *)0x0) {
    ...
    uVar5 = (uint)((CONCAT22(in_register_0000202a,cluster_role) - 1U & 0xffff) < 2);
    if (uVar5 == 0) {
      pcVar4 = "cluster_role == 0x01U || cluster_role == 0x02U";
      pcVar3 = "zcl_fan_control_cluster_get_attr_properties";
      uVar2 = __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/fan_control_desc.c"
                            ,0x19);
      type = (uint8_t *)pcVar3;
