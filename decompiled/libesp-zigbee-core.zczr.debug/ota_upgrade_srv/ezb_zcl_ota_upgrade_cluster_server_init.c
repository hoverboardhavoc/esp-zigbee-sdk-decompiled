...
void ezb_zcl_ota_upgrade_cluster_server_init(void)

{
  ...
  uStack_20 = 0;
  uStack_1c = 0;
  pcStack_18 = ota_upgrade_cluster_srv_cmd_disc_handler;
  pcStack_14 = ota_upgrade_cluster_srv_cmd_proc_handler;
  iVar1 = ota_upgrade_srv_ota_file_table_init();
  if (iVar1 == 0) {
