...

{
  ...
  if (eVar1 == 0) {
    ...
    __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/ota_upgrade_srv.c",0x1f6,
                  "ezb_zcl_ota_upgrade_cluster_server_init",
                  "ota_upgrade_srv_ota_file_table_init(ep_id) == 0");
  }
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/ota_upgrade_srv.c",0x1f7,
                "ezb_zcl_ota_upgrade_cluster_server_init",
