 ...
 * Source: libesp-zigbee-core.zczr.debug -> test_utils.o -> ezb_nwk_concentrator_start
 *
...

{
  ...
  if (CONCAT31(in_register_00002031,disc_time) < CONCAT31(in_register_0000202d,disc_sp_time)) {
    eVar2 = 2;
  }
  else {
