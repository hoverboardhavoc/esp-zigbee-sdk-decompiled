...
void af_data_indication_deliver_ep_handler(int param_1)

{
  ...
  iVar2 = __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/af/af_core.c",0x8e,
  ...
  if (iVar2 == 0) {
    ...
    while (pcVar1 = (char *)af_device_get_next_endpoint_desc(pcVar1), pcVar1 != (char *)0x0) {
      if ((*pcVar1 != -1) && (*(short *)(pcVar1 + 2) == *(short *)(iVar2 + 10))) {
        af_data_indication_deliver_ep(iVar2,uVar3);
        uVar3 = random_add_jitter(uVar3,10);
      }
    }
  }
  zmsg_free(*(undefined4 *)(iVar2 + 0x10));
  return;
}
