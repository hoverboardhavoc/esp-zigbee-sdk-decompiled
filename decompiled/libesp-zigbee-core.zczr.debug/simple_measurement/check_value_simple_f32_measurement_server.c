...

{
  ...
  if ((uVar6 == 0) || (uVar6 == 2)) {
    ...
    __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/simple_measurement.c",0xb2,
                  "check_value_simple_f32_measurement_server",
...
_L0:
  ...
  if ((pzVar3 == (zcl_attr_desc_t *)0x0) || ((undefined4 *)pzVar3->data_p == (undefined4 *)0x0)) {
    __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/simple_measurement.c",0xb9,
                  "check_value_simple_f32_measurement_server",
                  "attr_desc != ((void *)0) && attr_desc->data_p != ((void *)0)");
    return '\x01';
  }
