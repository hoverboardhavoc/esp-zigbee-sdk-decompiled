...

{
  ...
  if ((*(ushort *)(bind._12_4_ + 0x16) & 0x20) == 0) {
    ...
    __assert_func("//build/esp-zigbee/src/core/aps/aps_main.c",0x163,"aps_bind_trans_confirm",
                  "!zmsg_test_flag(bind_trans.orig_msg, ((1 << ((5) % (sizeof(unsigned long) * 8)))))"
                 );
  }
  __assert_func("//build/esp-zigbee/src/core/aps/aps_main.c",0x168,"aps_bind_trans_confirm",
                "bind.cnt > 0");
_L0:
