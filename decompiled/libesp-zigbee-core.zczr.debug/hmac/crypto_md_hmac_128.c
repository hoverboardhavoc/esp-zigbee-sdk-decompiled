 ...
 * Source: libesp-zigbee-core.zczr.debug -> hmac.o -> crypto_md_hmac_128
 *
...

{
  ...
  if (*param_1 != 1) {
    ...
    param_1 = (int *)__assert_func("//builds/thread_zigbee/esp-zigbee/src/core/crypto/hmac.c",0x77,
                                   "crypto_md_hmac_128",&_L0,param_4,param_5);
    param_2 = extraout_a1;
  }
  iVar2 = 0x10;
  uVar1 = 0x10;
