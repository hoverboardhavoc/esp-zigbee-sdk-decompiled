...

{
  ...
  if ((iVar1 == 0) &&
     (iVar1 = zcl_cmd_to_packet(&tx_option,0,0,*(undefined1 *)(in_a0 + 0xc),0,
                                CONCAT31(in_register_00002031,cmd_id),0x101), iVar1 == 0)) {
    abStack_4c[0] = abStack_4c[0] & 0xfe | aps_secur_enabled;
    zcl_packet_send_with_ext(&tx_option,in_a0 + 0x10,abStack_4c);
