...
void door_lock_cluster_unlock_door_rsp_handler(int param_1,int param_2)

{
  ...
  if ((param_1 == 0) || (param_2 == 0)) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/door_lock.c",0xa7,
  ...
  if (uVar2 == 0) {
    ...
    iStack_20 = param_1;
    zcl_core_action_schedule(0x1a,&uStack_28);
