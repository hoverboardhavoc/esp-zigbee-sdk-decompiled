...
void door_lock_cluster_unlock_door_cmd_handler(int param_1,int param_2)

{
  ...
  if ((param_1 == 0) || (param_2 == 0)) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/door_lock.c",0x85,
  ...
  iStack_18 = param_1;
  zcl_core_action_schedule(0x18,&uStack_20);
  uStack_21 = (char)uStack_14 != '\0';
  uVar1 = zmsg_append_bytes(*(undefined4 *)(param_2 + 0x24),1,&uStack_21);
  uVar1 = uVar1 & 0xff;
  if ((uVar1 == 0) && (uVar1 = zcl_packet_setup_response(param_2,param_1,1), uVar1 == 0)) {
    return;
  }
_L0:
