 ...
 * Source: libesp-zigbee-core.zczr.debug -> meter_identification_desc.o -> ezb_zcl_meter_identification_cluster_desc_add_attr
 *
...
ezb_err_t ezb_zcl_meter_identification_cluster_desc_add_attr
...

{
  ...
  if (cluster_desc == (ezb_zcl_cluster_desc_t)0x0) {
    ...
    if (*cluster_desc == 0xb01) {
      eVar1 = zcl_meter_identification_cluster_get_attr_properties
