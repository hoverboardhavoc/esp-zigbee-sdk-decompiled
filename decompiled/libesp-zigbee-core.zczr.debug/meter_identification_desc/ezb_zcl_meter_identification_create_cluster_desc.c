 ...
 * Source: libesp-zigbee-core.zczr.debug -> meter_identification_desc.o -> ezb_zcl_meter_identification_create_cluster_desc
 *
...

{
  ...
  uStack_24 = 0;
  server_default_cfg.company_name._0_2_ = 0;
  server_default_cfg.company_name._2_2_ = 0;
