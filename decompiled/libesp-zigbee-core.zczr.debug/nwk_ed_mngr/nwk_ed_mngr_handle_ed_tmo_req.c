...
_L0:
  ...
  if (*(ushort *)(iVar4 + 0x10) == (ushort)bStack_27) {
    iVar1 = 0;
  }
  else {
    *(ushort *)(iVar4 + 0x10) = (ushort)bStack_27;
  }
  if ((*(uint *)(iVar4 + 0x14) >> 0x14 & 0xf) == (uint)bStack_28) {
    if (iVar1 != 0) goto _L0;
  }
  else {
    *(uint *)(iVar4 + 0x14) = (bStack_28 & 0xf) << 0x14 | *(uint *)(iVar4 + 0x14) & 0xff0fffff;
_L0:
