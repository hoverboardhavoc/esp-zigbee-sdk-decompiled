 ...
 * Source: libesp-zigbee-core.zczr.debug -> analog_input_desc.o -> ezb_zcl_analog_input_create_cluster_desc
 *
...

{
  ...
  if (cluster_desc != (ezb_zcl_cluster_desc_t)0x0) {
    ...
    *(undefined **)((int)cluster_desc + 8) = puVar1;
    ...
    if ((role_mask & 1) != 0) {
      ezb_zcl_analog_input_cluster_desc_add_attr(cluster_desc,0x51,&uStack_1c);
