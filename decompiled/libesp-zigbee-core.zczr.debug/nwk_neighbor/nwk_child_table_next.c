...
int nwk_child_table_next(int param_1)

{
  ...
  if (param_1 == 0) {
    uVar2 = ((uint)*(ushort *)(iVar1 + 0xb24) - (uint)*(ushort *)(iVar1 + 0xb26) & 0xffff) - 1;
  }
  else {
    uVar2 = (param_1 - *(int *)(iVar1 + 0xb20) >> 2) * -0x49249249;
  }
  uVar2 = bitmap_find_next_bit
                    (*(undefined4 *)(iVar1 + 0xb1c),*(undefined2 *)(iVar1 + 0xb24),
                     (uVar2 & 0xffff) + 1 & 0xffff);
