...

{
  ...
  __assert_func("//build/esp-zigbee/src/core/nwk/nwk_neighbor.c",0x1a7,"nwk_neighbor_table_init",
                &_L0);
  iVar2 = core_globals_get();
  _Var1 = nbt_is_inited((nwk_neighbor_table_t *)(iVar2 + 0xb1c));
  ...
  iVar2 = __assert_func("//build/esp-zigbee/src/core/nwk/nwk_neighbor.c",0x1b5,
                        "nwk_neighbor_table_deinit",&_L0);
