...
int ezb_zcl_analog_value_create_cluster_desc(undefined1 *param_1,uint param_2)

{
  ...
  if (iVar1 != 0) {
    ...
    *(undefined **)(iVar1 + 8) = puVar2;
    ...
    if ((param_2 & 1) != 0) {
      ezb_zcl_analog_value_cluster_desc_add_attr(iVar1,0x51,&uStack_1c);
      ezb_zcl_analog_value_cluster_desc_add_attr(iVar1,0x55,&uStack_18);
      ezb_zcl_analog_value_cluster_desc_add_attr(iVar1,0x6f,&uStack_14);
    }
  }
  return iVar1;
}
