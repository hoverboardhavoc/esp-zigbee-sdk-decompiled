...

{
  ...
  if (iVar2 == 0) {
    ...
    __assert_func("//build/esp-zigbee/src/core/mac/mac_pal.c",0x9f,"start_transmit",
                  "(ezb_plat_radio_transmit(tx_frame)) == 0");
  }
  iVar2 = __assert_func("//build/esp-zigbee/src/core/mac/mac_pal.c",0x9b,"start_transmit",
                        "(ezb_plat_radio_receive(tx_frame->channel)) == 0");
