 ...
 * Source: libesp-zigbee-core.zczr.debug -> nwk_route_table.o -> route_disc_table_find
 *
...

{
  ...
  while( true ) {
    ...
    if (((uint)pnVar2->src_addr == CONCAT22(in_register_0000202e,src_addr)) &&
       ((uint)pnVar2->rreq_id == CONCAT31(in_register_00002031,rreq_id))) break;
