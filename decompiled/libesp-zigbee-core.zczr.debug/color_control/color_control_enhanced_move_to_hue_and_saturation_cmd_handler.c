 ...
 * Source: libesp-zigbee-core.zczr.debug -> color_control.o -> color_control_enhanced_move_to_hue_and_saturation_cmd_handler
 *
...
ezb_zcl_status_t
color_control_enhanced_move_to_hue_and_saturation_cmd_handler
          (zcl_packet_t *packet,zcl_packet_t *rsp)

{
  ...
  ezb_zcl_color_control_enhanced_move_to_hue_and_saturation_cmd_payload_t req;
  uint16_t offset;
  ...
  if (packet == (zcl_packet_t *)0x0) {
    ...
    if (uVar4 < (ushort)req._6_2_) {
      ...
      af_read_le8(packet->payload,(uint16_t *)offset_00,&req.saturation);
      af_read_le8(packet->payload,(uint16_t *)offset_00,&req.field_0x3);
      _Var2 = color_control_check_options_is_exec((packet->header).dst_ep,req.saturation,req._3_1_);
      if (CONCAT31(extraout_var,_Var2) == 0) {
        ...
        if (uVar4 == 0) {
          bVar3 = cvc_enhanced_move_to_hue_and_sat
