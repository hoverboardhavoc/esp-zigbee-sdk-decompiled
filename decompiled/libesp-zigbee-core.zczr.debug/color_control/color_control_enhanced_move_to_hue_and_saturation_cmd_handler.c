...
void color_control_enhanced_move_to_hue_and_saturation_cmd_handler(int param_1,int param_2)
  ...
  if (param_1 == 0) {
    ...
    if (uVar1 < uStack_12) {
      ...
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          iVar2 = cvc_enhanced_move_to_hue_and_sat(*(undefined1 *)(param_1 + 0x15),&uStack_1c,0);
        }
      }
    }
  }
