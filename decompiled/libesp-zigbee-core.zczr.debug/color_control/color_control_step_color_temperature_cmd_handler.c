...
void color_control_step_color_temperature_cmd_handler(int param_1,int param_2)

{
  ...
  if (param_1 == 0) {
    ...
    af_read_le8(*(undefined4 *)(param_1 + 0x24),&uStack_12,&local_20);
    af_read_le16(*(undefined4 *)(param_1 + 0x24),&uStack_12,(int)&local_20 + 2);
    ...
    if (uVar1 < uStack_12) {
      ...
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          iVar2 = step_cvc_color_temperature(*(undefined1 *)(param_1 + 0x15),&local_20,0);
        }
      }
    }
  }
