...
void color_control_step_color_cmd_handler(int param_1,int param_2)

{
  ...
  if (param_1 == 0) {
    ...
    af_read_le16(*(undefined4 *)(param_1 + 0x24),&uStack_12,(int)&uStack_18 + 1);
    ...
    if (uVar1 < uStack_12) {
      ...
      if (iVar2 == 0) {
        ...
        iVar2 = color_control_change_color_mode(param_1,1);
        if (iVar2 == 0) {
          iVar2 = step_cvc_color(*(undefined1 *)(param_1 + 0x15),&uStack_18,0);
        }
      }
    }
  }
