...
int ezb_zcl_color_control_step_color_cmd_req(int param_1)

{
  ...
  if (param_1 == 0) {
    ...
    if (iVar1 == 0) {
      iVar1 = zcl_cmd_to_packet(&uStack_38,0,0,*(undefined1 *)(param_1 + 0xc),0,9,0x300);
      if (iVar1 == 0) {
        uStack_3a = (ushort)*(byte *)(param_1 + 0x18);
        iVar1 = zmsg_append_bytes(uStack_14,2,&uStack_3a);
        if (iVar1 == 0) {
          uStack_3a = (ushort)*(byte *)(param_1 + 0x19);
          iVar1 = zmsg_append_bytes(uStack_14,2,&uStack_3a);
          if (iVar1 == 0) {
