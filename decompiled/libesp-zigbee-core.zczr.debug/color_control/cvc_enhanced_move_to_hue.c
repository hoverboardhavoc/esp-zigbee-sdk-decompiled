...
undefined4 cvc_enhanced_move_to_hue(uint param_1,ushort *param_2)

{
  ...
  if (param_2 == (ushort *)0x0) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/color_control.c",0x6df
...
_L0:
    ...
    if (bVar1 == 2) {
      ...
      if (bVar1 == 0) {
        ...
        if (uStack_2c < uStack_28 == 0x8000 < iVar2) {
