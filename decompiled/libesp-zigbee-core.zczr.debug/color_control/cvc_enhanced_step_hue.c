...
ezb_zcl_status_t
cvc_enhanced_step_hue(uint8_t ep_id,ezb_zcl_color_control_enhanced_step_hue_cmd_payload_t *payload)

{
  ...
  if (payload == (ezb_zcl_color_control_enhanced_step_hue_cmd_payload_t *)0x0) {
    __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/color_control.c",0x784,
