 ...
 * Source: libesp-zigbee-core.zczr.debug -> color_control.o -> cvc_color_xy_output_handler
 *
...
/* WARNING: Variable defined which should be unmapped: color_xy */
...

{
  ...
  iVar1 = math_mod(output,0xff00);
  auStack_12[0] = (short)iVar1;
