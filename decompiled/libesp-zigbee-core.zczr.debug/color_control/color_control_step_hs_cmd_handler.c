...
void color_control_step_hs_cmd_handler(int param_1,int param_2)
      ...
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          if (*(char *)(param_1 + 0x20) == '\x02') {
            iVar2 = cvc_step_hue(*(undefined1 *)(param_1 + 0x15),&uStack_18,0);
          }
          else {
            iVar2 = step_cvc_sat(*(undefined1 *)(param_1 + 0x15),&uStack_18);
          }
        }
      }
    }
