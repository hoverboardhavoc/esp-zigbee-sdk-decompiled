...
undefined4 cvc_move_to_color_xy(uint param_1,ushort *param_2)

{
  ...
  if (param_2 == (ushort *)0x0) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/color_control.c",0x4d1
    ...
    if (*param_2 < 0xff00) {
      ...
      uStack_20 = uStack_40;
      iVar1 = color_control_srv_get_attr_desc(3);
