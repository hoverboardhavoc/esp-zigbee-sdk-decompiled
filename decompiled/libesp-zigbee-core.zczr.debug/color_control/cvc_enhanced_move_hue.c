...
undefined4 cvc_enhanced_move_hue(undefined4 param_1,char *param_2,uint param_3)

{
  ...
  if (param_2 == (char *)0x0) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/api/zcl/cluster/color_control.c",0x731
