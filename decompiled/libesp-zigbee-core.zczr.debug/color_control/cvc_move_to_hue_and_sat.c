...
ezb_zcl_status_t
cvc_move_to_hue_and_sat
          (uint8_t ep_id,ezb_zcl_color_control_move_to_hue_and_saturation_cmd_payload_t *payload)

{
  ...
  if (payload == (ezb_zcl_color_control_move_to_hue_and_saturation_cmd_payload_t *)0x0) {
    __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/color_control.c",0x47a,
