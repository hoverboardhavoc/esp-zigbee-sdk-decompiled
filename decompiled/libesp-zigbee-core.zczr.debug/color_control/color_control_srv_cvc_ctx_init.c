...

{
  ...
  if (pzVar1 == (zcl_attr_desc_t *)0x0) {
    __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/color_control.c",0x15b,
  ...
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/color_control.c",0x15e,
