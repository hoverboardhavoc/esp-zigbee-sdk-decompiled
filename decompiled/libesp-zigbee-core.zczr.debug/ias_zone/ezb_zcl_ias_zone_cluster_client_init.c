 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_zone.o -> ezb_zcl_ias_zone_cluster_client_init
 *
...

{
  ...
  template.write_attr_handler = ias_zone_cluster_cli_cmd_disc_handler;
  template.cmd_disc_handler = ias_zone_cluster_cli_cmd_proc_handler;
  iVar1 = zcl_cluster_template_add(&uStack_24);
  if (iVar1 == 0) {
    return;
  }
  __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/ias_zone.c",0x239,
