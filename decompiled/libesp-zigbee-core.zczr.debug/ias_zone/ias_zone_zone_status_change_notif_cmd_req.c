...
int ias_zone_zone_status_change_notif_cmd_req(int param_1)

{
  ...
  if (param_1 == 0) {
    ...
    if ((iVar1 == 0) &&
       (iVar1 = zcl_cmd_to_packet(&uStack_38,0,1,*(undefined1 *)(param_1 + 0xc),0,0,0x500),
       iVar1 == 0)) {
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          uStack_3a = CONCAT11(uStack_3a._1_1_,*(undefined1 *)(param_1 + 0x1b));
          iVar1 = zmsg_append_bytes(uStack_14,1,&uStack_3a);
          if (iVar1 == 0) {
