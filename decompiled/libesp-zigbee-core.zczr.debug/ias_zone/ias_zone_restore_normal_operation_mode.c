...

{
  ...
  if (ctx == (void *)0x0) {
    __assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/ias_zone.c",0xb3,
  ...
  psVar6 = (short *)__assert_func("//build/esp-zigbee/src/core/api/zcl/cluster/ias_zone.c",0xbf,
                                  "ias_zone_restore_normal_operation_mode","attr_desc");
