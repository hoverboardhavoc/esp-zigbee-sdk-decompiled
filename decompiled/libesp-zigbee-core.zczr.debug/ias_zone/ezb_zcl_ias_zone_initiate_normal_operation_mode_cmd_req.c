 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_zone.o -> ezb_zcl_ias_zone_initiate_normal_operation_mode_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_ias_zone_initiate_normal_operation_mode_cmd_t *)0x0) {
    ...
    if ((iVar1 == 0) &&
       (iVar1 = zcl_cmd_to_packet(&uStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,1,0x500),
       iVar1 == 0)) {
