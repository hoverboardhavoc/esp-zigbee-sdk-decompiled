 ...
 * Source: libesp-zigbee-core.zczr.debug -> ias_zone.o -> ias_zone_cluster_cli_cmd_proc_handler
 *
  ...
  if (arg == (void *)0x0) {
    ...
    if (iVar1 == 0) {
      if (*(char *)((int)arg + 0x20) == '\0') {
        eVar2 = ias_zone_status_change_notification_cmd_handler
                          ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
        iVar1 = CONCAT31(extraout_var_00,eVar2);
      }
      else if (*(char *)((int)arg + 0x20) == '\x01') {
        eVar2 = ias_zone_enroll_request_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
