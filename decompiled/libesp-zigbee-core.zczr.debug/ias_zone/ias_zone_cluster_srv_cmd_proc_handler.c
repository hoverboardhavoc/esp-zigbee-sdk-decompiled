...

{
  ...
  if (arg == (void *)0x0) {
    ...
    if (iVar2 == 0) {
      ...
      if (cVar1 == '\x01') {
        eVar3 = ias_zone_initiate_normal_operation_mode_cmd_handler
                          ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
        iVar2 = CONCAT31(extraout_var_00,eVar3);
      }
      else if (cVar1 == '\x02') {
        eVar3 = ias_zone_initiate_test_mode_cmd_handler
                          ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
        iVar2 = CONCAT31(extraout_var_01,eVar3);
      }
      else if (cVar1 == '\0') {
        eVar3 = ias_zone_enroll_rsp_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
