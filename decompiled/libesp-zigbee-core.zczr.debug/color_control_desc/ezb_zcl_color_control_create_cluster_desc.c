...

{
  ...
  server_default_cfg._0_4_ = (int)"cluster_role == 0x01U || cluster_role == 0x02U" + 1;
  server_default_cfg.color_mode = '\b';
  server_default_cfg.options = '\0';
  server_default_cfg.enhanced_color_mode = '\0';
  server_default_cfg._7_1_ = 0;
  cluster_desc = (ezb_zcl_cluster_desc_t)zcl_create_cluster_desc(0x300,0);
  if (cluster_desc != (ezb_zcl_cluster_desc_t)0x0) {
    ...
    *(undefined **)((int)cluster_desc + 8) = puVar1;
    if (cluster_cfg != (void *)0x0) {
      ...
      server_default_cfg._4_4_ = *(undefined4 *)((int)cluster_cfg + 8);
    }
    zcl_cluster_desc_add_revision_attr(cluster_desc,3);
    if ((role_mask & 1) != 0) {
      ezb_zcl_color_control_cluster_desc_add_attr(cluster_desc,3,&uStack_1c);
      ezb_zcl_color_control_cluster_desc_add_attr(cluster_desc,4,(void *)((int)&uStack_1c + 2));
