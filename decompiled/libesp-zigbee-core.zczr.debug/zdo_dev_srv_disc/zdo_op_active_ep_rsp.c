...
uint zdo_op_active_ep_rsp(int param_1,char *param_2,int param_3)

{
  ...
  if ((param_1 == 0) || (param_2 == (char *)0x0)) {
    __assert_func("//builds/thread_zigbee/esp-zigbee/src/core/zdo/zdo_dev_srv_disc.c",0x256,
                  "zdo_op_active_ep_rsp","payload && rsp");
  }
  else if (param_3 == 0) {
    auStack_22[0] = 0;
    ...
    if (uVar3 < auStack_22[0]) {
      ...
      if ((*param_2 == '\0') && (__nmemb = (uint)(byte)param_2[4], __nmemb != 0)) {
        ...
        *(void **)(param_2 + 8) = pvVar2;
        ...
        af_read_bytes(param_1,auStack_22,__nmemb,pvVar2);
      }
      else {
        param_2[8] = '\0';
        param_2[9] = '\0';
    ...
    if (iVar1 == 0) {
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          if (*param_2 == '\0') {
            unaff_s3 = (uint)(byte)param_2[4];
            if (unaff_s3 != 0) {
              for (uVar3 = 0; unaff_s3 = 0, uVar3 < (byte)param_2[4]; uVar3 = uVar3 + 1 & 0xff) {
                auStack_22[0] =
                     CONCAT11(auStack_22[0]._1_1_,*(undefined1 *)(*(int *)(param_2 + 8) + uVar3));
                iVar1 = zmsg_append_bytes(param_1,1,auStack_22);
                if (iVar1 != 0) {
                  return 0x8a;
                }
