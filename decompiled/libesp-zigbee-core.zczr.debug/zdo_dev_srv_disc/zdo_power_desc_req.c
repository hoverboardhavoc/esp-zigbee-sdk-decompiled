 ...
 * Source: libesp-zigbee-core.zczr.debug -> zdo_dev_srv_disc.o -> zdo_power_desc_req
 *
...

{
  ...
  if (req == (zdo_power_desc_req_t *)0x0) {
    ...
    iVar3 = zdo_packet_init(&uStack_28,3,req->dst_nwk_addr,req->cb,req->user_ctx);
    if (iVar3 == 0) {
      zVar2 = zdo_op_power_desc_req((zdo_packet_payload_t *)packet.ctx.req_ctx.arg,&req->field,true)
      ;
