 ...
 * Source: libesp-zigbee-core.zczr.debug -> zdo_dev_srv_disc.o -> zdo_ieee_addr_req
 *
...

{
  ...
  if (req == (zdo_ieee_addr_req_t *)0x0) {
    ...
    iVar3 = zdo_packet_init(&uStack_28,1,req->dst_nwk_addr,req->cb,req->user_ctx);
    if (iVar3 == 0) {
      zVar2 = zdo_op_ieee_addr_req((zdo_packet_payload_t *)packet.ctx.req_ctx.arg,&req->field,true);
