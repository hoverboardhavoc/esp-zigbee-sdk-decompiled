 ...
 * Source: libesp-zigbee-core.zczr.debug -> alarms.o -> alarms_cluster_srv_cmd_proc_handler
 *
...

{
  ...
  if (bVar1 == 2) {
    eVar3 = alarms_cluster_get_alarm_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
    iVar2 = CONCAT31(extraout_var_02,eVar3);
  }
  else if (bVar1 < 3) {
    if (bVar1 == 0) {
      eVar3 = alarms_cluster_reset_alarm_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38)
      ;
      iVar2 = CONCAT31(extraout_var_01,eVar3);
    }
    else {
      if (bVar1 != 1) goto _L0;
      eVar3 = alarms_cluster_reset_all_alarms_cmd_handler
                        ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
      iVar2 = CONCAT31(extraout_var,eVar3);
    }
  }
  else if (bVar1 == 3) {
    eVar3 = alarms_cluster_reset_alarm_log_cmd_handler
                      ((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
