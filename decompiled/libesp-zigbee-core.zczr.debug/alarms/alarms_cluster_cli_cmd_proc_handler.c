 ...
 * Source: libesp-zigbee-core.zczr.debug -> alarms.o -> alarms_cluster_cli_cmd_proc_handler
 *
  ...
  if (arg == (void *)0x0) {
    ...
    if (iVar1 == 0) {
      if (*(char *)((int)arg + 0x20) == '\0') {
        eVar2 = alarms_cluster_alarm_cmd_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38);
        iVar1 = CONCAT31(extraout_var_00,eVar2);
      }
      else if (*(char *)((int)arg + 0x20) == '\x01') {
        eVar2 = alarms_cluster_get_alarm_rsp_handler((zcl_packet_t *)arg,(zcl_packet_t *)auStack_38)
        ;
