 ...
 * Source: libesp-zigbee-core.zczr.debug -> alarms.o -> ezb_zcl_alarms_cluster_client_init
 *
...

{
  ...
  template.write_attr_handler = alarms_cluster_cli_cmd_disc_handler;
  template.cmd_disc_handler = alarms_cluster_cli_cmd_proc_handler;
