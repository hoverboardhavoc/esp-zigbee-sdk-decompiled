 ...
 * Source: libesp-zigbee-core.zczr.debug -> alarms.o -> ezb_zcl_alarms_reset_alarm_cmd_req
 *
...

{
  ...
  if (cmd_req == (ezb_zcl_alarms_reset_alarm_cmd_t *)0x0) {
    ...
    if (iVar2 == 0) {
      eVar1 = zcl_cmd_to_packet(&uStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,0,9);
      if (eVar1 == 0) {
