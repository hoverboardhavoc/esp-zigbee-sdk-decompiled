 ...
 * Source: libesp-zigbee-core.zczr.debug -> buffer.o -> zmsg_read_bytes
 *
...

{
  ...
  while ((ushort)chunk.data != 0) {
    memcpy(__dest,chunk.buffer,(uint)(ushort)chunk.data);
    __dest = (void *)((int)__dest + (uint)(ushort)chunk.data);
