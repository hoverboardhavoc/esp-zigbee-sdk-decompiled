 ...
 * Source: libesp-zigbee-core.zczr.debug -> zcl_reporting.o -> zcl_reporting_info_find
 *
...

{
  ...
  while( true ) {
    ...
    if ((((piVar4 != (int *)0x0) &&
         (pzVar2 = (zcl_reporting_info_t *)*piVar4,
         (uint)pzVar2->ep_id == CONCAT31(in_register_00002029,ep_id))) &&
        ((uint)pzVar2->cluster_id == CONCAT22(in_register_0000202e,cluster_id))) &&
       ((((pzVar2->cluster_role & role) != 0 &&
