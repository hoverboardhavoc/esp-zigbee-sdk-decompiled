...

{
  ...
  if (iVar2 < iVar4 + iVar5) {
    ...
    eVar3 = crypto_aes_ccm_star_msg(msg,2,key,ccm_nonce,ad_len,(uint16_t)uVar1,auStack_30,tag_len);
    if ((eVar3 == 0) &&
       (iVar2 = zmsg_compare_bytes(msg,iVar4 + (uVar1 & 0xffff) & 0xffff,auStack_30,iVar5),
       iVar2 == 0)) {
      eVar3 = 0x13;
    }
  }
