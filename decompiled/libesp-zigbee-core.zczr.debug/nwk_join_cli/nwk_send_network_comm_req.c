...
bool nwk_send_network_comm_req(undefined2 *param_1,char param_2,int param_3,char param_4)

{
  ...
  if (iVar2 != 0) {
    ...
    nwk_frame_write_hdr(iVar2,uVar1,*param_1,1,param_3,0);
    ...
    *(char *)(iVar3 + 0x9d9) = acStack_21[0] + '\x01';
    ...
    acStack_21[0] = param_2;
    zmsg_append_bytes(iVar2,1,acStack_21);
    acStack_21[0] = param_4;
    zmsg_append_bytes(iVar2,1,acStack_21);
