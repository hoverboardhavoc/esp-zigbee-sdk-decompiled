...
/* WARNING: Variable defined which should be unmapped: src_extaddr */
    ...
    if ((iVar3 == 0) && (iVar3 = nwk_frame_get_dst_extaddr(msg,&rsp), iVar3 == 0)) {
      ...
      if ((_rsp == *piVar4) &&
        ...
        if (*(char *)(iVar3 + 0xac0) == '\0') {
          ...
          if (bStack_22 == 0) {
            nwk_mm_set_pib_attr(0xff,0x4a,(undefined1 *)((int)&dst_extaddr.field_0 + 4));
          }
          error = 0;
          if (bStack_22 != 0) {
            error = bStack_22 | 0x200;
          }
          nwk_do_attach_done(error,eStack_24);
        }
      }
    }
  }
