 ...
 * Source: libesp-zigbee-core.zczr.debug -> thermostat_ui_config_desc.o -> ezb_zcl_thermostat_ui_config_cluster_desc_add_attr
 *
...

{
  ...
  if (cluster_desc == (ezb_zcl_cluster_desc_t)0x0) {
    ...
    if (*cluster_desc == 0x204) {
      eVar1 = zcl_thermostat_ui_config_cluster_get_attr_properties
