 ...
 * Source: libesp-zigbee.release -> zdo_cmd_compat.o -> esp_zb_zdo_leave_rsp_wrapper
 *
...

{
  ...
  void *pvVar2;
  undefined4 uVar3;
  ezb_zdp_nwk_mgmt_leave_rsp_field_t *peVar4;
  code *pcVar5;
  ...
  if (pcVar5 != (code *)0x0) {
    if (result->error == 0) {
      peVar4 = result->rsp;
      pvVar2 = user_ctx;
      if (peVar4 == (ezb_zdp_nwk_mgmt_leave_rsp_field_t *)0x0) {
