 ...
 * Source: libesp-zigbee.release -> zdo_cmd_compat.o -> esp_zb_zdo_simple_desc_req
 *
...

{
  ...
  if ((cmd_req != (esp_zb_zdo_simple_desc_req_param_t *)0x0) &&
     ...
     req.cb != (ezb_zdo_simple_desc_req_callback_t)0x0)) {
    uVar2 = cmd_req->addr_of_interest;
    uVar1 = cmd_req->endpoint;
    *(esp_zb_zdo_simple_desc_callback_t *)req.cb = user_cb;
    local_20 = CONCAT22(uVar2,uVar2);
