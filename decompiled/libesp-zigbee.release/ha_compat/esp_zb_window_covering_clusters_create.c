 ...
 * Source: libesp-zigbee.release -> ha_compat.o -> esp_zb_window_covering_clusters_create
 *
...

{
  ...
  undefined4 uVar2;
  esp_zb_window_covering_cluster_cfg_t *peVar3;
  ...
  uVar2 = esp_zb_window_covering_cluster_create(peVar3);
  esp_zb_cluster_list_add_window_covering_cluster(peVar1,uVar2,1);
  return peVar1;
}
