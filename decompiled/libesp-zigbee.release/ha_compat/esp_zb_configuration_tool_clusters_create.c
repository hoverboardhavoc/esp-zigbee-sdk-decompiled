 ...
 * Source: libesp-zigbee.release -> ha_compat.o -> esp_zb_configuration_tool_clusters_create
 *
...

{
  ...
  peVar3 = &configuration_tool->identify_cfg;
  ...
  uVar2 = esp_zb_basic_cluster_create(configuration_tool);
