 ...
 * Source: libesp-zigbee.release -> ha_compat.o -> esp_zb_on_off_light_clusters_create
 *
...

{
  ...
  undefined4 uVar2;
  esp_zb_on_off_cluster_cfg_t *peVar3;
  esp_zb_scenes_cluster_cfg_t *peVar4;
  esp_zb_groups_cluster_cfg_t *peVar5;
  esp_zb_identify_cluster_cfg_t *peVar6;
  
  if (light_cfg == (esp_zb_on_off_light_cfg_t *)0x0) {
    peVar4 = (esp_zb_scenes_cluster_cfg_t *)0x0;
    peVar5 = (esp_zb_groups_cluster_cfg_t *)0x0;
    peVar6 = (esp_zb_identify_cluster_cfg_t *)0x0;
    peVar3 = (esp_zb_on_off_cluster_cfg_t *)0x0;
  }
  else {
    peVar6 = &light_cfg->identify_cfg;
    peVar5 = &light_cfg->groups_cfg;
    peVar4 = &light_cfg->scenes_cfg;
    peVar3 = &light_cfg->on_off_cfg;
  }
  ...
  uVar2 = esp_zb_on_off_cluster_create(peVar3);
