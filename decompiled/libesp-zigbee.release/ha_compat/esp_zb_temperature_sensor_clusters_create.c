 ...
 * Source: libesp-zigbee.release -> ha_compat.o -> esp_zb_temperature_sensor_clusters_create
 *
...

{
  ...
  undefined4 uVar2;
  esp_zb_temperature_meas_cluster_cfg_t *peVar3;
  ...
  if (temperature_sensor == (esp_zb_temperature_sensor_cfg_t *)0x0) {
    ...
    peVar3 = (esp_zb_temperature_meas_cluster_cfg_t *)0x0;
  }
  else {
    peVar4 = &temperature_sensor->identify_cfg;
    peVar3 = &temperature_sensor->temp_meas_cfg;
  }
  peVar1 = (esp_zb_cluster_list_t *)esp_zb_zcl_cluster_list_create();
  uVar2 = esp_zb_basic_cluster_create(temperature_sensor);
  ...
  uVar2 = esp_zb_temperature_meas_cluster_create(peVar3);
  esp_zb_cluster_list_add_temperature_meas_cluster(peVar1,uVar2,1);
