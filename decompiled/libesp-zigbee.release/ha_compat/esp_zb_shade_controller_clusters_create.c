 ...
 * Source: libesp-zigbee.release -> ha_compat.o -> esp_zb_shade_controller_clusters_create
 *
...

{
  ...
  peVar3 = &shade_controller_cfg->identify_cfg;
  ...
  uVar2 = esp_zb_basic_cluster_create(shade_controller_cfg);
