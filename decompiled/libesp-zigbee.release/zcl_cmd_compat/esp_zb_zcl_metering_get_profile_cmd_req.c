...

{
  ...
  if (cmd_req != (esp_zb_metering_get_profile_cmd_t *)0x0) {
    ...
    ;
    req.cmd_ctrl.cnf_ctx.user_ctx._0_1_ = cmd_req->interval_channel;
    req.payload._0_4_ = cmd_req->end_time;
    req.payload.end_time._0_1_ = cmd_req->number_of_periods;
    iVar2 = ezb_zcl_metering_get_profile_cmd_req(auStack_34);
    if (iVar2 == 0) {
