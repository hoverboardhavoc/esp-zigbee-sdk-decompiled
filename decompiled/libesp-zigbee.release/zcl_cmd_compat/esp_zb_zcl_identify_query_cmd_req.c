 ...
 * Source: libesp-zigbee.release -> zcl_cmd_compat.o -> esp_zb_zcl_identify_query_cmd_req
 *
...

{
  ...
  ezb_zcl_identify_query_cmd_t req;
  
  memset(auStack_28,0,0x18);
  if (cmd_req != (esp_zb_zcl_identify_query_cmd_t *)0x0) {
    convert_to_ezb_specific_cmd_ctrl
              ((ezb_zcl_cluster_cmd_ctrl_t *)auStack_28,(esp_zb_zcl_specific_cmd_header_t *)cmd_req)
    ;
    iVar2 = ezb_zcl_identify_identify_query_cmd_req(auStack_28);
    if (iVar2 == 0) {
