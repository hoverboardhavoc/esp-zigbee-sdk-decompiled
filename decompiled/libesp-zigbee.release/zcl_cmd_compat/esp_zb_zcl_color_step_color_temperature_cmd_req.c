 ...
 * Source: libesp-zigbee.release -> zcl_cmd_compat.o -> esp_zb_zcl_color_step_color_temperature_cmd_req
 *
...

{
  ...
  if (cmd_req != (esp_zb_zcl_color_step_color_temperature_cmd_t *)0x0) {
    ...
    req.payload._0_2_ = cmd_req->color_temperature_minimum;
    req.payload.step_size = cmd_req->color_temperature_maximum;
    iVar2 = ezb_zcl_color_control_step_color_temperature_cmd_req(auStack_34);
    if (iVar2 == 0) {
