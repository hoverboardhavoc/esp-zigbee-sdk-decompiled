...

{
  ...
  p_Var1 = cb;
  if (cb != (esp_zb_apsde_data_indication_callback_t)0x0) {
    p_Var1 = esp_zb_apsde_data_indication_handler;
  }
  ezb_apsde_data_indication_handler_register(p_Var1);
  s_esp_zb_data_ind_handler = cb;
  return;
}
