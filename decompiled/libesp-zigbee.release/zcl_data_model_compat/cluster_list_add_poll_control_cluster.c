 ...
 * Source: libesp-zigbee.release -> zcl_data_model_compat.o -> cluster_list_add_poll_control_cluster
 *
...
void cluster_list_add_poll_control_cluster(int param_1,int param_2,byte param_3)
