...
int ezb_zcl_ias_wd_start_warning_cmd_req(void *param_1)

{
  ...
  if (param_1 == (void *)0x0) {
    ...
    if (iVar1 == 0) {
      ...
      iVar1 = zcl_cmd_to_packet(auStack_38,1,0,0,*(undefined1 *)((int)param_1 + 0xc),0,0,0x502);
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 == 0) {
            ...
            iVar1 = zmsg_append_bytes(uStack_14,1,&uStack_3a);
            if (iVar1 == 0) {
              uStack_3a = CONCAT11(uStack_3a._1_1_,*(undefined1 *)((int)param_1 + 0x1d));
              iVar1 = zmsg_append_bytes(uStack_14,1,&uStack_3a);
              if (iVar1 == 0) {
