 ...
 * Source: libesp-zigbee-core.zczr.release -> touchlink_utility.o -> touchlink_get_next_disc_device
 *
...

{
  ...
  while( true ) {
    ...
    iVar2 = touchlink_transaction_get();
    if (device == (touchlink_disc_dev_info_t *)(iVar2 + uVar1 * 0xc0 + 0xc)) break;
    uVar1 = uVar1 + 1 & 0xff;
  }
  iVar2 = touchlink_transaction_get();
  ...
  iVar2 = touchlink_transaction_get();
  return (touchlink_disc_dev_info_t *)(iVar2 + uVar1 * 0xc0 + 0xcc);
}
