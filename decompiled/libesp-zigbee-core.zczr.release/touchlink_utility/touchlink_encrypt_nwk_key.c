...

{
  ...
  iVar1 = 0xff;
  if (((param_2 != 0) && (param_1 != 0)) && ((param_3 & *(ushort *)(iVar2 + 4)) != 0)) {
    ...
    if (iVar1 != 0xff) {
      ...
      crypto_aes_ecb_init(&uStack_40);
      crypto_aes_ecb_setkey_enc(&uStack_40,&puStack_48);
      crypto_aes_ecb_encrypt(&uStack_40,param_1,param_2);
      crypto_aes_ecb_free(&uStack_40);
    }
  }
  return iVar1;
}
