...

{
  ...
  iVar6 = *(int *)(iVar3 + 0xcbc);
  iVar3 = core_globals_get();
  iVar3 = *(int *)(iVar3 + 0xcc0);
  iVar4 = core_globals_get();
  if (((*(short *)(iVar4 + 0xcc4) != 0) && (iVar6 != 0)) && (iVar3 != 0)) {
    iVar3 = core_globals_get();
  ...
  iVar3 = core_globals_get();
  iVar4 = *(int *)(iVar3 + 0xccc);
  iVar3 = core_globals_get();
  if (((*(short *)(iVar3 + 0xcd0) != 0) && (iVar6 != 0)) && (iVar4 != 0)) {
    __assert_func(0,0,0,0);
  }
  iVar3 = core_globals_get();
  memset((void *)(iVar3 + 0xcc8),0,0xc);
  iVar3 = core_globals_get();
