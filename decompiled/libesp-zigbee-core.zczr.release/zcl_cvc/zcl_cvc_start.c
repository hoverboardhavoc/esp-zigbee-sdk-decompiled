...

{
  ...
  if ((arg != (void *)0x0) && (*(code **)((int)arg + 0x34) != (code *)0x0)) {
    uVar6 = *(uint *)((int)arg + 0x14);
    uVar4 = *(uint *)((int)arg + 0x10);
    if (uVar6 <= uVar4) {
      if (uVar6 != 0) {
        iVar3 = (int)*(char *)((int)arg + 1) * *(int *)((int)arg + 4) + *(int *)((int)arg + 0x30);
        *(int *)((int)arg + 0x30) = iVar3;
        uVar5 = *(int *)((int)arg + 0xc) + *(int *)((int)arg + 8);
        *(uint *)((int)arg + 0xc) = uVar5;
        if (uVar4 <= uVar5) {
          *(int *)((int)arg + 0x30) = *(char *)((int)arg + 1) + iVar3;
          *(uint *)((int)arg + 0xc) = uVar5 - uVar4;
        }
      }
      if (*(char *)((int)arg + 0x2c) == '\x01') {
        ...
        iVar3 = uVar6 + 1;
        iVar2 = (*(uint *)((int)arg + 0x18) / 100) * (uVar4 - uVar6);
      }
                    /* WARNING: Load size is inaccurate */
      *(int *)((int)arg + 0x14) = iVar3;
      (**(code **)((int)arg + 0x34))
