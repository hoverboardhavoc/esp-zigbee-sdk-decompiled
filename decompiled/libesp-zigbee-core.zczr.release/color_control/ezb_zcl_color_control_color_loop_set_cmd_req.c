...

{
  ...
  if ((cmd_req == (ezb_zcl_color_control_color_loop_set_cmd_t *)0x0) ||
    ...
    iVar1 = zcl_cmd_to_packet(auStack_38,0,0,(cmd_req->cmd_ctrl).dis_default_rsp,0,0x44,0x300);
    if (((((iVar1 == 0) &&
          (iVar1 = zmsg_append_u8((zmsg_t *)packet._32_4_,(cmd_req->payload).update_flags),
          iVar1 == 0)) &&
         (iVar1 = zmsg_append_u8((zmsg_t *)packet._32_4_,(cmd_req->payload).action), iVar1 == 0)) &&
        ((iVar1 = zmsg_append_u8((zmsg_t *)packet._32_4_,(cmd_req->payload).direction), iVar1 == 0
         && (iVar1 = zmsg_append_le16((zmsg_t *)packet._32_4_,(cmd_req->payload).time), iVar1 == 0))
        )) && ((iVar1 = zmsg_append_le16((zmsg_t *)packet._32_4_,(cmd_req->payload).start_hue),
               iVar1 == 0 &&
