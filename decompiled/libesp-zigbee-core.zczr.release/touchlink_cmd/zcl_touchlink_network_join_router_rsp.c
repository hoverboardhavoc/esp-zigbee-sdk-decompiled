 ...
 * Source: libesp-zigbee-core.zczr.release -> touchlink_cmd.o -> zcl_touchlink_network_join_router_rsp
 *
...
ezb_err_t zcl_touchlink_network_join_router_rsp(zcl_touchlink_join_router_rsp_t *cmd_rsp)

{
  ...
  if ((cmd_rsp == (zcl_touchlink_join_router_rsp_t *)0x0) ||
    ...
    eVar3 = zcl_touchlink_cmd_to_packet
                      ((zcl_packet_t *)auStack_38,'\x01','\x13',(ezb_address_t *)cmd_rsp);
    eVar1 = 2;
    if (eVar3 == 0) {
