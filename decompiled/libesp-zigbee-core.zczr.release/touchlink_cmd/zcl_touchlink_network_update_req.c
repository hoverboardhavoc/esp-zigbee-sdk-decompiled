...
ezb_err_t zcl_touchlink_network_update_req(zcl_touchlink_network_update_req_t *cmd_req)

{
  ...
  if ((cmd_req == (zcl_touchlink_network_update_req_t *)0x0) ||
    ...
    eVar3 = zcl_touchlink_cmd_to_packet
                      ((zcl_packet_t *)auStack_38,'\0','\x16',(ezb_address_t *)cmd_req);
    eVar1 = 2;
    if ((((eVar3 == 0) &&
       ...
       (((eVar1 = zmsg_append_u8((zmsg_t *)packet._32_4_,cmd_req->network_update_id), eVar1 == 0 &&
