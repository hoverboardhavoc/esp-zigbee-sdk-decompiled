...

{
  ...
  iStack_18 = 0;
  cie_ieee_addr.field_0.u64._0_4_ = 0;
  pzVar2 = ias_zone_srv_get_attr_desc(ep_id,0x10);
  if (pzVar2 == (zcl_attr_desc_t *)0x0) {
    pzVar2 = (zcl_attr_desc_t *)__assert_func(0,0,0);
  }
                    /* WARNING: Load size is inaccurate */
  iVar4 = *pzVar2->data_p;
  iVar1 = *(int *)((int)pzVar2->data_p + 4);
  iVar3 = nwk_address_extended_by_short(CONCAT22(in_register_0000202e,short_addr),&iStack_18);
  return iVar3 == 0 && (iStack_18 == iVar4 && cie_ieee_addr.field_0.u64._0_4_ == iVar1);
}
