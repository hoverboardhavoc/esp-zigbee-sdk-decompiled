...

{
  ...
  if (__s == (aps_device_key_pair_t *)0x0) {
    ...
    if ((CONCAT22(extraout_var,uVar5) < (uint)blk_nr) &&
       (__s = (aps_device_key_pair_t *)(iVar7 + CONCAT22(extraout_var,uVar5) * 0x38),
       __s != (aps_device_key_pair_t *)0x0)) {
      memset(__s,0,0x38);
      puVar1 = (undefined4 *)((int)&src_addr->field_0 + 4);
      uVar2 = *(undefined2 *)puVar1;
      uVar3 = *(undefined4 *)&src_addr->field_0;
      uVar4 = *puVar1;
      (__s->device_address).field_0.u8[0] = (uint8_t)*(undefined2 *)&src_addr->field_0;
      (__s->device_address).field_0.u8[1] = (uint8_t)((uint)uVar3 >> 8);
      (__s->device_address).field_0.u8[3] = (uint8_t)((uint)uVar3 >> 0x18);
      (__s->device_address).field_0.u8[5] = (uint8_t)((uint)uVar4 >> 8);
      (__s->device_address).field_0.u8[2] = (uint8_t)((uint)uVar3 >> 0x10);
      (__s->device_address).field_0.u8[4] = (uint8_t)uVar2;
