...

{
  ...
  zmsg_read_bytes(param_2,0,1,&bStack_52);
  bVar3 = bStack_52;
  uVar5 = aps_fcf_get_hdr_size(bStack_52);
  if ((char)bVar3 < '\0') {
    iVar6 = zmsg_read_bytes(param_2,uVar5,1,abStack_30);
    uVar5 = ((abStack_30[0] & 3) - 1 < 2) + uVar5 + iVar6 & 0xffff;
  }
  iVar6 = 0;
  if ((bStack_52 & 0x20) != 0) {
    if ((iVar4 != 0) && (aiStack_64[0] != 0)) {
      zmsg_read_bytes(param_2,uVar5,0xe,&uStack_40);
      iVar6 = aiStack_64[0];
      ...
      *(int *)(iVar6 + 8) = iVar8 + 1;
      ...
      zmsg_write_bytes(param_2,uVar5,iVar6,&uStack_40);
      if ((uStack_3c << 0x18 | uStack_40 >> 8) != 0xffffffff) {
        ...
        if (iVar8 != 0) {
          ...
          iVar6 = secur_secure_msg(iVar4,abStack_30,&uStack_50,param_2,iVar6 + uVar5 & 0xffff);
          if (iVar6 == 0) {
            *(ushort *)(param_2 + 0x16) = *(ushort *)(param_2 + 0x16) | 4;
            ...
            zmsg_write_bytes(param_2,uVar5,1,&bStack_51);
          }
          goto _L0;
        }
      }
