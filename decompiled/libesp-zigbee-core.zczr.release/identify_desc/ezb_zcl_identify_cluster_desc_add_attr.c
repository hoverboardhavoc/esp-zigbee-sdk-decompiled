 ...
 * Source: libesp-zigbee-core.zczr.release -> identify_desc.o -> ezb_zcl_identify_cluster_desc_add_attr
 *
...
ezb_err_t ezb_zcl_identify_cluster_desc_add_attr
  ...
  if (cluster_desc == (ezb_zcl_cluster_desc_t)0x0) {
    ...
    if (*cluster_desc == 3) {
      ...
      if (uVar5 == uVar2) {
        ...
        eVar4 = ezb_zcl_cluster_desc_add_manuf_attr(uVar3,0);
        return eVar4;
      }
    }
  }
