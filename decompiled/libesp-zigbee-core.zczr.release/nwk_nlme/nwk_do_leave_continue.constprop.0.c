 ...
 * Source: libesp-zigbee-core.zczr.release -> nwk_nlme.o -> nwk_do_leave_continue.constprop.0
 *
...
void nwk_do_leave_continue_constprop_0(uint param_1,uint param_2)
...
_L0:
    ...
    *(undefined1 *)(iVar2 + 0xac0) = 0;
    ...
    if (*(char *)(iVar2 + 0xac8) == '\0') {
      ...
      bStack_24 = (byte)param_1 | (byte)(uVar1 << 1);
    ...
    if ((byte)(*(char *)(iVar2 + 0xac8) - 1U) < 2) {
      uStack_30 = 0;
      uStack_2c = 0;
      iStack_28 = (uint)(byte)((byte)param_1 | (byte)(uVar1 << 1)) << 0x10;
