...
void zcl_packet_append_variable_attr_value
...

{
  ...
  uStack_28 = 0;
  uStack_24 = 0;
  iVar1 = zcl_attr_type_is_composite(param_2);
  if (iVar1 == 0) {
    uVar2 = zcl_get_attr_value_size(param_2,0);
    if (0x10 < uVar2) {
    ...
    uVar2 = zcl_get_attr_value_size(param_2,param_3);
    puVar3 = (undefined4 *)param_3;
  }
  zmsg_append_bytes(param_1,uVar2,puVar3);
  return;
}
