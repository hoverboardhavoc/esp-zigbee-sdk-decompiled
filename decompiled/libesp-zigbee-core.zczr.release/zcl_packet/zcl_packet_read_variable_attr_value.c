...

{
  ...
  __size = 0xffff;
  if ((((param_1 != 0) && (__size = 0xffff, param_2 != (undefined2 *)0x0)) && (param_4 != 0)) &&
     ((__size = zcl_packet_read_variable_attr_actual_size(*param_2), (__size - 1 & 0xffff) < 0xfffe
      && (pvVar1 = calloc(1,__size), pvVar1 != (void *)0x0)))) {
