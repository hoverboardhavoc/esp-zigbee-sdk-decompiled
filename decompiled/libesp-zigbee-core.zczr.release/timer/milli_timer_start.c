 ...
 * Source: libesp-zigbee-core.zczr.release -> timer.o -> milli_timer_start
 *
...
void milli_timer_start(milli_timer_t *tm,uint32_t delay_ms)

{
  ...
  if (0x7ffffffe < delay_ms) {
    tm_sched_remove(&s_tm_sched_milli,tm);
  }
  uVar2 = (*sched->get_now)(sched->get_now);
  uVar2 = delay_ms + uVar2;
