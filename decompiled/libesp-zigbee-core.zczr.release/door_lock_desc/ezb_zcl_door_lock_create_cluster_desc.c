 ...
 * Source: libesp-zigbee-core.zczr.release -> door_lock_desc.o -> ezb_zcl_door_lock_create_cluster_desc
 *
...
int ezb_zcl_door_lock_create_cluster_desc(void *param_1,uint param_2)
  ...
  if (iVar1 != 0) {
    ...
    *(undefined **)(iVar1 + 8) = puVar2;
    ...
    if ((param_2 & 1) != 0) {
      ...
      ezb_zcl_door_lock_cluster_desc_add_attr(iVar1,1,(int)&uStack_14 + 1);
