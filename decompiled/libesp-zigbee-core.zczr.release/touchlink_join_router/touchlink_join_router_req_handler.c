...

{
  ...
  if (req == (touchlink_join_router_req_t *)0x0) {
    req = (touchlink_join_router_req_t *)__assert_func(0,0,0);
  }
  ...
  if ((uVar6 == 0) || (uVar10 = touchlink_transaction_id(0), uVar6 != uVar10)) {
    ...
    *(undefined4 *)(iVar8 + 0x610) = 2;
    ...
    if (uVar13 == 0) {
      ...
      *(ezb_shortaddr_t *)(iVar8 + 0x61e) = req->new_nwk_addr;
  ...
  eVar9 = zcl_touchlink_network_join_router_rsp(auStack_3c);
  return eVar9;
}
