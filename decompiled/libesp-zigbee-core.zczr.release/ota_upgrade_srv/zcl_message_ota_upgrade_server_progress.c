...
{
  ota_upgrade_upgrade_end_req_payload_t *upgrade_end;
  uint uVar1;
  ...
  uVar1 = zcl_packet_to_message(auStack_4c,packet);
  if (uVar1 != 0) goto _L0;
  ...
  if (peVar2 == (ezb_zcl_cmd_hdr_t *)0x5) {
    ...
    message.in.progress._0_1_ = *info;
    message.in.progress._2_2_ = *(undefined2 *)((int)info + 2);
    ...
    if (peVar2 == (ezb_zcl_cmd_hdr_t *)0x0) {
      ...
      if (info == (void *)0x0) goto _L0;
      message.in.progress._0_2_ = *(undefined2 *)((int)info + 2);
      message.in.progress._2_2_ = *(undefined2 *)((int)info + 4);
...
_L0:
  ...
  zcl_core_action_schedule(0x3c,auStack_4c);
  uVar1 = (uint)(byte)message.in.field_2.start.policy.file_version._0_1_;
  if (uVar1 == 0xfe) {
    uVar1 = 0;
  }
