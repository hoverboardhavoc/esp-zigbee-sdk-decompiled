...
ezb_zcl_status_t
illuminance_measurement_cluster_srv_check_value_handler
...

{
  ...
  if (uVar1 == 0xffff) {
    ...
    if (uVar5 == 3) {
      ...
      pzVar4 = simple_measurement_srv_get_attr_desc(endpoint,0x400,1);
...
_L0:
        ...
        if (uVar5 == 2) goto _L0;
_L0:
        pzVar4 = simple_measurement_srv_get_attr_desc(endpoint,0x400,2);
