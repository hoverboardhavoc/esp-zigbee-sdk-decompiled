...
bool rel_humidity_measurement_cluster_srv_check_value_handler
...

{
  ...
  if (uVar1 == 0xffff) {
    ...
    if (param_1 == 3) {
      ...
      iVar4 = simple_measurement_srv_get_attr_desc(param_2,0x405,1);
      if (iVar4 != 0) goto _L0;
      do {
        do {
...
_L0:
        iVar4 = simple_measurement_srv_get_attr_desc(param_2,0x405,2);
