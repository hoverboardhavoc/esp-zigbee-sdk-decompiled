...
bool pm2_5_measurement_cluster_srv_check_value_handler
...

{
  ...
  iVar2 = simple_measurement_srv_get_attr_desc(param_2,0x42a,1);
  if (iVar2 != 0) goto _L0;
  while( true ) {
    do {
...
_L0:
    if (1 < param_1) break;
    iVar2 = simple_measurement_srv_get_attr_desc(param_2,0x42a,2);
