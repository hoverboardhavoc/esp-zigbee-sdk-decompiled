...
int ezb_zcl_poll_control_set_long_poll_interval_cmd_req(void *param_1)
...
_L0:
    ...
    iVar1 = zcl_cmd_to_packet(auStack_38,0,0,*(undefined1 *)((int)param_1 + 0xc),0,2,0x20);
    if (iVar1 == 0) {
      uStack_3c = *(undefined4 *)((int)param_1 + 0x18);
