...

{
  ...
  iVar2 = zdo_packet_init(auStack_28,1,*param_1,*(undefined4 *)(param_1 + 4),
  ...
  if (iStack_14 == 0) {
    __assert_func(0,0,0);
_L0:
    iVar1 = zmsg_append_u8(iStack_14,*(undefined1 *)(param_1 + 2));
    if ((iVar1 == 0) &&
       (iVar1 = zmsg_append_u8(iStack_14,*(undefined1 *)((int)param_1 + 5)), iVar1 == 0)) {
