...
/* WARNING: Removing unreachable block (ram,0x00010bde) */
/* WARNING: Removing unreachable block (ram,0x00010bca) */
...

{
  ...
  if (CONCAT22(in_register_0000202a,shortaddr) < 0xfff8) {
    ref = search_short((nwk_addr_table_t *)(iVar1 + 0xcb0),shortaddr);
