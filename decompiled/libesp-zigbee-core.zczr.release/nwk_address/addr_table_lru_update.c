...
void addr_table_lru_update(int param_1,int param_2)

{
  ...
  iVar4 = *(int *)(param_1 + 4) + param_2 * 0x12;
  if ((*(short *)(iVar4 + 10) != -1) && (*(short *)(iVar4 + 0xc) != -1)) {
    addr_table_lru_remove();
    iVar4 = *(int *)(param_1 + 4);
    iVar5 = param_2 * 0x12 + iVar4;
    if ((*(short *)(iVar5 + 10) == -1) || (*(short *)(iVar5 + 0xc) == -1)) {
      uVar2 = (undefined2)param_2;
      if ((uint)*(ushort *)(param_1 + 10) < (uint)*(ushort *)(param_1 + 8)) {
        uVar1 = *(ushort *)((uint)*(ushort *)(param_1 + 10) * 0x12 + iVar4 + 10);
        *(ushort *)(iVar5 + 10) = uVar1;
        iVar3 = (uint)uVar1 * 0x12 + iVar4;
        *(undefined2 *)(iVar5 + 0xc) = *(undefined2 *)(iVar3 + 0xc);
        if (uVar1 != 0xffff) {
          *(undefined2 *)(iVar3 + 0xc) = uVar2;
        }
        if (*(ushort *)(iVar5 + 0xc) != 0xffff) {
          *(undefined2 *)(iVar4 + (uint)*(ushort *)(iVar5 + 0xc) * 0x12 + 10) = uVar2;
        }
      }
      else {
