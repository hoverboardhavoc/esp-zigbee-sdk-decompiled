 ...
 * Source: libesp-zigbee-core.zczr.release -> nwk_neighbor.o -> nwk_neighbor_table_set_ed_capacity
 *
...

{
  ...
  eVar3 = 2;
  if (CONCAT22(in_register_0000202a,capacity) <= CONCAT22(extraout_var,uVar1)) {
