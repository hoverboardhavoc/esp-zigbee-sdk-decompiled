 ...
 * Source: libesp-zigbee-core.zczr.release -> zcl_reporting.o -> zcl_reporting_sync_attr_change
 *
  ...
  if (info != (zcl_reporting_info_t *)0x0) {
    ...
    if (iVar1 != 0) {
      ...
      if (iVar2 == 0) {
        ...
        zcl_read_attr_value((undefined1 *)((int)&info->u + 0x10));
      }
      info->field_0x9 =
           info->field_0x9 & 0xf | (byte)((uint)*(undefined4 *)&info->cluster_role >> 8) & 0xe0;
    }
    return;
  }
  return;
