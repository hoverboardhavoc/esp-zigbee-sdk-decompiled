...
_L0:
  ...
  if (bVar21 == 4) {
    ...
    if ((*(int *)(param_1 + 0x24) != 0) && (iStack_34 != 0)) {
      ...
      uStack_e4 = param_1;
      uVar5 = zmsg_get_length(*(undefined4 *)(param_1 + 0x24));
      if ((uVar5 == 1) || ((2 < uVar5 && (uVar5 % 3 == 0)))) goto _L0;
      goto _L0;
    }
    goto _L166;
  }
...
_L0:
    ...
    if (bVar21 == 7) {
      ...
      if ((*(int *)(param_1 + 0x24) != 0) && (iStack_34 != 0)) {
        ...
        uStack_d0 = param_1;
        uVar5 = zmsg_get_length(*(undefined4 *)(param_1 + 0x24));
        if ((uVar5 == 1) || ((3 < uVar5 && ((uVar5 & 3) == 0)))) goto _L0;
        goto _L0;
      }
      goto _L166;
    }
    if (bVar21 == 8) {
      ...
      if ((iVar4 != 0) && (iStack_34 != 0)) {
        ...
        if (puVar14 == (undefined1 *)0x0) goto _L0;
        puVar15 = (undefined2 *)
                  af_endpoint_get_cluster_desc
                            (*(undefined2 *)(param_1 + 0x16),
                             ((*(byte *)(param_1 + 0x1a) & 8) != 0) + '\x01');
  ...
  if (iVar4 == 0) {
    ...
    while ((local_70 & 0xffff) < uVar5) {
      ...
      *(char **)(pcVar13 + 0x18) = pcStack_b8;
      ...
      if (uVar5 < (local_70 & 0xffff)) goto _L271;
      if (*pcVar13 == '\0') {
        if (pcVar13[1] == '\0') {
          af_read_le8_isra_0();
...
_L0:
  if (local_88[0] < uVar5) {
    local_70 = 0xffffff00;
    uStack_6c = 0;
    af_read_le8_isra_0(*(undefined4 *)(param_1 + 0x24),local_88,&local_70);
    if (uVar5 != 1) goto _L0;
    if ((char)local_70 == '\0') goto _L0;
_L0:
    uVar5 = 0x80;
  }
  else {
...
_L0:
  while (puStack_cc != (uint *)0x0) {
    puVar3 = (uint *)puStack_cc[1];
    mm_free(puStack_cc);
    puStack_cc = puVar3;
  }
  goto _L0;
_L0:
  af_read_le8_isra_0(*(undefined4 *)(param_1 + 0x24),local_88,(int)&local_70 + 1);
  af_read_le16_isra_0(*(undefined4 *)(param_1 + 0x24),local_88,(int)&local_70 + 2);
  if ((char)local_70 != '\0') {
_L0:
    puVar3 = (uint *)calloc(1,8);
    if (puVar3 == (uint *)0x0) {
      uVar5 = 0x89;
      goto _L0;
    }
    puVar3[1] = (uint)puStack_cc;
    *puVar3 = local_70;
    puStack_cc = puVar3;
  }
  goto _L0;
  ...
  if (local_88[0] < uVar5) {
    ...
    if ((local_70 & 0xff) == 0) {
      if ((iVar9 == 0) || (*(int *)(iVar9 + 8) == 0)) {
        ...
        uVar7 = *(byte *)(iVar9 + 2) - 0x48;
        if ((9 < (uVar7 & 0xff)) || (iVar12 = 0x8c, (0x317U >> (uVar7 & 0x1f) & 1) == 0)) {
          if ((*(byte *)(iVar9 + 3) & 4) == 0) goto _L355;
          iVar12 = 0x8d;
...
_L0:
      zmsg_append_u8(iStack_34,iVar12);
...
_L0:
  ...
  iVar4 = zmsg_get_length(iStack_34);
  uVar5 = 0;
  if (iVar4 == 0) {
    zmsg_append_u8(iStack_34,0);
  }
_L0:
  if (uStack_64 != (void *)0x0) {
    mm_free();
...
_L0:
    ...
    if (iVar9 != 0) goto _L0;
    iVar12 = zcl_reporting_info_find
    ...
    if (iVar9 == 0) {
      if ((uStack_110 & 0xff) == 0) {
        ...
        zmsg_append_le16(iStack_34,*(undefined2 *)(iVar12 + 0x10));
        zmsg_append_le16(iStack_34,*(undefined2 *)(iVar12 + 0x12));
        iVar9 = zcl_attr_type_is_analog(*(undefined1 *)(puVar16 + 1));
        if (iVar9 != 0) {
          zcl_packet_append_variable_attr_value
                    (iStack_34,*(undefined1 *)(puVar16 + 1),iVar12 + 0x18);
        }
      }
      else {
...
_L0:
  ...
  sVar11 = zcl_packet_read_variable_attr_size
                     (*(undefined4 *)(param_1 + 0x24),local_70 & 0xffff,local_108 >> 0x10 & 0xff);
  pvStack_104 = calloc(1,sVar11);
  zcl_packet_read_variable_attr_value(iVar4,&local_70,local_108 >> 0x10 & 0xff,pvStack_104);
  iVar12 = zcl_cluster_get_attr_desc(iVar9,local_108 & 0xffff,uVar24);
  if (iVar12 == 0) {
_L0:
    iVar17 = 0x86;
_L0:
    zmsg_append_u8(iStack_34,iVar17);
    zmsg_append_le16(iStack_34,local_108 & 0xffff);
  }
  else {
    iVar17 = 0x8d;
    if (local_108._2_1_ != *(char *)(iVar12 + 2)) goto _L0;
    bVar21 = *(byte *)(iVar12 + 3);
    if ((bVar21 == 1) || ((bVar21 & 2) == 0)) {
      iVar17 = 0x88;
      goto _L0;
    }
    if ((bVar21 & 0x40) != 0) goto _L0;
    uVar18 = 1;
    if ((*(byte *)(param_1 + 0x1a) & 8) != 0) {
      uVar18 = 2;
    }
    iVar17 = zcl_set_attr_value(*(undefined1 *)(param_1 + 0x15),*(undefined2 *)(param_1 + 0x16),
                                uVar18,local_108 & 0xffff,uVar24,pvStack_104,0);
    if (iVar17 != 0) goto _L0;
    if ((*(short *)(param_1 + 0x16) == 0x500) && ((*(byte *)(param_1 + 0x1a) & 8) == 0)) {
      ias_zone_cluster_srv_set_attr_val_post_proc(param_1,local_108 & 0xffff,pvStack_104);
    }
    uVar18 = 1;
    if ((*(byte *)(param_1 + 0x1a) & 8) != 0) {
      uVar18 = 2;
    ...
    zcl_message_notify_attr_value
              (*(undefined1 *)(param_1 + 0x15),*(undefined2 *)(param_1 + 0x16),uVar18,iVar12);
  }
  mm_free(pvStack_104);
  goto _L0;
_L0:
  uVar5 = 0x80;
  if (uVar7 == (local_70 & 0xffff)) {
    iVar4 = zmsg_get_length(iStack_34,0x80);
    if (iVar4 == 0) {
      zmsg_append_u8(iStack_34,0);
    }
    uVar18 = 4;
...
_L0:
  while (puStack_e0 != (uint *)0x0) {
    puVar3 = (uint *)puStack_e0[1];
    mm_free(puStack_e0);
    puStack_e0 = puVar3;
  }
_L0:
