...
int zcl_write_attr_cmd_req(void *param_1)
  ...
  if ((((param_1 == (void *)0x0) || (*(char *)((int)param_1 + 0x1c) == '\0')) ||
    ...
    if (iVar2 == 0) {
      while ((iVar2 < (int)(uint)*(byte *)((int)param_1 + 0x1c) &&
             (*(int *)((int)param_1 + 0x20) != 0))) {
        iVar4 = iVar2 * 0xc;
        iVar1 = zmsg_append_le16(uStack_24,*(undefined2 *)(*(int *)((int)param_1 + 0x20) + iVar4));
        if ((iVar1 != 0) ||
           ((iVar1 = zmsg_append_u8(uStack_24,
                                    *(undefined1 *)(*(int *)((int)param_1 + 0x20) + iVar4 + 4)),
            iVar1 != 0 ||
            (iVar4 = *(int *)((int)param_1 + 0x20) + iVar4,
            iVar1 = zcl_packet_append_variable_attr_value
                              (uStack_24,*(undefined1 *)(iVar4 + 4),*(undefined4 *)(iVar4 + 8)),
            iVar1 != 0)))) goto _L0;
        iVar2 = iVar2 + 1;
      }
