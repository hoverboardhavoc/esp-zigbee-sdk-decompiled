 ...
 * Source: libesp-zigbee-core.zczr.release -> alarms.o -> alarm_table_pop_oldest
 *
...

{
  ...
  if ((paVar2 != (alarms_alarm_table_t *)0x0) &&
    ...
    paVar3 = (alarms_alarm_table_entry_t *)paVar2->tail;
    (paVar1->node).next = (list_node_s *)paVar1;
    if (paVar3 == paVar1) {
      paVar2->tail = (list_node_t *)0x0;
    }
    paVar2->count = paVar2->count + 0xff;
    alarm_table_remove_stored_entry(ep_id,paVar1->alarm_code,paVar1->cluster_id,paVar1->time_stamp);
  }
  return paVar1;
}
