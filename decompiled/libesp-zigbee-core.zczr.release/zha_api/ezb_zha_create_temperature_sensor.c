 ...
 * Source: libesp-zigbee-core.zczr.release -> zha_api.o -> ezb_zha_create_temperature_sensor
 *
...

{
  ...
  undefined4 uVar2;
  ezb_zcl_temperature_measurement_cluster_server_config_t *peVar3;
  ...
  if (cfg == (ezb_zha_temperature_sensor_config_t *)0x0) {
    ...
    peVar3 = (ezb_zcl_temperature_measurement_cluster_server_config_t *)0x0;
  }
  else {
    peVar4 = &cfg->identify_cfg;
    peVar3 = &cfg->temp_meas_cfg;
  }
  ...
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
  uVar2 = ezb_zcl_temperature_measurement_create_cluster_desc(peVar3,1);
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
