 ...
 * Source: libesp-zigbee-core.zczr.release -> zha_api.o -> ezb_zha_create_window_covering_controller
 *
...
ezb_af_ep_desc_t
ezb_zha_create_window_covering_controller
          (uint8_t ep_id,ezb_zha_window_covering_controller_config_t *cfg)

{
  ...
  if (cfg == (ezb_zha_window_covering_controller_config_t *)0x0) {
  ...
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
  uVar2 = ezb_zcl_window_covering_create_cluster_desc(0,2);
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
