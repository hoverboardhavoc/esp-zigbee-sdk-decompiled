 ...
 * Source: libesp-zigbee-core.zczr.release -> zha_api.o -> ezb_zha_create_color_dimmable_light
 *
...

{
  ...
  undefined4 uVar2;
  ezb_zcl_color_control_cluster_server_config_t *peVar3;
  ...
  if (cfg == (ezb_zha_color_dimmable_light_config_t *)0x0) {
    ...
    peVar3 = (ezb_zcl_color_control_cluster_server_config_t *)0x0;
  }
  else {
  ...
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
  uVar2 = ezb_zcl_groups_create_cluster_desc(peVar7,1);
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
  uVar2 = ezb_zcl_scenes_create_cluster_desc(peVar6,1);
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
  uVar2 = ezb_zcl_on_off_create_cluster_desc(peVar5,1);
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
  uVar2 = ezb_zcl_level_create_cluster_desc(peVar4,1);
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
  uVar2 = ezb_zcl_color_control_create_cluster_desc(peVar3,1);
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
  return pvVar1;
}
