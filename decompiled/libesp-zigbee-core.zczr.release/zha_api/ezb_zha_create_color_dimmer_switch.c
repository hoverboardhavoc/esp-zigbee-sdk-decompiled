 ...
 * Source: libesp-zigbee-core.zczr.release -> zha_api.o -> ezb_zha_create_color_dimmer_switch
 *
...
ezb_af_ep_desc_t
ezb_zha_create_color_dimmer_switch(uint8_t ep_id,ezb_zha_color_dimmer_switch_config_t *cfg)

{
  ...
  if (cfg == (ezb_zha_color_dimmer_switch_config_t *)0x0) {
  ...
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
  uVar2 = ezb_zcl_color_control_create_cluster_desc(0,2);
  ezb_af_endpoint_add_cluster_desc(pvVar1,uVar2);
