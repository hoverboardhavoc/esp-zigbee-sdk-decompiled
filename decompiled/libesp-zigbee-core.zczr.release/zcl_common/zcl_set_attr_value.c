  ...
  if (iVar2 == 0) {
    ...
    if (value != (void *)0x0) {
      if (CONCAT31(in_register_00002041,check_access) != 0) {
        iVar3 = 0x88;
        if (((*(byte *)(iVar2 + 3) & 2) == 0) || (iVar3 = 0x8c, (*(byte *)(iVar2 + 3) & 0x40) != 0))
        goto _L0;
      }
      iVar4 = zcl_cluster_template_find
                        (CONCAT22(in_register_0000202e,cluster_id),
                         CONCAT31(in_register_00002031,cluster_role));
      if (iVar4 != 0) {
        if ((*(code **)(iVar4 + 4) != (code *)0x0) &&
           (iVar3 = (**(code **)(iVar4 + 4))(uVar5,uVar1,value), iVar3 != 0)) goto _L0;
        if (*(code **)(iVar4 + 8) != (code *)0x0) {
          (**(code **)(iVar4 + 8))(uVar1,uVar5,value,CONCAT22(in_register_0000203a,manuf_code));
        }
      }
