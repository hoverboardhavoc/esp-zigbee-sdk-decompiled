 ...
 * Source: libesp-zigbee-core.zczr.release -> multistate_input_desc.o -> ezb_zcl_multistate_input_create_cluster_desc
 *
...
int ezb_zcl_multistate_input_create_cluster_desc(void *param_1,uint param_2)
  ...
  if (iVar1 != 0) {
    ...
    *(undefined **)(iVar1 + 8) = puVar2;
    ...
    if ((param_2 & 1) != 0) {
      ...
      ezb_zcl_multistate_input_cluster_desc_add_attr(iVar1,0x51,auStack_16);
      ezb_zcl_multistate_input_cluster_desc_add_attr(iVar1,0x55,&uStack_14);
      ezb_zcl_multistate_input_cluster_desc_add_attr(iVar1,0x6f,auStack_12);
    }
  }
  return iVar1;
}
