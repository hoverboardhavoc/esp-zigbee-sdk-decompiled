...

{
  ...
  if ((__size != 0xffff) &&
     (pzVar1 = (zcl_attr_desc_t *)calloc(1,0x10), pzVar1 != (zcl_attr_desc_t *)0x0)) {
    pzVar1->id = id;
    pvVar2 = (void *)0x0;
    if (__size != 0) {
    ...
    if ((__size == 0) || (pvVar2 != (void *)0x0)) {
      zcl_write_attr_value(data_p,CONCAT31(in_register_0000202d,type));
      return pzVar1;
    }
    mm_free(pzVar1);
  }
  return (zcl_attr_desc_t *)0x0;
}
