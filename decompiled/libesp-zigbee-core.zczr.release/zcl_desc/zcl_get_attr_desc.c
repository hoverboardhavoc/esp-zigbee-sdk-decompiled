...

{
  ...
  if (pzVar1 != (zcl_cluster_desc_t *)0x0) {
    while (pzVar1 = (zcl_cluster_desc_t *)pzVar1->attr_list, pzVar1 != (zcl_cluster_desc_t *)0x0) {
      if ((uint)pzVar1->cluster_id == CONCAT22(in_register_00002036,attr_id)) {
        if (CONCAT22(in_register_0000203a,manuf_code) == 0) {
          return (zcl_attr_desc_t *)pzVar1;
        }
        if (((pzVar1->field_0x3 & 0x20) != 0) &&
