...

{
  ...
  if (CONCAT31(in_register_00002029,iface_id) != 0xff) {
    ...
    UNRECOVERED_JUMPTABLE = *(code **)(*(int *)(*(int *)(iVar2 + iVar1 + 0xc84) + 4) + 4);
    iVar2 = core_globals_get();
    ...
    eVar3 = (*UNRECOVERED_JUMPTABLE)
                      (*(undefined4 *)(iVar2 + iVar1 + 0xc84),
                       CONCAT31(in_register_0000202d,set_default_pib),UNRECOVERED_JUMPTABLE);
    return eVar3;
  }
  ...
  if (iVar2 != 0) {
    iVar2 = core_globals_get();
    UNRECOVERED_JUMPTABLE = *(code **)(*(int *)(*(int *)(iVar2 + 0xc84) + 4) + 4);
    iVar2 = core_globals_get();
    iVar2 = (*UNRECOVERED_JUMPTABLE)
                      (*(undefined4 *)(iVar2 + 0xc84),CONCAT31(in_register_0000202d,set_default_pib)
                      );
    if (iVar2 != 0) {
      log_write(1,"nwk_multimac_proxy.c","%s on iface %d failed: %d","reset",0,iVar2);
      iVar1 = iVar2;
    }
  }
  return iVar1;
