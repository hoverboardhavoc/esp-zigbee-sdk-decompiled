...

{
  ...
  if (CONCAT31(in_register_00002029,iface_id) == 0xff) {
    ...
    UNRECOVERED_JUMPTABLE = *(code **)(*(int *)(*(int *)(iVar1 + 0xce8) + 4) + 8);
    iVar1 = core_globals_get();
    ...
    UNRECOVERED_JUMPTABLE = *(code **)(*(int *)(*(int *)(iVar2 + iVar1 + 0xce8) + 4) + 8);
    iVar2 = core_globals_get();
  ...
  eVar4 = (*UNRECOVERED_JUMPTABLE)
                    (uVar3,CONCAT31(in_register_0000202d,pib_attr),value,UNRECOVERED_JUMPTABLE);
  return eVar4;
}
