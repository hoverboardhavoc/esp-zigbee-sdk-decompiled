 ...
 * Source: libesp-zigbee-core.zczr.release -> nwk_ed_mngr.o -> nwk_pim_stop_fast_poll
 *
...

{
  ...
  if (((*(int *)(iVar3 + 0xb14) << 10 < 0) &&
      (iVar3 = core_globals_get(), (*(byte *)(iVar3 + 0xb16) & 0xf) != 0)) &&
     (iVar3 = core_globals_get(), (*(byte *)(iVar3 + 0xb16) & 0xf) != 0xf)) {
    iVar3 = core_globals_get();
    *(byte *)(iVar3 + 0xb16) =
         *(byte *)(iVar3 + 0xb16) & 0xf0 | (char)*(undefined2 *)(iVar3 + 0xb16) + 0xfU & 0xf;
    iVar3 = core_globals_get();
    if ((*(byte *)(iVar3 + 0xb16) & 0xf) == 0) {
      iVar3 = core_globals_get();
      *(undefined2 *)(iVar3 + 0xb14) = 0;
      iVar3 = core_globals_get();
