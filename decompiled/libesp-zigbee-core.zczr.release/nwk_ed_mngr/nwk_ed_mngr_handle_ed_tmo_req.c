...
_L0:
  ...
  if (((ushort)(iVar3 != 0) != (*(ushort *)(param_1 + 0x16) >> 1 & 1)) ||
     (*(short *)(param_2 + 2) != *(short *)(param_2 + 6))) goto _L0;
  uStack_28 = 0;
  iVar3 = core_globals_get();
  bStack_27 = *(byte *)(iVar3 + 0xa28);
  sVar1 = zmsg_get_offset(param_1);
  zmsg_read_bytes(param_1,sVar1 + 1,2,&bStack_24);
  if (0xe < bStack_24) {
    uStack_28 = 1;
    goto _L0;
  }
  ...
  if (*(ushort *)(iVar3 + 0x10) == (ushort)bStack_23) {
    iVar2 = 0;
  }
  else {
    *(ushort *)(iVar3 + 0x10) = (ushort)bStack_23;
  }
  if ((*(uint *)(iVar3 + 0x14) >> 0x14 & 0xf) == (uint)bStack_24) {
    if (iVar2 != 0) goto _L0;
  }
  else {
    *(uint *)(iVar3 + 0x14) = *(uint *)(iVar3 + 0x14) & 0xff0fffff | (bStack_24 & 0xf) << 0x14;
_L0:
