...

{
  ...
  iVar1 = nwk_mm_get_pib_attr(0,0x4f,params,1);
  if ((iVar1 == 0) && (iVar1 = nwk_mm_get_pib_attr(0x57,&params->max_be), iVar1 == 0)) {
    eVar2 = nwk_mm_get_pib_attr(0x4e,&params->max_backoffs,1);
    return eVar2;
  }
  return iVar1;
}
