 ...
 * Source: libesp-zigbee-core.zczr.release -> aps_bind.o -> aps_bind_table_remove
 *
...

{
  ...
  if (((src == (aps_bind_src_t *)0x0) || (dst == (aps_bind_dst_t *)0x0)) ||
     (_Var1 = bind_table_unbind(src,dst), CONCAT31(extraout_var,_Var1) == 0)) {
    eVar2 = 5;
  }
  else {
    eVar2 = 0;
