 ...
 * Source: libesp-zigbee-core.zczr.release -> ota_upgrade_cli.o -> ota_upgrade_downloading_context_get
 *
...

{
  ...
  attr_id = __assert_func(0,0,0,0);
  poVar1 = (ota_upgrade_downloading_context_t *)ota_upgrade_cli_get_attr_desc(ep_id_00,attr_id);
