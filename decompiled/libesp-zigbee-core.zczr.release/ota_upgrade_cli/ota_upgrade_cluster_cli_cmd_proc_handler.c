...

{
  ...
  if (bVar1 == 5) {
    ...
    iVar4 = ota_upgrade_download_stop_timer();
    if ((iVar4 == 0) || (**(char **)(iVar3 + 0x18) != '\x01')) {
_L143:
      uVar6 = 0xfe;
    }
    else {
      uVar5 = zmsg_get_length(*(undefined4 *)(param_1 + 0x24));
      af_read_le8_isra_0(*(undefined4 *)(param_1 + 0x24),&uStack_64,auStack_60);
      if (((uint)auStack_60 & 0xff) == 0) {
        ...
        uVar8 = (uint)abStack_50[0];
        pvStack_4c = calloc(1,uVar8);
        if ((pvStack_4c != (void *)0x0) || (uVar6 = 0x89, uVar8 == 0)) {
          sVar9 = (short)uStack_64;
          iVar4 = zmsg_read_bytes(*(undefined4 *)(param_1 + 0x24),uStack_64 & 0xffff,uVar8,
                                  pvStack_4c);
          if ((iVar4 == 0) && (uVar8 != 0)) {
            sVar9 = -1;
          }
          else {
            sVar9 = sVar9 + (short)iVar4;
          }
          uStack_64 = CONCAT22(uStack_64._2_2_,sVar9);
          goto _L0;
        }
      }
      else {
        if (((uint)auStack_60 & 0xff) == 0x97) {
        ...
        if ((uStack_64 & 0xffff) <= uVar5) {
          if (((uint)auStack_60 & 0xff) == 0) {
            if (((**(short **)(iVar3 + 0x1c) != (short)uStack_5c) ||
               ...
               (*(uint *)(iVar3 + 0x2c) != uStack_58)) goto _L143;
            uVar5 = *(uint *)(iVar3 + 0x28);
            uVar8 = (uint)abStack_50[0] + **(int **)(iVar3 + 4);
            ...
            if ((uVar6 == 0) &&
               (zcl_message_ota_upgrade_downloading_progress(param_1,1,auStack_60),
               **(char **)(iVar3 + 0x18) == '\x02')) {
              zcl_message_ota_upgrade_downloading_progress(param_1,3,auStack_60);
            }
          }
          else {
            uVar6 = 0x95;
...
_L0:
      ...
      uStack_64 = (uint)uStack_64._2_2_ << 0x10;
      auStack_60 = (undefined1  [4])0x0;
      uStack_5c = 0;
      uStack_58 = 0;
      uStack_54 = 0;
      iVar3 = ota_upgrade_downloading_context_get(*(undefined1 *)(param_1 + 0x15));
      iVar4 = ota_upgrade_download_stop_timer();
      if ((iVar4 == 0) || (**(char **)(iVar3 + 0x18) != '\x02')) {
_L0:
        uVar6 = 0xfe;
        goto _L0;
      }
      uVar5 = zmsg_get_length(*(undefined4 *)(param_1 + 0x24));
      af_read_le16_isra_0(*(undefined4 *)(param_1 + 0x24),&uStack_64,auStack_60);
      af_read_le16_isra_0(*(undefined4 *)(param_1 + 0x24),&uStack_64,auStack_60 + 2);
      af_read_le32_isra_0(*(undefined4 *)(param_1 + 0x24),&uStack_64,&uStack_5c);
      af_read_le32_isra_0(*(undefined4 *)(param_1 + 0x24),&uStack_64,&uStack_58);
      af_read_le32_isra_0(*(undefined4 *)(param_1 + 0x24),&uStack_64,&uStack_54);
      uVar6 = 0x80;
      if (uVar5 < (uStack_64 & 0xffff)) goto _L0;
      if ((((((uint)**(ushort **)(iVar3 + 0x1c) != ((uint)auStack_60 & 0xffff)) &&
            (((uint)auStack_60 & 0xffff) != 0xffff)) ||
           ((**(short **)(iVar3 + 0x20) != auStack_60._2_2_ && (auStack_60._2_2_ != -1)))) ||
      ...
      **(undefined4 **)(iVar3 + 4) = 0;
      ...
      iVar4 = zcl_message_ota_upgrade_downloading_progress(param_1,4,auStack_60);
      if (iVar4 == 0x96) {
        ...
        if (iVar4 != 0x99) {
          if (iVar4 == 0) {
            **(undefined1 **)(iVar3 + 0x18) = 4;
            zcl_message_ota_upgrade_downloading_progress(param_1,5,auStack_60);
    ...
    if (bVar1 == 0) {
      auStack_60 = (undefined1  [4])0xffff0000;
      uStack_5c = 0xffff;
      ...
      if (**(char **)(iVar4 + 0x18) == '\0') {
        ...
        af_read_le8_isra_0(*(undefined4 *)(param_1 + 0x24),&uStack_66,auStack_60);
        af_read_le8_isra_0(*(undefined4 *)(param_1 + 0x24),&uStack_66,auStack_60 + 1);
        uVar8 = (uint)auStack_60 & 0xff;
        if (uVar8 == 3) {
          af_read_le16_isra_0(*(undefined4 *)(param_1 + 0x24),&uStack_66,auStack_60 + 2);
          ...
          if (uVar8 == 2) {
            ...
            uVar6 = 0x81;
            if (uVar8 != 1) goto _L0;
            puVar7 = (undefined4 *)(auStack_60 + 2);
          }
          af_read_le16_isra_0(*(undefined4 *)(param_1 + 0x24),&uStack_66,puVar7);
        }
        uVar6 = 0x80;
        if (uStack_66 <= uVar5) {
          ...
          if (uVar2 < 0xfff8) {
            ...
            uVar5 = (uint)auStack_60 & 0xff;
            if (uVar5 == 2) {
_L0:
              uVar8 = uStack_5c & 0xffff;
              if (**(ushort **)(iVar4 + 0x20) != uVar8) {
                uVar5 = 0xffff;
                goto _L0;
              }
            }
              ...
              if (uVar5 == 3) {
                ...
                if ((uStack_58 == uVar5) || (uStack_58 == uVar8)) goto _L0;
                goto _L0;
              }
              uVar8 = 1;
_L0:
              if (uVar8 != uVar5) goto _L0;
            }
            if ((**(short **)(iVar4 + 0x1c) != auStack_60._2_2_) && (auStack_60._2_2_ != -1)) {
_L0:
              uVar6 = 0x96;
              goto _L0;
            }
          ...
          if (uVar5 % 100 <= ((uint)auStack_60 >> 8 & 0xff)) {
            ...
            if (iVar3 == 0) {
              ...
              if (((iVar3 == 0) &&
                  (iVar3 = zmsg_append_le16(uStack_24,**(undefined2 **)(iVar4 + 0x1c)), iVar3 == 0))
                 && (iVar3 = zmsg_append_le16(uStack_24,**(undefined2 **)(iVar4 + 0x20)), iVar3 == 0
                    )) {
    ...
    uVar6 = 0x80;
    if ((uVar5 < (uStack_64 & 0xffff)) ||
       (uVar6 = zcl_message_ota_upgrade_query_next_image(param_1,auStack_60), uVar6 != 0)) goto _L0;
    ota_upgrade_download_stop_timer(iVar3);
    uVar6 = (uint)auStack_60 & 0xff;
    if (uVar6 != 0) {
...
_L0:
    ...
    if ((**(short **)(iVar3 + 0x1c) != auStack_60._2_2_) ||
    ...
    *(uint *)(iVar3 + 0x28) = uStack_54;
    zcl_message_ota_upgrade_downloading_progress(param_1,0,auStack_60);
