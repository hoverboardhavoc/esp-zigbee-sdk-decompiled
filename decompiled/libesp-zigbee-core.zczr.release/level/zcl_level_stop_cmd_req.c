 ...
 * Source: libesp-zigbee-core.zczr.release -> level.o -> zcl_level_stop_cmd_req
 *
...
int zcl_level_stop_cmd_req(int param_1,void *param_2)

{
  ...
  if (param_2 == (void *)0x0) {
    ...
    if (iVar2 == 0) {
      ...
      iVar2 = zcl_cmd_to_packet(auStack_38,0,0,uVar1,0,(-(uint)(param_1 == 0) & 0xfffffffc) + 7,8);
      if (((iVar2 == 0) &&
