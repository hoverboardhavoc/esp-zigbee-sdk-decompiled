 ...
 * Source: libesp-zigbee-core.zczr.release -> level.o -> ezb_zcl_level_stop_with_on_off_cmd_req
 *
...
ezb_err_t ezb_zcl_level_stop_with_on_off_cmd_req(ezb_zcl_level_stop_cmd_t *req)

{
  ...
  if (req == (ezb_zcl_level_stop_cmd_t *)0x0) {
    ...
    if (iVar2 == 0) {
      ...
      iVar2 = zcl_cmd_to_packet(auStack_38,0,0,_Var1,0,7,8);
      if (((iVar2 == 0) &&
