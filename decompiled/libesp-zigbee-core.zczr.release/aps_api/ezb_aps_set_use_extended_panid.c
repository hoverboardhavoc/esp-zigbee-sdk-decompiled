 ...
 * Source: libesp-zigbee-core.zczr.release -> aps_api.o -> ezb_aps_set_use_extended_panid
 *
...

{
  ...
  *(char *)(iVar5 + 0xd) = (char)((uint)uVar3 >> 8);
  *(char *)(iVar5 + 0xf) = (char)((uint)uVar3 >> 0x18);
  *(char *)(iVar5 + 0x11) = (char)((uint)uVar4 >> 8);
  *(char *)(iVar5 + 0xe) = (char)((uint)uVar3 >> 0x10);
