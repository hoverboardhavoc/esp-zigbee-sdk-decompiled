 ...
 * Source: libesp-zigbee-core.zczr.release -> touchlink_network_start.o -> touchlink_network_start_confirm
 *
...
void touchlink_network_start_confirm(touchlink_cmd_cnf_t *cnf,void *arg)
