...

{
  ...
  if (pcVar10 < (char *)0x3) {
    if (pcVar10 == (char *)0x0) {
      ...
      tasklet_post(iVar9 + 0xd3c);
      return;
    }
    iVar9 = core_globals_get();
    if (*(char *)(iVar9 + 0xd4f) != '\0') {
      return;
    }
    ...
    iVar9 = core_globals_get();
    if ((*(char *)(iVar9 + 0xd4f) == '\0') &&
       (iVar9 = core_globals_get(), *(char *)(iVar9 + 0xd4e) == '\x06')) {
      iVar9 = core_globals_get();
      *(undefined1 *)(iVar9 + 0xd4f) = 1;
  ...
  if (pcVar10 == (char *)0x3) {
    ...
    pcVar10 = (char *)(uint)*(byte *)(iVar9 + 0xd4e);
    if (pcVar10 != (char *)0x2) {
      if (pcVar10 < (char *)0x3) {
        if (pcVar10 != (char *)0x0) {
...
_L0:
      ...
      if (pcVar10 == (char *)0x4) {
        iVar9 = core_globals_get();
        pcVar10 = bdb_comm_step_to_str(*(bdb_comm_step_t *)(iVar9 + 0xd4e));
...
_L0:
    ...
    if ((iVar9 != 0) && (iVar9 = core_globals_get(), (*(byte *)(iVar9 + 0xd5e) & 4) != 0)) {
...
_L0:
    ...
    if (iVar9 != 0) {
      iVar9 = core_globals_get();
      *(undefined1 *)((int)param + iVar9 + -0x2b4) = 10;
      goto _L0;
    }
    iVar9 = core_globals_get();
    iVar9 = iVar9 + (int)param;
  }
  *(undefined1 *)(iVar9 + -0x2b4) = 0;
_L0:
  iVar9 = core_globals_get();
  if (*(char *)(iVar9 + 0xd4c) != '\0') {
    if (*(char *)(iVar9 + 0xd4c) == '\x01') {
