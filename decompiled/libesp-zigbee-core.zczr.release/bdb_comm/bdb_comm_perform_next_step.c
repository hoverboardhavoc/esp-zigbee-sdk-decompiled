        ...
        if (uVar3 == 2) {
          ...
          *(byte *)(iVar5 + 0xd5e) = *(byte *)(iVar5 + 0xd5e) | 1;
          ...
          if (((*(byte *)(iVar5 + 0xd5e) & 1) != 0) &&
             (iVar5 = core_globals_get(), *(int *)(iVar5 + 0xd54) != 0)) goto _L0;
          iVar5 = core_globals_get();
...
_L0:
          ...
          *(undefined1 *)(iVar5 + 0xd4c) = 3;
          ...
          iVar5 = core_globals_get();
          bdb_comm_put_app_signal(0x102,*(undefined1 *)(iVar5 + 0xd4c));
        }
        else {
          iVar5 = zdo_dev_joined();
          if (iVar5 == 0) {
            iVar5 = bdb_comm_is_factory_new();
            if (iVar5 == 0) {
              iVar5 = core_globals_get();
              *(undefined1 *)(iVar5 + 0xd4c) = 3;
                  ...
                  if ((piVar7[1] + 1U != (uint)(*piVar7 == 0)) || (*piVar7 - 1U < 0xfffffffe)) {
                    ...
                    if (iVar5 != 0) {
                      do {
                        iVar5 = nwk_is_authed();
                        if ((iVar5 == 0) ||
                           (piVar7 = (int *)aps_secur_get_tc_address(),
                           *piVar7 == 0 && piVar7[1] == 0)) break;
                        nwk_get_panid();
                        nwk_set_panid();
                        ...
                        *(byte *)(iVar5 + 0xb18) = *(byte *)(iVar5 + 0xb18) | 1;
                        ...
                        iVar5 = nwk_address_update(uVar8,uVar9,auStack_32);
                        if (iVar5 == 0) {
...
_L0:
            ...
            iVar5 = core_globals_get();
            bdb_comm_put_app_signal(0x101 - sVar4,*(undefined1 *)(iVar5 + 0xd4c));
          }
          else {
            bdb_comm_finish_step();
          }
        ...
        bdb_comm_finish_step();
        iVar5 = core_globals_get();
        bdb_comm_put_app_signal(0x104,*(undefined1 *)(iVar5 + 0xd4c));
      }
      goto _L0;
    }
    iVar5 = zdo_dev_joined();
...
_L0:
    ...
    bdb_comm_finish_step();
    iVar5 = core_globals_get();
    bdb_comm_put_app_signal(0x103,*(undefined1 *)(iVar5 + 0xd4c));
  } while( true );
}
