 ...
 * Source: libesp-zigbee-core.zczr.release -> bdb_comm.o -> bdb_comm_finish_network_formation
 *
...
void bdb_comm_finish_network_formation(void)

{
  ...
  bdb_comm_put_app_signal(0x103,*(bdb_comm_status_t *)(iVar9 + 0xd4c));
_L0:
  do {
    uVar3 = 6;
