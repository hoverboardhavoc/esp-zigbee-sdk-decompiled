 ...
 * Source: libesp-zigbee-core.zczr.release -> bdb_comm.o -> bdb_comm_finish_network_steering
 *
...
void bdb_comm_finish_network_steering(void)
...
_L0:
        ...
        bdb_comm_put_app_signal
                  (0x101 - (short)CONCAT31(extraout_var,_Var4),*(bdb_comm_status_t *)(iVar9 + 0xda0)
                  );
      }
      else {
        bdb_comm_finish_step();
