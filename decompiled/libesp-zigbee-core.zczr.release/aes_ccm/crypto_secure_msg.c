...

{
  ...
  if (iVar1 < iVar3) {
    ...
    uVar4 = iVar1 - iVar3;
    eVar2 = crypto_aes_ccm_star_msg(msg,3,key,ccm_nonce,ad_len,(uint16_t)uVar4,auStack_30,tag_len);
    if (eVar2 == 0) {
      zmsg_write_bytes(msg,CONCAT22(in_register_00002036,ad_len) + (uVar4 & 0xffff) & 0xffff,
