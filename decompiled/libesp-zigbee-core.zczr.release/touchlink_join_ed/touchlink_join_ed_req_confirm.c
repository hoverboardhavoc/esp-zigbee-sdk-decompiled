 ...
 * Source: libesp-zigbee-core.zczr.release -> touchlink_join_ed.o -> touchlink_join_ed_req_confirm
 *
...
void touchlink_join_ed_req_confirm(undefined1 *param_1,undefined4 param_2)
