#!/usr/bin/env python3
"""Auto-decompile pipeline for esp-zigbee-sdk-decompiled.
...
(oldest first, bounded by MAX_COMMITS_PER_RUN), this script:
  ...
  1. globs components/esp-zigbee-lib/lib/esp32c3/*.a against the upstream checkout to discover the
...
UPSTREAM_REPO = "espressif/esp-zigbee-sdk"
UPSTREAM_URL = "https://github.com/espressif/esp-zigbee-sdk.git"
TARGET_GLOB = "components/esp-zigbee-lib/lib/esp32c3/*.a"
